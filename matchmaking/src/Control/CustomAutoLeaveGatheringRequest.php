 ...
 */
class CustomAutoLeaveGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return CustomAutoLeaveGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): CustomAutoLeaveGatheringRequest {
	 ...
	 * @return CustomAutoLeaveGatheringRequest
	 */
	public function withGatheringId($gatheringId): CustomAutoLeaveGatheringRequest {
