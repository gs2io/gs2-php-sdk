 ...
 */
class DeleteGoldMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteGoldMaster";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return DeleteGoldMasterRequest
	 */
	public function withGoldPoolName($goldPoolName): DeleteGoldMasterRequest {
	 ...
	 * @return DeleteGoldMasterRequest
	 */
	public function withGoldName($goldName): DeleteGoldMasterRequest {
