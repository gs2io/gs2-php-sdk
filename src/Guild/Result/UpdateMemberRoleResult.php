...
class UpdateMemberRoleResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): UpdateMemberRoleResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateMemberRoleResult {
        if ($data === null) {
            return null;
        }
