...
class PutSubscribeRankingScoreByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): PutSubscribeRankingScoreByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?PutSubscribeRankingScoreByUserIdRequest {
        if ($data === null) {
            return null;
        }
