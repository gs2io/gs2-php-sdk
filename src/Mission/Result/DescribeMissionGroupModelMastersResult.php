...
class DescribeMissionGroupModelMastersResult implements IResult {
	...
	public function withItems(?array $items): DescribeMissionGroupModelMastersResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeMissionGroupModelMastersResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
