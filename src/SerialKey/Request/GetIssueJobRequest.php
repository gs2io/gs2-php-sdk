...
class GetIssueJobRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetIssueJobRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCampaignModelName(?string $campaignModelName): GetIssueJobRequest {
		$this->campaignModelName = $campaignModelName;
		return $this;
	}
	...
	public function withIssueJobName(?string $issueJobName): GetIssueJobRequest {
		$this->issueJobName = $issueJobName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetIssueJobRequest {
        if ($data === null) {
            return null;
        }
