...
class GetItemSetByUserIdRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName 有効期限ごとのアイテム所持数量を取得
     * @return GetItemSetByUserIdRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetItemSetByUserIdRequest {
     ...
     * @return GetItemSetByUserIdRequest $this
     */
    public function withInventoryName(string $inventoryName = null): GetItemSetByUserIdRequest {
     ...
     * @return GetItemSetByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetItemSetByUserIdRequest {
     ...
     * @return GetItemSetByUserIdRequest $this
     */
    public function withItemName(string $itemName = null): GetItemSetByUserIdRequest {
     ...
     * @return GetItemSetByUserIdRequest $this
     */
    public function withItemSetName(string $itemSetName = null): GetItemSetByUserIdRequest {
     ...
     * @return GetItemSetByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetItemSetByUserIdRequest {
