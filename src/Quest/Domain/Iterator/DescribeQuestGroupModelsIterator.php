...
use Gs2\Quest\Domain\Cache\QuestGroupModelDomainCache;
...
class DescribeQuestGroupModelsIterator implements Iterator {

    /**
     * @var QuestGroupModelDomainCache
     */
    ...
    public function __construct(
        QuestGroupModelDomainCache $questGroupModelCache,
    ...
    private function load(): void {
        /**
         * @var DescribeQuestGroupModelsResult
         */
         $r = $this->client->describeQuestGroupModels(
