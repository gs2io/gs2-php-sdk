...
class Namespace_ implements IModel {
	 ...
	 */
	protected $enableDirectEnhance;

	/**
	 * DirectEnhance を利用できるようにするかを取得
	 *
	 * @return bool|null DirectEnhance を利用できるようにするか
	 */
	 ...
	 *
	 * @param bool|null $enableDirectEnhance DirectEnhance を利用できるようにするか
	 */
    ...
    public function toJson(): array {
        return array(
            ...
            "enableDirectEnhance" => $this->enableDirectEnhance,
    ...
    public static function fromJson(array $data): Namespace_ {
        ...
        $model->setEnableDirectEnhance(isset($data["enableDirectEnhance"]) ? $data["enableDirectEnhance"] : null);
