...
class GetEventMasterRequest extends Gs2BasicRequest {
	 ...
	 */
	public function withScheduleName($scheduleName): GetEventMasterRequest {
	 ...
	 * @return GetEventMasterRequest
	 */
	public function withEventName($eventName): GetEventMasterRequest {
