 ...
 */
class DeleteResourcePoolRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteResourcePool";
	 ...
	 */
	public function withResourcePoolName($resourcePoolName): DeleteResourcePoolRequest {
