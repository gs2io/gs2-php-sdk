...
class GetLimitModelMasterResult implements IResult {
	/** @var LimitModelMaster 回数制限の種類マスター */
	private $item;

	/**
	 * 回数制限の種類マスターを取得
	 *
	 * @return LimitModelMaster|null 回数制限の種類マスターを取得
	 */
	 ...
	 * 回数制限の種類マスターを設定
	 *
	 * @param LimitModelMaster|null $item 回数制限の種類マスターを取得
	 */
    ...
    public static function fromJson(array $data): GetLimitModelMasterResult {
        $result = new GetLimitModelMasterResult();
