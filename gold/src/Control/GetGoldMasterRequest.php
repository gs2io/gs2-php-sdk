 ...
 */
class GetGoldMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGoldMaster";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return GetGoldMasterRequest
	 */
	public function withGoldPoolName($goldPoolName): GetGoldMasterRequest {
	 ...
	 * @return GetGoldMasterRequest
	 */
	public function withGoldName($goldName): GetGoldMasterRequest {
