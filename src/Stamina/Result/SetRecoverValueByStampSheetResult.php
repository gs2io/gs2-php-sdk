...
class SetRecoverValueByStampSheetResult implements IResult {
    /** @var Stamina */
    private $item;
    /** @var Stamina */
    private $old;
	...
	public function withItem(?Stamina $item): SetRecoverValueByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withOld(?Stamina $old): SetRecoverValueByStampSheetResult {
		$this->old = $old;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): SetRecoverValueByStampSheetResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SetRecoverValueByStampSheetResult {
        if ($data === null) {
            return null;
        }
