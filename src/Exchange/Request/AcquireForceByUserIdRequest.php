...
class AcquireForceByUserIdRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName 交換待機の報酬を取得
     * @return AcquireForceByUserIdRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): AcquireForceByUserIdRequest {
     ...
     * @return AcquireForceByUserIdRequest $this
     */
    public function withUserId(string $userId = null): AcquireForceByUserIdRequest {
     ...
     * @return AcquireForceByUserIdRequest $this
     */
    public function withRateName(string $rateName = null): AcquireForceByUserIdRequest {
     ...
     * @return AcquireForceByUserIdRequest $this
     */
    public function withAwaitName(string $awaitName = null): AcquireForceByUserIdRequest {
     ...
     * @return AcquireForceByUserIdRequest $this
     */
    public function withConfig(array $config = null): AcquireForceByUserIdRequest {
     ...
     * @return AcquireForceByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): AcquireForceByUserIdRequest {
