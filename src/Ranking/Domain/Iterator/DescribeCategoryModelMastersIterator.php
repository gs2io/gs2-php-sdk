...
use Gs2\Ranking\Domain\Cache\CategoryModelMasterDomainCache;
...
class DescribeCategoryModelMastersIterator implements Iterator {

    /**
     * @var CategoryModelMasterDomainCache
     */
    ...
    public function __construct(
        CategoryModelMasterDomainCache $categoryModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeCategoryModelMastersResult
         */
         $r = $this->client->describeCategoryModelMasters(
