...
use Gs2\Stamina\Domain\Cache\RecoverValueTableMasterDomainCache;
...
class DescribeRecoverValueTableMastersIterator implements Iterator {

    /**
     * @var RecoverValueTableMasterDomainCache
     */
    ...
    /**
     * @var array<RecoverValueTableMaster>
     */
    private $result;
    ...
    public function __construct(
        RecoverValueTableMasterDomainCache $recoverValueTableMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeRecoverValueTableMastersResult
         */
         $r = $this->client->describeRecoverValueTableMasters(
