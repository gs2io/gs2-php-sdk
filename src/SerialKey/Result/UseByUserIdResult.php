...
class UseByUserIdResult implements IResult {
    /** @var SerialKey */
    private $item;
    /** @var CampaignModel */
	...
	public function withItem(?SerialKey $item): UseByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withCampaignModel(?CampaignModel $campaignModel): UseByUserIdResult {
		$this->campaignModel = $campaignModel;
		return $this;
	}

    public static function fromJson(?array $data): ?UseByUserIdResult {
        if ($data === null) {
            return null;
        }
