...
class ProgressDomain {
    ...
    public function load(
        \Gs2\Enhance\Request\GetProgressByUserIdRequest $request
    ): \Gs2\Enhance\Result\GetProgressByUserIdResult {
        $request->setNamespaceName($this->namespaceName);
        $request->setUserId($this->userId);
        /**
         * @var \Gs2\Enhance\Result\GetProgressByUserIdResult
         */
    ...
    ): \Gs2\Enhance\Domain\Iterator\DescribeProgressesByUserIdIterator {
        return new \Gs2\Enhance\Domain\Iterator\DescribeProgressesByUserIdIterator(
            $this->progressCache,
            $this->client,
            $this->namespaceName,
            $this->userId
