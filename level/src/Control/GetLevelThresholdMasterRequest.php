 ...
 */
class GetLevelThresholdMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetLevelThresholdMaster";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return GetLevelThresholdMasterRequest
	 */
	public function withResourcePoolName($resourcePoolName): GetLevelThresholdMasterRequest {
	 ...
	 * @return GetLevelThresholdMasterRequest
	 */
	public function withLevelTableName($levelTableName): GetLevelThresholdMasterRequest {
	 ...
	 * @return GetLevelThresholdMasterRequest
	 */
	public function withThreshold($threshold): GetLevelThresholdMasterRequest {
