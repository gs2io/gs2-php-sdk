...
class GetEntryWithSignatureByUserIdResult implements IResult {
	 ...
	 * エントリーを取得
	 *
	 * @return Entry|null ユーザIDを指定してエントリーを取得
	 */
	 ...
	 * エントリーを設定
	 *
	 * @param Entry|null $item ユーザIDを指定してエントリーを取得
	 */
	 ...
	 * 署名対象のエントリー情報を設定
	 *
	 * @param string|null $body ユーザIDを指定してエントリーを取得
	 */
	 ...
	 * 署名を設定
	 *
	 * @param string|null $signature ユーザIDを指定してエントリーを取得
	 */
    ...
    public static function fromJson(array $data): GetEntryWithSignatureByUserIdResult {
        $result = new GetEntryWithSignatureByUserIdResult();
