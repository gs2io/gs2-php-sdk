 ...
 */
class DeleteItemRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteItem";
	 ...
	 */
	public function withMoneyName($moneyName): DeleteItemRequest {
	 ...
	 * @return DeleteItemRequest
	 */
	public function withItemName($itemName): DeleteItemRequest {
