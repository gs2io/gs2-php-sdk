 ...
 */
class DescribeRoomRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeRoom";
	 ...
	 *
	 * @param string $lobbyName ロビーの名前
	 * @return DescribeRoomRequest
	 */
	public function withLobbyName($lobbyName): DescribeRoomRequest {
	 ...
	 * @return DescribeRoomRequest
	 */
	public function withPageToken($pageToken): DescribeRoomRequest {
	 ...
	 * @return DescribeRoomRequest
	 */
	public function withLimit($limit): DescribeRoomRequest {
		$this->setLimit($limit);
		return $this;
	}
