...
use Gs2\Account\Result\GetServiceVersionResult;
...
class CreateNamespaceTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        if ($this->request->getUnBanScript() !== null) {
            $json["unBanScript"] = $this->request->getUnBanScript()->toJson();
        }
...
class GetServiceVersionTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "account", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/version";
