...
class CreateGuildResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): CreateGuildResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?CreateGuildResult {
        if ($data === null) {
            return null;
        }
