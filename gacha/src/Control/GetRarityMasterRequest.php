 ...
 */
class GetRarityMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetRarityMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return GetRarityMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): GetRarityMasterRequest {
	 ...
	 * @return GetRarityMasterRequest
	 */
	public function withPrizeTableName($prizeTableName): GetRarityMasterRequest {
	 ...
	 * @return GetRarityMasterRequest
	 */
	public function withRarityName($rarityName): GetRarityMasterRequest {
