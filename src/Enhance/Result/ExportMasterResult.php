...
/**
 * 現在有効な強化レート設定のマスターデータをエクスポートします のレスポンスモデル
 *
...
class ExportMasterResult implements IResult {
	 ...
	 * 現在有効な強化レート設定を取得
	 *
	 * @return CurrentRateMaster|null 現在有効な強化レート設定のマスターデータをエクスポートします
	 */
	 ...
	 * 現在有効な強化レート設定を設定
	 *
	 * @param CurrentRateMaster|null $item 現在有効な強化レート設定のマスターデータをエクスポートします
	 */
