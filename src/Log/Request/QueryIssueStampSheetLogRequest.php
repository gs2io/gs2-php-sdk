...
class QueryIssueStampSheetLogRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): QueryIssueStampSheetLogRequest {
     ...
     * マイクロサービスの種類を設定
     *
     * @param string $service スタンプシート発行ログの一覧を取得
     */
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withService(string $service = null): QueryIssueStampSheetLogRequest {
     ...
     * マイクロサービスのメソッドを設定
     *
     * @param string $method スタンプシート発行ログの一覧を取得
     */
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withMethod(string $method = null): QueryIssueStampSheetLogRequest {
     ...
     * ユーザーIDを設定
     *
     * @param string $userId スタンプシート発行ログの一覧を取得
     */
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withUserId(string $userId = null): QueryIssueStampSheetLogRequest {
     ...
     * 報酬アクションを設定
     *
     * @param string $action スタンプシート発行ログの一覧を取得
     */
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withAction(string $action = null): QueryIssueStampSheetLogRequest {
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withPageToken(string $pageToken = null): QueryIssueStampSheetLogRequest {
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withLimit(int $limit = null): QueryIssueStampSheetLogRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return QueryIssueStampSheetLogRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): QueryIssueStampSheetLogRequest {
