...
class UpdateCurrentEventMasterFromGitHubRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UpdateCurrentEventMasterFromGitHubRequest {
     ...
     * @return UpdateCurrentEventMasterFromGitHubRequest $this
     */
    public function withCheckoutSetting(GitHubCheckoutSetting $checkoutSetting = null): UpdateCurrentEventMasterFromGitHubRequest {
