 ...
 */
class GetGatheringPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGatheringPool";
	 ...
	 *
	 * @param string $gatheringPoolName ギャザリングプールの名前を指定します。
	 * @return GetGatheringPoolRequest
	 */
	public function withGatheringPoolName($gatheringPoolName): GetGatheringPoolRequest {
