 ...
 */
class GetProbabilityRequest extends Gs2BasicRequest {

    const FUNCTION = "GetProbability";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前
	 * @return GetProbabilityRequest
	 */
	public function withGachaPoolName($gachaPoolName): GetProbabilityRequest {
	 ...
	 * @return GetProbabilityRequest
	 */
	public function withGachaName($gachaName): GetProbabilityRequest {
	 ...
	 * @return GetProbabilityRequest
	 */
	public function withDrawTime($drawTime): GetProbabilityRequest {
