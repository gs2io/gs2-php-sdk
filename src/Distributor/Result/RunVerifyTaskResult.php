...
class RunVerifyTaskResult implements IResult {
    /** @var string */
	...
	public function withContextStack(?string $contextStack): RunVerifyTaskResult {
		$this->contextStack = $contextStack;
		return $this;
	}
	...
	public function withStatusCode(?int $statusCode): RunVerifyTaskResult {
		$this->statusCode = $statusCode;
		return $this;
	}
	...
	public function withResult(?string $result): RunVerifyTaskResult {
		$this->result = $result;
		return $this;
	}

    public static function fromJson(?array $data): ?RunVerifyTaskResult {
        if ($data === null) {
            return null;
        }
