...
class OpenMessageByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): OpenMessageByUserIdRequest {
     ...
     * @return OpenMessageByUserIdRequest $this
     */
    public function withUserId(string $userId = null): OpenMessageByUserIdRequest {
     ...
     * @return OpenMessageByUserIdRequest $this
     */
    public function withMessageName(string $messageName = null): OpenMessageByUserIdRequest {
     ...
     * @return OpenMessageByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): OpenMessageByUserIdRequest {
