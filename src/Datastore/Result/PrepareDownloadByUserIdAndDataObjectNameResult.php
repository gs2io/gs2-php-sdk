...
class PrepareDownloadByUserIdAndDataObjectNameResult implements IResult {
	...
	public function withItem(?DataObject $item): PrepareDownloadByUserIdAndDataObjectNameResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withFileUrl(?string $fileUrl): PrepareDownloadByUserIdAndDataObjectNameResult {
		$this->fileUrl = $fileUrl;
		return $this;
	}
	...
	public function withContentLength(?int $contentLength): PrepareDownloadByUserIdAndDataObjectNameResult {
		$this->contentLength = $contentLength;
		return $this;
	}
