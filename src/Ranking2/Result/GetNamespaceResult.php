...
use Gs2\Ranking2\Model\TransactionSetting;
use Gs2\Ranking2\Model\TransactionSettingV2;
use Gs2\Ranking2\Model\LogSetting;
use Gs2\Ranking2\Model\Namespace_;
