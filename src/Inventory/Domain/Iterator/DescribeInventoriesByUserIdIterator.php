...
use Gs2\Inventory\Domain\Cache\InventoryDomainCache;
...
class DescribeInventoriesByUserIdIterator implements Iterator {

    /**
     * @var InventoryDomainCache
     */
    ...
    public function __construct(
        InventoryDomainCache $inventoryCache,
    ...
    private function load(): void {
        /**
         * @var DescribeInventoriesByUserIdResult
         */
         $r = $this->client->describeInventoriesByUserId(
