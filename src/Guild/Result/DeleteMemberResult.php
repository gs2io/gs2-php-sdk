...
class DeleteMemberResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): DeleteMemberResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteMemberResult {
        if ($data === null) {
            return null;
        }
