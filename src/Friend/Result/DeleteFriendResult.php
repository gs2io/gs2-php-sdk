...
class DeleteFriendResult implements IResult {
    /** @var FriendUser */
    private $item;
	...
	public function withItem(?FriendUser $item): DeleteFriendResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteFriendResult {
        if ($data === null) {
            return null;
        }
