...
class DescribeMutexesRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName): DescribeMutexesRequest {
     ...
     * @return DescribeMutexesRequest $this
     */
    public function withPageToken(string $pageToken): DescribeMutexesRequest {
     ...
     * @return DescribeMutexesRequest $this
     */
    public function withLimit(int $limit): DescribeMutexesRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeMutexesRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider): DescribeMutexesRequest {
