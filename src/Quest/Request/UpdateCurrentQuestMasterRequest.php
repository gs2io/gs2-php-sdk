...
class UpdateCurrentQuestMasterRequest extends Gs2BasicRequest {
	...
	public function withMode(?string $mode): UpdateCurrentQuestMasterRequest {
		$this->mode = $mode;
		return $this;
	}
	...
	public function withUploadToken(?string $uploadToken): UpdateCurrentQuestMasterRequest {
		$this->uploadToken = $uploadToken;
		return $this;
	}
