...
class DescribeTakeOversByUserIdResult implements IResult {
	...
	public function withItems(?array $items): DescribeTakeOversByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeTakeOversByUserIdResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
