 ...
 */
class GetLockPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetLockPool";
	 ...
	 *
	 * @param string $lockPoolName ロックプールの名前を指定します。
	 * @return GetLockPoolRequest
	 */
	public function withLockPoolName($lockPoolName): GetLockPoolRequest {
