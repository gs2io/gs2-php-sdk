...
use Gs2\Idle\Model\GitHubCheckoutSetting;

class UpdateCurrentCategoryMasterFromGitHubRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentCategoryMasterFromGitHubRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCheckoutSetting(?GitHubCheckoutSetting $checkoutSetting): UpdateCurrentCategoryMasterFromGitHubRequest {
		$this->checkoutSetting = $checkoutSetting;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentCategoryMasterFromGitHubRequest {
        if ($data === null) {
            return null;
        }
