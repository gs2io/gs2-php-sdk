...
class ResetCounterResult implements IResult {
    /** @var Counter */
    private $item;
	...
	public function withItem(?Counter $item): ResetCounterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?ResetCounterResult {
        if ($data === null) {
            return null;
        }
