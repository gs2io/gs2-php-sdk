...
class IncreaseByStampSheetRequest extends Gs2BasicRequest {
     ...
     */
    public function withStampSheet(string $stampSheet = null): IncreaseByStampSheetRequest {
     ...
     * @return IncreaseByStampSheetRequest $this
     */
    public function withKeyId(string $keyId = null): IncreaseByStampSheetRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return IncreaseByStampSheetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): IncreaseByStampSheetRequest {
