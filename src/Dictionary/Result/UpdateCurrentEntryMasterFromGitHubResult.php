...
class UpdateCurrentEntryMasterFromGitHubResult implements IResult {
	...
	public function withItem(?CurrentEntryMaster $item): UpdateCurrentEntryMasterFromGitHubResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentEntryMasterFromGitHubResult {
        if ($data === null) {
            return null;
        }
