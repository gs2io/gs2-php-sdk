...
class SubRankCapResult implements IResult {
    /** @var Status */
    private $item;
	...
	public function withItem(?Status $item): SubRankCapResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?SubRankCapResult {
        if ($data === null) {
            return null;
        }
