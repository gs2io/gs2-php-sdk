...
class DeleteRequestRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DeleteRequestRequest {
     ...
     * @return DeleteRequestRequest $this
     */
    public function withTargetUserId(string $targetUserId = null): DeleteRequestRequest {
     ...
     * @return DeleteRequestRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DeleteRequestRequest {
