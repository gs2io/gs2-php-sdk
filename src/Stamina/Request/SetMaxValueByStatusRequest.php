...
class SetMaxValueByStatusRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName スタミナの最大値をGS2-Experienceのステータスを使用して更新
     * @return SetMaxValueByStatusRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): SetMaxValueByStatusRequest {
     ...
     * @return SetMaxValueByStatusRequest $this
     */
    public function withStaminaName(string $staminaName = null): SetMaxValueByStatusRequest {
     ...
     * @return SetMaxValueByStatusRequest $this
     */
    public function withKeyId(string $keyId = null): SetMaxValueByStatusRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return SetMaxValueByStatusRequest $this
     */
    public function withSignedStatusBody(string $signedStatusBody = null): SetMaxValueByStatusRequest {
     ...
     * @return SetMaxValueByStatusRequest $this
     */
    public function withSignedStatusSignature(string $signedStatusSignature = null): SetMaxValueByStatusRequest {
     ...
     * @return SetMaxValueByStatusRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetMaxValueByStatusRequest {
