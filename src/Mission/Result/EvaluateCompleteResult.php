...
class EvaluateCompleteResult implements IResult {
    /** @var Complete */
    private $item;
	...
	public function withItem(?Complete $item): EvaluateCompleteResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?EvaluateCompleteResult {
        if ($data === null) {
            return null;
        }
