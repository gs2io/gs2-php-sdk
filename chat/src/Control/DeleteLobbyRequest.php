 ...
 */
class DeleteLobbyRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteLobby";
	 ...
	 *
	 * @param string $lobbyName ロビーの名前
	 * @return DeleteLobbyRequest
	 */
	public function withLobbyName($lobbyName): DeleteLobbyRequest {
