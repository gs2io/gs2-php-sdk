...
/**
 * クエストを分類するカテゴリーを新規作成 のレスポンスモデル
 *
 * @author Game Server Services, Inc.
 */
class CreateNamespaceResult implements IResult {
	/** @var Namespace_ 作成したクエストを分類するカテゴリー */
	private $item;

	/**
	 * 作成したクエストを分類するカテゴリーを取得
	 *
	 * @return Namespace_|null クエストを分類するカテゴリーを新規作成
	 */
	...
	/**
	 * 作成したクエストを分類するカテゴリーを設定
	 *
	 * @param Namespace_|null $item クエストを分類するカテゴリーを新規作成
	 */
