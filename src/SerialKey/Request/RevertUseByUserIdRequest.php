...
class RevertUseByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): RevertUseByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?RevertUseByUserIdRequest {
        if ($data === null) {
            return null;
        }
