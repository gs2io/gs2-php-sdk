...
class GetJobResultByUserIdResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetJobResultByUserIdResult {
        if ($data === null) {
            return null;
        }
        return (new GetJobResultByUserIdResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? JobResult::fromJson($data['item']) : null);
    }
