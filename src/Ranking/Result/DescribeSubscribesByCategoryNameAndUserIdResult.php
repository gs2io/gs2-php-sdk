...
class DescribeSubscribesByCategoryNameAndUserIdResult implements IResult {
	 ...
	 * 購読対象のリストを取得
	 *
	 * @return SubscribeUser[]|null ユーザIDを指定して購読しているユーザIDの一覧取得
	 */
	 ...
	 * 購読対象のリストを設定
	 *
	 * @param SubscribeUser[]|null $items ユーザIDを指定して購読しているユーザIDの一覧取得
	 */
    ...
    public static function fromJson(array $data): DescribeSubscribesByCategoryNameAndUserIdResult {
        $result = new DescribeSubscribesByCategoryNameAndUserIdResult();
