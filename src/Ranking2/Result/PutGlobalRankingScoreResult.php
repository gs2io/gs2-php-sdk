...
class PutGlobalRankingScoreResult implements IResult {
	...
	public function withItem(?GlobalRankingScore $item): PutGlobalRankingScoreResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?PutGlobalRankingScoreResult {
        if ($data === null) {
            return null;
        }
