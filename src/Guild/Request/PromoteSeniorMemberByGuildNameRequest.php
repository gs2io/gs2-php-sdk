...
class PromoteSeniorMemberByGuildNameRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): PromoteSeniorMemberByGuildNameRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?PromoteSeniorMemberByGuildNameRequest {
        if ($data === null) {
            return null;
        }
