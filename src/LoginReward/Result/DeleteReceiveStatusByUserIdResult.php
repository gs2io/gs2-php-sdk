...
class DeleteReceiveStatusByUserIdResult implements IResult {
    /** @var ReceiveStatus */
    private $item;
    /** @var BonusModel */
    private $bonusModel;
	...
	public function withItem(?ReceiveStatus $item): DeleteReceiveStatusByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withBonusModel(?BonusModel $bonusModel): DeleteReceiveStatusByUserIdResult {
		$this->bonusModel = $bonusModel;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteReceiveStatusByUserIdResult {
        if ($data === null) {
            return null;
        }
