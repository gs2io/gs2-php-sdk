 ...
 */
class DescribeGoldMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeGoldMaster";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return DescribeGoldMasterRequest
	 */
	public function withGoldPoolName($goldPoolName): DescribeGoldMasterRequest {
	 ...
	 * @return DescribeGoldMasterRequest
	 */
	public function withPageToken($pageToken): DescribeGoldMasterRequest {
	 ...
	 * @return DescribeGoldMasterRequest
	 */
	public function withLimit($limit): DescribeGoldMasterRequest {
		$this->setLimit($limit);
		return $this;
	}
