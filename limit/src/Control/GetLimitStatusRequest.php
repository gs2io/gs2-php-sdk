 ...
 */
class GetLimitStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetLimitStatus";
	 ...
	 *
	 * @param string $limitName 回数制限の名前を指定します。
	 * @return GetLimitStatusRequest
	 */
	public function withLimitName($limitName): GetLimitStatusRequest {
