...
class DescribeNewsResult implements IResult {
	 ...
	 * お知らせ記事のリストを設定
	 *
	 * @param News[]|null $items お知らせ記事の一覧を取得
	 */
	 ...
	 * お知らせ記事データのハッシュ値を設定
	 *
	 * @param string|null $contentHash お知らせ記事の一覧を取得
	 */
	 ...
	 * テンプレートデータのハッシュ値を設定
	 *
	 * @param string|null $templateHash お知らせ記事の一覧を取得
	 */
