 ...
 */
class GetResourcePoolStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetResourcePoolStatus";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return GetResourcePoolStatusRequest
	 */
	public function withResourcePoolName($resourcePoolName): GetResourcePoolStatusRequest {
