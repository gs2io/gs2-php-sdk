...
class SetCapacityByStampSheetRequest extends Gs2BasicRequest {
     ...
     */
    public function withStampSheet(string $stampSheet = null): SetCapacityByStampSheetRequest {
     ...
     * @return SetCapacityByStampSheetRequest $this
     */
    public function withKeyId(string $keyId = null): SetCapacityByStampSheetRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return SetCapacityByStampSheetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetCapacityByStampSheetRequest {
