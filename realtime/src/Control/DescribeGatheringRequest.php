 ...
 */
class DescribeGatheringRequest extends Gs2BasicRequest {
	 ...
	 *
	 * @param string $gatheringPoolName ギャザリングプールの名前を指定します。
	 * @return DescribeGatheringRequest
	 */
	public function withGatheringPoolName($gatheringPoolName): DescribeGatheringRequest {
	 ...
	 * @return DescribeGatheringRequest
	 */
	public function withPageToken($pageToken): DescribeGatheringRequest {
	 ...
	 * @return DescribeGatheringRequest
	 */
	public function withLimit($limit): DescribeGatheringRequest {
		$this->setLimit($limit);
		return $this;
	}
