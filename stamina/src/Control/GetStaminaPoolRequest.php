 ...
 */
class GetStaminaPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetStaminaPool";
	 ...
	 *
	 * @param string $staminaPoolName スタミナプールの名前を指定します。
	 * @return GetStaminaPoolRequest
	 */
	public function withStaminaPoolName($staminaPoolName): GetStaminaPoolRequest {
