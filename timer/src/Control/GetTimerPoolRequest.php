 ...
 */
class GetTimerPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetTimerPool";
	 ...
	 *
	 * @param string $timerPoolName タイマープールの名前を指定します。
	 * @return GetTimerPoolRequest
	 */
	public function withTimerPoolName($timerPoolName): GetTimerPoolRequest {
