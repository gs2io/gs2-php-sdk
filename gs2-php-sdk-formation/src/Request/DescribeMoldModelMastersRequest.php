...
class DescribeMoldModelMastersRequest extends Gs2BasicRequest {
     ...
     * ネームスペース名を設定
     *
     * @param string $namespaceName フォームの保存領域マスターの一覧を取得
     */
     ...
     *
     * @param string $namespaceName フォームの保存領域マスターの一覧を取得
     * @return DescribeMoldModelMastersRequest $this
     */
     ...
     *
     * @param string $pageToken フォームの保存領域マスターの一覧を取得
     */
     ...
     * データの取得件数を取得
     *
     * @return int|null フォームの保存領域マスターの一覧を取得
     */
     ...
     * データの取得件数を設定
     *
     * @param int $limit フォームの保存領域マスターの一覧を取得
     */
