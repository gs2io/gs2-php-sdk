...
class UpdateBalanceParameterModelMasterResult implements IResult {
    ...
    public static function fromJson(?array $data): ?UpdateBalanceParameterModelMasterResult {
        if ($data === null) {
            return null;
        }
        return (new UpdateBalanceParameterModelMasterResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? BalanceParameterModelMaster::fromJson($data['item']) : null);
    }
