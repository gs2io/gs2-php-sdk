...
class GetCurrentTreeMasterResult implements IResult {
	...
	public function withItem(?CurrentTreeMaster $item): GetCurrentTreeMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetCurrentTreeMasterResult {
        if ($data === null) {
            return null;
        }
