 ...
 */
class DescribeStatusRequest extends Gs2UserRequest {

    const FUNCTION = "DescribeStatus";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return DescribeStatusRequest
	 */
	public function withResourcePoolName($resourcePoolName): DescribeStatusRequest {
	 ...
	 * @return DescribeStatusRequest
	 */
	public function withStatusIds($statusIds): DescribeStatusRequest {
	 ...
	 * @return DescribeStatusRequest
	 */
	public function withPageToken($pageToken): DescribeStatusRequest {
	 ...
	 * @return DescribeStatusRequest
	 */
	public function withLimit($limit): DescribeStatusRequest {
		$this->setLimit($limit);
		return $this;
	}
