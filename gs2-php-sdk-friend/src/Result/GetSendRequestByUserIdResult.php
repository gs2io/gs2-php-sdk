...
/**
 * ユーザーIDを指定して送信したフレンドリクエストを取得 のレスポンスモデル
 *
...
class GetSendRequestByUserIdResult implements IResult {
	 ...
	 * フレンドリクエストを取得
	 *
	 * @return FriendRequest|null ユーザーIDを指定して送信したフレンドリクエストを取得
	 */
	 ...
	 * フレンドリクエストを設定
	 *
	 * @param FriendRequest|null $item ユーザーIDを指定して送信したフレンドリクエストを取得
	 */
	public function setItem(?FriendRequest $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetSendRequestByUserIdResult {
        $result = new GetSendRequestByUserIdResult();
