...
class DescribeRateModelMastersResult implements IResult {
	/** @var RateModelMaster[] 強化レートマスターのリスト */
	private $items;
	 ...
	 * 強化レートマスターのリストを取得
	 *
	 * @return RateModelMaster[]|null 強化レートマスターの一覧を取得
	 */
	 ...
	 * 強化レートマスターのリストを設定
	 *
	 * @param RateModelMaster[]|null $items 強化レートマスターの一覧を取得
	 */
	 ...
	 *
	 * @param string|null $nextPageToken 強化レートマスターの一覧を取得
	 */
