...
class DescribeDataObjectHistoriesByUserIdIterator implements Iterator {
    ...
    private function load(): void {
        /**
         * @var DescribeDataObjectHistoriesByUserIdResult
         */
         $r = $this->client->describeDataObjectHistoriesByUserId(
