...
class PasswordDomain {
    ...
    public function __construct(
        ...
        \Gs2\Identifier\Domain\Cache\PasswordDomainCache $passwordCache,
        string $userName
    ) {
    ...
    public function load(
        \Gs2\Identifier\Request\GetPasswordRequest $request
    ): \Gs2\Identifier\Result\GetPasswordResult {
        $request->setUserName($this->userName);
        /**
         * @var \Gs2\Identifier\Result\GetPasswordResult
         */
        $r = $this->client->getPassword(
            $request
        );
