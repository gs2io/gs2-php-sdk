...
class GetGlobalRankingByUserIdResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetGlobalRankingByUserIdResult {
        if ($data === null) {
            return null;
        }
        return (new GetGlobalRankingByUserIdResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? GlobalRankingData::fromJson($data['item']) : null);
    }
