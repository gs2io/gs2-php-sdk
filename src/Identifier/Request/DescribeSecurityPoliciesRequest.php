...
class DescribeSecurityPoliciesRequest extends Gs2BasicRequest {
     ...
     */
    public function withPageToken(string $pageToken = null): DescribeSecurityPoliciesRequest {
     ...
     * @return DescribeSecurityPoliciesRequest $this
     */
    public function withLimit(int $limit = null): DescribeSecurityPoliciesRequest {
        $this->setLimit($limit);
        return $this;
    }
