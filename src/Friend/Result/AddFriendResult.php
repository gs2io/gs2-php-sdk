...
class AddFriendResult implements IResult {
    /** @var FriendUser */
    private $item;
	...
	public function withItem(?FriendUser $item): AddFriendResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?AddFriendResult {
        if ($data === null) {
            return null;
        }
