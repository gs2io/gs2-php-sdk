...
class DescribeFormsRequest extends Gs2BasicRequest {
     ...
     * @return DescribeFormsRequest $this
     */
    public function withMoldName(string $moldName): DescribeFormsRequest {
     ...
     * @return DescribeFormsRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider): DescribeFormsRequest {
