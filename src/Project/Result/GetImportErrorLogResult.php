...
class GetImportErrorLogResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetImportErrorLogResult {
        if ($data === null) {
            return null;
        }
        return (new GetImportErrorLogResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? ImportErrorLog::fromJson($data['item']) : null);
    }
