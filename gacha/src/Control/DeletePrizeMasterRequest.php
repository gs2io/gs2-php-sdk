 ...
 */
class DeletePrizeMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeletePrizeMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DeletePrizeMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): DeletePrizeMasterRequest {
	 ...
	 * @return DeletePrizeMasterRequest
	 */
	public function withPrizeTableName($prizeTableName): DeletePrizeMasterRequest {
	 ...
	 * @return DeletePrizeMasterRequest
	 */
	public function withRarityName($rarityName): DeletePrizeMasterRequest {
	 ...
	 * @return DeletePrizeMasterRequest
	 */
	public function withResourceId($resourceId): DeletePrizeMasterRequest {
