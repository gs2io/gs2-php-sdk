...
class ApplyRankCapByUserIdResult implements IResult {
    /** @var Status */
    private $item;
    /** @var string */
	...
	public function withItem(?Status $item): ApplyRankCapByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withExperienceNamespaceName(?string $experienceNamespaceName): ApplyRankCapByUserIdResult {
		$this->experienceNamespaceName = $experienceNamespaceName;
		return $this;
	}
	...
	public function withExperienceStatus(?ExperienceStatus $experienceStatus): ApplyRankCapByUserIdResult {
		$this->experienceStatus = $experienceStatus;
		return $this;
	}

    public static function fromJson(?array $data): ?ApplyRankCapByUserIdResult {
        if ($data === null) {
            return null;
        }
