...
class GetTransactionResultResult implements IResult {
	...
	public function withItem(?TransactionResult $item): GetTransactionResultResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetTransactionResultResult {
        if ($data === null) {
            return null;
        }
