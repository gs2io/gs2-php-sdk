 ...
 */
class DeleteCounterMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteCounterMaster";
	 ...
	 *
	 * @param string $limitName 回数制限の名前を指定します。
	 * @return DeleteCounterMasterRequest
	 */
	public function withLimitName($limitName): DeleteCounterMasterRequest {
	 ...
	 * @return DeleteCounterMasterRequest
	 */
	public function withCounterName($counterName): DeleteCounterMasterRequest {
