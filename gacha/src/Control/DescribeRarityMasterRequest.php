 ...
 */
class DescribeRarityMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeRarityMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DescribeRarityMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): DescribeRarityMasterRequest {
	 ...
	 * @return DescribeRarityMasterRequest
	 */
	public function withPrizeTableName($prizeTableName): DescribeRarityMasterRequest {
	 ...
	 * @return DescribeRarityMasterRequest
	 */
	public function withPageToken($pageToken): DescribeRarityMasterRequest {
	 ...
	 * @return DescribeRarityMasterRequest
	 */
	public function withLimit($limit): DescribeRarityMasterRequest {
		$this->setLimit($limit);
		return $this;
	}
