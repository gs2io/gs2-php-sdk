...
class CreateTakeOverOpenIdConnectRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): CreateTakeOverOpenIdConnectRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?CreateTakeOverOpenIdConnectRequest {
        if ($data === null) {
            return null;
        }
