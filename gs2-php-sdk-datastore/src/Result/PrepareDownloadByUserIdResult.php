...
class PrepareDownloadByUserIdResult implements IResult {
	 ...
	 * データオブジェクトを取得
	 *
	 * @return DataObject|null ユーザIDを指定してデータオブジェクトをダウンロード準備する
	 */
	 ...
	 * データオブジェクトを設定
	 *
	 * @param DataObject|null $item ユーザIDを指定してデータオブジェクトをダウンロード準備する
	 */
	 ...
	 *
	 * @param string|null $fileUrl ユーザIDを指定してデータオブジェクトをダウンロード準備する
	 */
	 ...
	 * ファイルの容量を取得
	 *
	 * @return int|null ユーザIDを指定してデータオブジェクトをダウンロード準備する
	 */
	 ...
	 * ファイルの容量を設定
	 *
	 * @param int|null $contentLength ユーザIDを指定してデータオブジェクトをダウンロード準備する
	 */
	public function setContentLength(?int $contentLength) {
		$this->contentLength = $contentLength;
	}

    public static function fromJson(array $data): PrepareDownloadByUserIdResult {
        $result = new PrepareDownloadByUserIdResult();
