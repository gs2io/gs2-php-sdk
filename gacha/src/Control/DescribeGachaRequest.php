 ...
 */
class DescribeGachaRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeGacha";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DescribeGachaRequest
	 */
	public function withGachaPoolName($gachaPoolName): DescribeGachaRequest {
