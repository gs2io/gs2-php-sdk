...
class DeleteReferenceOfByUserIdResult implements IResult {
	 ...
	 *
	 * @param ItemSet|null $itemSet 参照元を削除
	 */
	 ...
	 * アイテムモデルを設定
	 *
	 * @param ItemModel|null $itemModel 参照元を削除
	 */
	 ...
	 * インベントリを設定
	 *
	 * @param Inventory|null $inventory 参照元を削除
	 */
    ...
    public static function fromJson(array $data): DeleteReferenceOfByUserIdResult {
        $result = new DeleteReferenceOfByUserIdResult();
