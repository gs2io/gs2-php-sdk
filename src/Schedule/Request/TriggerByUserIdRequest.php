...
class TriggerByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): TriggerByUserIdRequest {
     ...
     * @return TriggerByUserIdRequest $this
     */
    public function withTriggerName(string $triggerName = null): TriggerByUserIdRequest {
     ...
     * @return TriggerByUserIdRequest $this
     */
    public function withUserId(string $userId = null): TriggerByUserIdRequest {
     ...
     */
    public function setTriggerStrategy(string $triggerStrategy = null) {
     ...
     * @return TriggerByUserIdRequest $this
     */
    public function withTriggerStrategy(string $triggerStrategy = null): TriggerByUserIdRequest {
     ...
     * @return TriggerByUserIdRequest $this
     */
    public function withTtl(int $ttl = null): TriggerByUserIdRequest {
        $this->setTtl($ttl);
        return $this;
    }
     ...
     * @return TriggerByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): TriggerByUserIdRequest {
