...
class DescribeResourcesRequest extends Gs2BasicRequest {
     ...
     */
    public function withStackName(string $stackName = null): DescribeResourcesRequest {
     ...
     * @return DescribeResourcesRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeResourcesRequest {
     ...
     * @return DescribeResourcesRequest $this
     */
    public function withLimit(int $limit = null): DescribeResourcesRequest {
        $this->setLimit($limit);
        return $this;
    }
