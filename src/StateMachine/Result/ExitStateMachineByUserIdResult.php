...
class ExitStateMachineByUserIdResult implements IResult {
    /** @var Status */
    private $item;
	...
	public function withItem(?Status $item): ExitStateMachineByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?ExitStateMachineByUserIdResult {
        if ($data === null) {
            return null;
        }
