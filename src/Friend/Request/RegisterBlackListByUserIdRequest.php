...
class RegisterBlackListByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): RegisterBlackListByUserIdRequest {
     ...
     * @return RegisterBlackListByUserIdRequest $this
     */
    public function withUserId(string $userId = null): RegisterBlackListByUserIdRequest {
     ...
     * @return RegisterBlackListByUserIdRequest $this
     */
    public function withTargetUserId(string $targetUserId = null): RegisterBlackListByUserIdRequest {
     ...
     * @return RegisterBlackListByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): RegisterBlackListByUserIdRequest {
