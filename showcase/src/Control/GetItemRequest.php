 ...
 */
class GetItemRequest extends Gs2UserRequest {
	 ...
	 */
	public function withShowcaseName($showcaseName): GetItemRequest {
	 ...
	 * @return GetItemRequest
	 */
	public function withShowcaseItemId($showcaseItemId): GetItemRequest {
