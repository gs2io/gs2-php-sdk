...
class CheckVersionRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName バージョンチェック
     * @return CheckVersionRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): CheckVersionRequest {
     ...
     * @return CheckVersionRequest $this
     */
    public function withTargetVersions(array $targetVersions = null): CheckVersionRequest {
     ...
     * @return CheckVersionRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): CheckVersionRequest {
