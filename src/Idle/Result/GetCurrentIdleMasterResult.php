...
class GetCurrentIdleMasterResult implements IResult {
	...
	public function withItem(?CurrentCategoryMaster $item): GetCurrentIdleMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetCurrentIdleMasterResult {
        if ($data === null) {
            return null;
        }
