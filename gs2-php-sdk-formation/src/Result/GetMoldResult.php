...
class GetMoldResult implements IResult {
	 ...
	 * 保存したフォームを設定
	 *
	 * @param Mold|null $item 保存したフォームを取得
	 */
	 ...
	 * フォームの保存領域を取得
	 *
	 * @return MoldModel|null 保存したフォームを取得
	 */
	 ...
	 * フォームの保存領域を設定
	 *
	 * @param MoldModel|null $moldModel 保存したフォームを取得
	 */
	public function setMoldModel(?MoldModel $moldModel) {
		$this->moldModel = $moldModel;
	}

    public static function fromJson(array $data): GetMoldResult {
        $result = new GetMoldResult();
