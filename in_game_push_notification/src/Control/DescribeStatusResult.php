...
use Gs2\InGamePushNotification\Model\Status;

/**
 * @author Game Server Services, Inc.
 */
class DescribeStatusResult {

	/** @var Status[] オンラインステータス */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, Status::build($arr));
            }
        }
