...
class GetBoxByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetBoxByUserIdRequest {
     ...
     * @return GetBoxByUserIdRequest $this
     */
    public function withPrizeTableName(string $prizeTableName = null): GetBoxByUserIdRequest {
     ...
     * @return GetBoxByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetBoxByUserIdRequest {
     ...
     * @return GetBoxByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetBoxByUserIdRequest {
