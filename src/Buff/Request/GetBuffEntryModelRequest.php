...
class GetBuffEntryModelRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetBuffEntryModelRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withBuffEntryName(?string $buffEntryName): GetBuffEntryModelRequest {
		$this->buffEntryName = $buffEntryName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetBuffEntryModelRequest {
        if ($data === null) {
            return null;
        }
