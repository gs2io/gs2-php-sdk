...
use Gs2\Lottery\Domain\Cache\LotteryModelMasterDomainCache;
...
class DescribeLotteryModelMastersIterator implements Iterator {

    /**
     * @var LotteryModelMasterDomainCache
     */
    ...
    public function __construct(
        LotteryModelMasterDomainCache $lotteryModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeLotteryModelMastersResult
         */
         $r = $this->client->describeLotteryModelMasters(
