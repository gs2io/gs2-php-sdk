...
class QueryExecuteStampTaskLogRequest extends Gs2BasicRequest {
     ...
     * @return QueryExecuteStampTaskLogRequest $this
     */
    public function withBegin(int $begin = null): QueryExecuteStampTaskLogRequest {
        $this->setBegin($begin);
        return $this;
    }
     ...
     * @return QueryExecuteStampTaskLogRequest $this
     */
    public function withEnd(int $end = null): QueryExecuteStampTaskLogRequest {
        $this->setEnd($end);
        return $this;
    }
     ...
     * @return QueryExecuteStampTaskLogRequest $this
     */
    public function withLongTerm(bool $longTerm = null): QueryExecuteStampTaskLogRequest {
