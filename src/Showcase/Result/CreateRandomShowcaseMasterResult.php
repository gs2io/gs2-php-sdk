...
class CreateRandomShowcaseMasterResult implements IResult {
    ...
    public static function fromJson(?array $data): ?CreateRandomShowcaseMasterResult {
        if ($data === null) {
            return null;
        }
        return (new CreateRandomShowcaseMasterResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? RandomShowcaseMaster::fromJson($data['item']) : null);
    }
