 ...
 */
class GetGoldPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGoldPool";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return GetGoldPoolRequest
	 */
	public function withGoldPoolName($goldPoolName): GetGoldPoolRequest {
