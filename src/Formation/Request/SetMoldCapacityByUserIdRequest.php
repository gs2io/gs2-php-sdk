...
class SetMoldCapacityByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SetMoldCapacityByUserIdRequest {
     ...
     * @return SetMoldCapacityByUserIdRequest $this
     */
    public function withUserId(string $userId = null): SetMoldCapacityByUserIdRequest {
     ...
     * @return SetMoldCapacityByUserIdRequest $this
     */
    public function withMoldName(string $moldName = null): SetMoldCapacityByUserIdRequest {
     ...
     * @return SetMoldCapacityByUserIdRequest $this
     */
    public function withCapacity(int $capacity = null): SetMoldCapacityByUserIdRequest {
     ...
     * @return SetMoldCapacityByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetMoldCapacityByUserIdRequest {
