...
class GetReferenceOfRequest extends Gs2BasicRequest {
	...
	public function withNamespaceName(?string $namespaceName): GetReferenceOfRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withInventoryName(?string $inventoryName): GetReferenceOfRequest {
		$this->inventoryName = $inventoryName;
		return $this;
	}
	...
	public function withItemName(?string $itemName): GetReferenceOfRequest {
		$this->itemName = $itemName;
		return $this;
	}
	...
	public function withItemSetName(?string $itemSetName): GetReferenceOfRequest {
		$this->itemSetName = $itemSetName;
		return $this;
	}
	...
	public function withReferenceOf(?string $referenceOf): GetReferenceOfRequest {
		$this->referenceOf = $referenceOf;
		return $this;
	}

    public static function fromJson(?array $data): ?GetReferenceOfRequest {
        if ($data === null) {
            return null;
        }
