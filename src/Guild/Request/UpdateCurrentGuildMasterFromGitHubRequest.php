...
use Gs2\Guild\Model\GitHubCheckoutSetting;

class UpdateCurrentGuildMasterFromGitHubRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentGuildMasterFromGitHubRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCheckoutSetting(?GitHubCheckoutSetting $checkoutSetting): UpdateCurrentGuildMasterFromGitHubRequest {
		$this->checkoutSetting = $checkoutSetting;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentGuildMasterFromGitHubRequest {
        if ($data === null) {
            return null;
        }
