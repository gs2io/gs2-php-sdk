 ...
 */
class CustomAutoDescribeJoinedUserRequest extends Gs2UserRequest {

    const FUNCTION = "DescribeJoinedUser";
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return CustomAutoDescribeJoinedUserRequest
	 */
	public function withMatchmakingName($matchmakingName): CustomAutoDescribeJoinedUserRequest {
	 ...
	 * @return CustomAutoDescribeJoinedUserRequest
	 */
	public function withGatheringId($gatheringId): CustomAutoDescribeJoinedUserRequest {
