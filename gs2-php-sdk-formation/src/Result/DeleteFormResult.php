...
class DeleteFormResult implements IResult {
	 ...
	 * フォームの保存領域を設定
	 *
	 * @param MoldModel|null $moldModel フォームを削除
	 */
	 ...
	 * フォームモデルを設定
	 *
	 * @param FormModel|null $formModel フォームを削除
	 */
