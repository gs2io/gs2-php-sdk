...
/**
 * ユーザIDを指定してデータオブジェクトを更新する のレスポンスモデル
 *
...
class UpdateDataObjectByUserIdResult implements IResult {
	 ...
	 * データオブジェクトを取得
	 *
	 * @return DataObject|null ユーザIDを指定してデータオブジェクトを更新する
	 */
	 ...
	 * データオブジェクトを設定
	 *
	 * @param DataObject|null $item ユーザIDを指定してデータオブジェクトを更新する
	 */
    ...
    public static function fromJson(array $data): UpdateDataObjectByUserIdResult {
        $result = new UpdateDataObjectByUserIdResult();
