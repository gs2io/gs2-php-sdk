 ...
 */
class DeleteRankingTableRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteRankingTable";
	 ...
	 *
	 * @param string $rankingTableName ランキングテーブルの名前を指定します。
	 * @return DeleteRankingTableRequest
	 */
	public function withRankingTableName($rankingTableName): DeleteRankingTableRequest {
