...
class UnlockIncrementalExchangeByUserIdResult implements IResult {
	...
	public function withItem(?IncrementalRateModel $item): UnlockIncrementalExchangeByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UnlockIncrementalExchangeByUserIdResult {
        if ($data === null) {
            return null;
        }
