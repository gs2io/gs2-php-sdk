...
class EarlyCompleteByUserIdResult implements IResult {
    /** @var Gathering */
    private $item;
	...
	public function withItem(?Gathering $item): EarlyCompleteByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?EarlyCompleteByUserIdResult {
        if ($data === null) {
            return null;
        }
