...
class DescribeDataObjectHistoriesByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeDataObjectHistoriesByUserIdRequest {
     ...
     * @return DescribeDataObjectHistoriesByUserIdRequest $this
     */
    public function withUserId(string $userId = null): DescribeDataObjectHistoriesByUserIdRequest {
     ...
     * @return DescribeDataObjectHistoriesByUserIdRequest $this
     */
    public function withDataObjectName(string $dataObjectName = null): DescribeDataObjectHistoriesByUserIdRequest {
     ...
     * @return DescribeDataObjectHistoriesByUserIdRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeDataObjectHistoriesByUserIdRequest {
     ...
     * @return DescribeDataObjectHistoriesByUserIdRequest $this
     */
    public function withLimit(int $limit = null): DescribeDataObjectHistoriesByUserIdRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeDataObjectHistoriesByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeDataObjectHistoriesByUserIdRequest {
