 ...
 */
class CheckEstimateScanByteByAllRoomRequest extends Gs2BasicRequest {

    const FUNCTION = "CheckEstimateScanByteByAllRoom";
	 ...
	 *
	 * @param string $lobbyName ロビーの名前
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withLobbyName($lobbyName): CheckEstimateScanByteByAllRoomRequest {
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withUserId($userId): CheckEstimateScanByteByAllRoomRequest {
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withMessage($message): CheckEstimateScanByteByAllRoomRequest {
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withMeta($meta): CheckEstimateScanByteByAllRoomRequest {
		$this->setMeta($meta);
		return $this;
	}
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withBegin($begin): CheckEstimateScanByteByAllRoomRequest {
		$this->setBegin($begin);
		return $this;
	}
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withEnd($end): CheckEstimateScanByteByAllRoomRequest {
		$this->setEnd($end);
		return $this;
	}
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withPageToken($pageToken): CheckEstimateScanByteByAllRoomRequest {
	 ...
	 * @return CheckEstimateScanByteByAllRoomRequest
	 */
	public function withLimit($limit): CheckEstimateScanByteByAllRoomRequest {
		$this->setLimit($limit);
		return $this;
	}
