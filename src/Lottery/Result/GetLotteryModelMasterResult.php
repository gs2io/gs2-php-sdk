...
class GetLotteryModelMasterResult implements IResult {
	/** @var LotteryModelMaster 抽選の種類マスター */
	private $item;

	/**
	 * 抽選の種類マスターを取得
	 *
	 * @return LotteryModelMaster|null 抽選の種類マスターを取得
	 */
	 ...
	 * 抽選の種類マスターを設定
	 *
	 * @param LotteryModelMaster|null $item 抽選の種類マスターを取得
	 */
	public function setItem(?LotteryModelMaster $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetLotteryModelMasterResult {
        $result = new GetLotteryModelMasterResult();
