...
class UnregisterBlackListResult implements IResult {
	 ...
	 * ブラックリストを取得
	 *
	 * @return BlackList|null ブラックリストからユーザを削除
	 */
	 ...
	 * ブラックリストを設定
	 *
	 * @param BlackList|null $item ブラックリストからユーザを削除
	 */
	public function setItem(?BlackList $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): UnregisterBlackListResult {
        $result = new UnregisterBlackListResult();
