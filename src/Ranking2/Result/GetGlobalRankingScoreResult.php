...
class GetGlobalRankingScoreResult implements IResult {
	...
	public function withItem(?GlobalRankingScore $item): GetGlobalRankingScoreResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetGlobalRankingScoreResult {
        if ($data === null) {
            return null;
        }
