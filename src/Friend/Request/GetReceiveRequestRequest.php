...
class GetReceiveRequestRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetReceiveRequestRequest {
     ...
     * @return GetReceiveRequestRequest $this
     */
    public function withFromUserId(string $fromUserId = null): GetReceiveRequestRequest {
     ...
     * @return GetReceiveRequestRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetReceiveRequestRequest {
