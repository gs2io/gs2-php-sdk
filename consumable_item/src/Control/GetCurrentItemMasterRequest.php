 ...
 */
class GetCurrentItemMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetCurrentItemMaster";
	 ...
	 *
	 * @param string $itemPoolName アイテムプールの名前を指定します。
	 * @return GetCurrentItemMasterRequest
	 */
	public function withItemPoolName($itemPoolName): GetCurrentItemMasterRequest {
