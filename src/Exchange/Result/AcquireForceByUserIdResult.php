...
class AcquireForceByUserIdResult implements IResult {
    /** @var Await */
    private $item;
    /** @var string */
	...
	public function withItem(?Await $item): AcquireForceByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): AcquireForceByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): AcquireForceByUserIdResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): AcquireForceByUserIdResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): AcquireForceByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): AcquireForceByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): AcquireForceByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): AcquireForceByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?AcquireForceByUserIdResult {
        if ($data === null) {
            return null;
        }
