...
use Gs2\Formation\Domain\Cache\FormModelMasterDomainCache;
...
class DescribeFormModelMastersIterator implements Iterator {

    /**
     * @var FormModelMasterDomainCache
     */
    ...
    public function __construct(
        FormModelMasterDomainCache $formModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeFormModelMastersResult
         */
         $r = $this->client->describeFormModelMasters(
