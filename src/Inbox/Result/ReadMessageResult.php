...
class ReadMessageResult implements IResult {
	...
	public function withTransactionId(?string $transactionId): ReadMessageResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): ReadMessageResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): ReadMessageResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): ReadMessageResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): ReadMessageResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
