...
class DescribeAcceptVersionsRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeAcceptVersionsRequest {
     ...
     * @return DescribeAcceptVersionsRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeAcceptVersionsRequest {
     ...
     * @return DescribeAcceptVersionsRequest $this
     */
    public function withLimit(int $limit = null): DescribeAcceptVersionsRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeAcceptVersionsRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeAcceptVersionsRequest {
