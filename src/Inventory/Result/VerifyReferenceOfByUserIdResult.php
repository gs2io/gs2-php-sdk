...
class VerifyReferenceOfByUserIdResult implements IResult {
	...
	public function withItem(?string $item): VerifyReferenceOfByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withItemSet(?ItemSet $itemSet): VerifyReferenceOfByUserIdResult {
		$this->itemSet = $itemSet;
		return $this;
	}
	...
	public function withItemModel(?ItemModel $itemModel): VerifyReferenceOfByUserIdResult {
		$this->itemModel = $itemModel;
		return $this;
	}
	...
	public function withInventory(?Inventory $inventory): VerifyReferenceOfByUserIdResult {
		$this->inventory = $inventory;
		return $this;
	}
