 ...
 */
class SetMaxValueByStampSheetRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $stampSheet スタンプシートでスタミナの最大値を更新
     * @return SetMaxValueByStampSheetRequest $this
     */
    public function withStampSheet(string $stampSheet = null): SetMaxValueByStampSheetRequest {
     ...
     * @return SetMaxValueByStampSheetRequest $this
     */
    public function withKeyId(string $keyId = null): SetMaxValueByStampSheetRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return SetMaxValueByStampSheetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetMaxValueByStampSheetRequest {
