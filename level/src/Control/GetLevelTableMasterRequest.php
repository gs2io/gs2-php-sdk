 ...
 */
class GetLevelTableMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetLevelTableMaster";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return GetLevelTableMasterRequest
	 */
	public function withResourcePoolName($resourcePoolName): GetLevelTableMasterRequest {
	 ...
	 * @return GetLevelTableMasterRequest
	 */
	public function withLevelTableName($levelTableName): GetLevelTableMasterRequest {
