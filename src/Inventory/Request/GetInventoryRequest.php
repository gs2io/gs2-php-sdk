...
class GetInventoryRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName インベントリを取得
     * @return GetInventoryRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetInventoryRequest {
     ...
     * @return GetInventoryRequest $this
     */
    public function withInventoryName(string $inventoryName = null): GetInventoryRequest {
     ...
     * @return GetInventoryRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetInventoryRequest {
