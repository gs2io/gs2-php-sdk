...
class SetRecoverIntervalByStampSheetResult implements IResult {
	 ...
	 * スタミナを取得
	 *
	 * @return Stamina|null スタンプシートでスタミナの最大値を更新
	 */
	 ...
	 * スタミナを設定
	 *
	 * @param Stamina|null $item スタンプシートでスタミナの最大値を更新
	 */
	 ...
	 * スタミナモデルを取得
	 *
	 * @return StaminaModel|null スタンプシートでスタミナの最大値を更新
	 */
	 ...
	 * スタミナモデルを設定
	 *
	 * @param StaminaModel|null $staminaModel スタンプシートでスタミナの最大値を更新
	 */
    ...
    public static function fromJson(array $data): SetRecoverIntervalByStampSheetResult {
        $result = new SetRecoverIntervalByStampSheetResult();
