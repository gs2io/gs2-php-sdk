...
class ExtendTriggerByUserIdResult implements IResult {
    /** @var Trigger */
    private $item;
	...
	public function withItem(?Trigger $item): ExtendTriggerByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?ExtendTriggerByUserIdResult {
        if ($data === null) {
            return null;
        }
