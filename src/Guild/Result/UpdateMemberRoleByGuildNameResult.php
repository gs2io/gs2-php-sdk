...
class UpdateMemberRoleByGuildNameResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): UpdateMemberRoleByGuildNameResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateMemberRoleByGuildNameResult {
        if ($data === null) {
            return null;
        }
