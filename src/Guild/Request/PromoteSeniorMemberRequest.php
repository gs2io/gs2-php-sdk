...
class PromoteSeniorMemberRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): PromoteSeniorMemberRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?PromoteSeniorMemberRequest {
        if ($data === null) {
            return null;
        }
