 ...
 */
class PasscodeEarlyCompleteGatheringRequest extends Gs2UserRequest {

    const FUNCTION = "EarlyCompleteGathering";

	/** @var string マッチメイキングの名前を指定します。 */
	private $matchmakingName;

	/** @var string ギャザリングIDを指定します。 */
	private $gatheringId;
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return PasscodeEarlyCompleteGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): PasscodeEarlyCompleteGatheringRequest {
	 ...
	 * ギャザリングIDを指定します。を設定
	 *
	 * @param string $gatheringId ギャザリングIDを指定します。
	 */
	 ...
	 * @return PasscodeEarlyCompleteGatheringRequest
	 */
	public function withGatheringId($gatheringId): PasscodeEarlyCompleteGatheringRequest {
