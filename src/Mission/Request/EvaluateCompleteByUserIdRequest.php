...
class EvaluateCompleteByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): EvaluateCompleteByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?EvaluateCompleteByUserIdRequest {
        if ($data === null) {
            return null;
        }
