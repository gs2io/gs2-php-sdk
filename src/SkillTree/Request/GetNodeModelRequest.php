...
class GetNodeModelRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetNodeModelRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withNodeModelName(?string $nodeModelName): GetNodeModelRequest {
		$this->nodeModelName = $nodeModelName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetNodeModelRequest {
        if ($data === null) {
            return null;
        }
