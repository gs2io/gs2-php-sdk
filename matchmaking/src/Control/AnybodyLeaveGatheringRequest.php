 ...
 */
class AnybodyLeaveGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return AnybodyLeaveGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): AnybodyLeaveGatheringRequest {
	 ...
	 * @return AnybodyLeaveGatheringRequest
	 */
	public function withGatheringId($gatheringId): AnybodyLeaveGatheringRequest {
