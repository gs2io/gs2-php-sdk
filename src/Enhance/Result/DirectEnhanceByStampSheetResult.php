...
class DirectEnhanceByStampSheetResult implements IResult {
	...
	public function withAtomicCommit(?bool $atomicCommit): DirectEnhanceByStampSheetResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): DirectEnhanceByStampSheetResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): DirectEnhanceByStampSheetResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
