...
class GetMessageByUserIdResult implements IResult {
	 ...
	 * メッセージを取得
	 *
	 * @return Message|null ユーザーIDを指定してメッセージを取得
	 */
	 ...
	 * メッセージを設定
	 *
	 * @param Message|null $item ユーザーIDを指定してメッセージを取得
	 */
	public function setItem(?Message $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetMessageByUserIdResult {
        $result = new GetMessageByUserIdResult();
