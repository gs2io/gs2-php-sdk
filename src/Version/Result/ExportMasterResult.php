...
/**
 * 現在有効なバージョンのマスターデータをエクスポートします のレスポンスモデル
 *
...
class ExportMasterResult implements IResult {
	 ...
	 * 現在有効なバージョンを取得
	 *
	 * @return CurrentVersionMaster|null 現在有効なバージョンのマスターデータをエクスポートします
	 */
	 ...
	 * 現在有効なバージョンを設定
	 *
	 * @param CurrentVersionMaster|null $item 現在有効なバージョンのマスターデータをエクスポートします
	 */
