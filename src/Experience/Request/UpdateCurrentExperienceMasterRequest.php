...
class UpdateCurrentExperienceMasterRequest extends Gs2BasicRequest {
	...
	public function withMode(?string $mode): UpdateCurrentExperienceMasterRequest {
		$this->mode = $mode;
		return $this;
	}
	...
	public function withUploadToken(?string $uploadToken): UpdateCurrentExperienceMasterRequest {
		$this->uploadToken = $uploadToken;
		return $this;
	}
