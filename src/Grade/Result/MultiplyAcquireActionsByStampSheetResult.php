...
class MultiplyAcquireActionsByStampSheetResult implements IResult {
    /** @var array */
    private $items;
    /** @var string */
	...
	public function withItems(?array $items): MultiplyAcquireActionsByStampSheetResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): MultiplyAcquireActionsByStampSheetResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): MultiplyAcquireActionsByStampSheetResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): MultiplyAcquireActionsByStampSheetResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): MultiplyAcquireActionsByStampSheetResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): MultiplyAcquireActionsByStampSheetResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): MultiplyAcquireActionsByStampSheetResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): MultiplyAcquireActionsByStampSheetResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?MultiplyAcquireActionsByStampSheetResult {
        if ($data === null) {
            return null;
        }
