...
class DeleteCounterResult implements IResult {
    /** @var Counter */
    private $item;
	...
	public function withItem(?Counter $item): DeleteCounterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteCounterResult {
        if ($data === null) {
            return null;
        }
