...
class DirectEnhanceByStampSheetResult implements IResult {
	 ...
	 * 強化レートモデルを取得
	 *
	 * @return RateModel|null スタンプシートで強化を実行
	 */
	 ...
	 * 強化レートモデルを設定
	 *
	 * @param RateModel|null $item スタンプシートで強化を実行
	 */
	 ...
	 *
	 * @param string|null $stampSheet スタンプシートで強化を実行
	 */
	 ...
	 *
	 * @param string|null $stampSheetEncryptionKeyId スタンプシートで強化を実行
	 */
	 ...
	 * 獲得経験値量を設定
	 *
	 * @param int|null $acquireExperience スタンプシートで強化を実行
	 */
	 ...
	 *
	 * @return float|null スタンプシートで強化を実行
	 */
	 ...
	 *
	 * @param float|null $bonusRate スタンプシートで強化を実行
	 */
    ...
    public static function fromJson(array $data): DirectEnhanceByStampSheetResult {
        $result = new DirectEnhanceByStampSheetResult();
