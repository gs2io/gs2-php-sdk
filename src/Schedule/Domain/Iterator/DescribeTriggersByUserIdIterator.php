...
use Gs2\Schedule\Domain\Cache\TriggerDomainCache;
...
class DescribeTriggersByUserIdIterator implements Iterator {

    /**
     * @var TriggerDomainCache
     */
    ...
    public function __construct(
        TriggerDomainCache $triggerCache,
    ...
    private function load(): void {
        /**
         * @var DescribeTriggersByUserIdResult
         */
         $r = $this->client->describeTriggersByUserId(
