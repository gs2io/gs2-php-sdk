...
class GetStatusModelRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetStatusModelRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withNodeModelName(?string $nodeModelName): GetStatusModelRequest {
		$this->nodeModelName = $nodeModelName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetStatusModelRequest {
        if ($data === null) {
            return null;
        }
