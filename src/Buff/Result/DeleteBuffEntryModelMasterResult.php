...
class DeleteBuffEntryModelMasterResult implements IResult {
	...
	public function withItem(?BuffEntryModelMaster $item): DeleteBuffEntryModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteBuffEntryModelMasterResult {
        if ($data === null) {
            return null;
        }
