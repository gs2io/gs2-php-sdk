...
class DeleteTriggerRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DeleteTriggerRequest {
     ...
     * @return DeleteTriggerRequest $this
     */
    public function withTriggerName(string $triggerName = null): DeleteTriggerRequest {
     ...
     * @return DeleteTriggerRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DeleteTriggerRequest {
