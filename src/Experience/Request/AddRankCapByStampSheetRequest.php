...
class AddRankCapByStampSheetRequest extends Gs2BasicRequest {
     ...
     */
    public function withStampSheet(string $stampSheet = null): AddRankCapByStampSheetRequest {
     ...
     * @return AddRankCapByStampSheetRequest $this
     */
    public function withKeyId(string $keyId = null): AddRankCapByStampSheetRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return AddRankCapByStampSheetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): AddRankCapByStampSheetRequest {
