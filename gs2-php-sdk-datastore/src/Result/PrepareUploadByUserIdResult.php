...
class PrepareUploadByUserIdResult implements IResult {
	 ...
	 * データオブジェクトを取得
	 *
	 * @return DataObject|null ユーザIDを指定してデータオブジェクトをアップロード準備する
	 */
	 ...
	 * データオブジェクトを設定
	 *
	 * @param DataObject|null $item ユーザIDを指定してデータオブジェクトをアップロード準備する
	 */
	 ...
	 *
	 * @param string|null $uploadUrl ユーザIDを指定してデータオブジェクトをアップロード準備する
	 */
    ...
    public static function fromJson(array $data): PrepareUploadByUserIdResult {
        $result = new PrepareUploadByUserIdResult();
