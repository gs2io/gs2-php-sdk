...
class UpdateBannedResult implements IResult {
    /** @var Account */
    private $item;
	...
	public function withItem(?Account $item): UpdateBannedResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateBannedResult {
        if ($data === null) {
            return null;
        }
