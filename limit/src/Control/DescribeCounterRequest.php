 ...
 */
class DescribeCounterRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeCounter";
	 ...
	 *
	 * @param string $limitName 回数制限の名前を指定します。
	 * @return DescribeCounterRequest
	 */
	public function withLimitName($limitName): DescribeCounterRequest {
	 ...
	 * @return DescribeCounterRequest
	 */
	public function withPageToken($pageToken): DescribeCounterRequest {
	 ...
	 * @return DescribeCounterRequest
	 */
	public function withLimit($limit): DescribeCounterRequest {
		$this->setLimit($limit);
		return $this;
	}
