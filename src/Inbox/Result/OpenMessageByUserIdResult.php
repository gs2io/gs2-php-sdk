...
class OpenMessageByUserIdResult implements IResult {
    /** @var Message */
    private $item;
	...
	public function withItem(?Message $item): OpenMessageByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?OpenMessageByUserIdResult {
        if ($data === null) {
            return null;
        }
