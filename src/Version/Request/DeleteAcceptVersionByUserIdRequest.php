...
class DeleteAcceptVersionByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DeleteAcceptVersionByUserIdRequest {
     ...
     * @return DeleteAcceptVersionByUserIdRequest $this
     */
    public function withUserId(string $userId = null): DeleteAcceptVersionByUserIdRequest {
     ...
     * @return DeleteAcceptVersionByUserIdRequest $this
     */
    public function withVersionName(string $versionName = null): DeleteAcceptVersionByUserIdRequest {
     ...
     * @return DeleteAcceptVersionByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DeleteAcceptVersionByUserIdRequest {
