...
class BuyResult implements IResult {
	...
	public function withAtomicCommit(?bool $atomicCommit): BuyResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): BuyResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): BuyResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
