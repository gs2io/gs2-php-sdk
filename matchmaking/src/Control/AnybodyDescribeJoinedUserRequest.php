 ...
 */
class AnybodyDescribeJoinedUserRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return AnybodyDescribeJoinedUserRequest
	 */
	public function withMatchmakingName($matchmakingName): AnybodyDescribeJoinedUserRequest {
	 ...
	 * @return AnybodyDescribeJoinedUserRequest
	 */
	public function withGatheringId($gatheringId): AnybodyDescribeJoinedUserRequest {
