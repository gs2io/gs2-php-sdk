...
class DeleteGuildModelMasterResult implements IResult {
	...
	public function withItem(?GuildModelMaster $item): DeleteGuildModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteGuildModelMasterResult {
        if ($data === null) {
            return null;
        }
