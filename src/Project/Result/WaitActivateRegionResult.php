...
class WaitActivateRegionResult implements IResult {
    /** @var Project */
    private $item;
	...
	public function withItem(?Project $item): WaitActivateRegionResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?WaitActivateRegionResult {
        if ($data === null) {
            return null;
        }
