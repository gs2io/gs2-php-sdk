...
class UpdateTakeOverByUserIdResult implements IResult {
    /** @var TakeOver */
    private $item;
	...
	public function withItem(?TakeOver $item): UpdateTakeOverByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateTakeOverByUserIdResult {
        if ($data === null) {
            return null;
        }
