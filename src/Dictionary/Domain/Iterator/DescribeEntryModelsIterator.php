...
use Gs2\Dictionary\Domain\Cache\EntryModelDomainCache;
...
class DescribeEntryModelsIterator implements Iterator {

    /**
     * @var EntryModelDomainCache
     */
    ...
    public function __construct(
        EntryModelDomainCache $entryModelCache,
    ...
    private function load(): void {
        /**
         * @var DescribeEntryModelsResult
         */
         $r = $this->client->describeEntryModels(
