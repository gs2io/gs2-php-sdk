...
use Gs2\Matchmaking\Domain\Cache\GatheringDomainCache;
...
class DescribeGatheringsIterator implements Iterator {

    /**
     * @var GatheringDomainCache
     */
    ...
    public function __construct(
        GatheringDomainCache $gatheringCache,
    ...
    private function load(): void {
        /**
         * @var DescribeGatheringsResult
         */
         $r = $this->client->describeGatherings(
