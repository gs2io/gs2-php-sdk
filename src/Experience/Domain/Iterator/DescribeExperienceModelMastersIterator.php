...
use Gs2\Experience\Domain\Cache\ExperienceModelMasterDomainCache;
...
class DescribeExperienceModelMastersIterator implements Iterator {

    /**
     * @var ExperienceModelMasterDomainCache
     */
    ...
    /**
     * @var array<ExperienceModelMaster>
     */
    private $result;
    ...
    public function __construct(
        ExperienceModelMasterDomainCache $experienceModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeExperienceModelMastersResult
         */
         $r = $this->client->describeExperienceModelMasters(
