 ...
 */
class GetMyRankRequest extends Gs2UserRequest {

    const FUNCTION = "GetMyRank";
	 ...
	 *
	 * @param string $rankingTableName ランキングテーブルの名前を指定します。
	 * @return GetMyRankRequest
	 */
	public function withRankingTableName($rankingTableName): GetMyRankRequest {
	 ...
	 * @return GetMyRankRequest
	 */
	public function withGameMode($gameMode): GetMyRankRequest {
