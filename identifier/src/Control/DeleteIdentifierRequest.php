...
class DeleteIdentifierRequest extends Gs2BasicRequest {
    ...
    const FUNCTION = "DeleteIdentifier";
	 ...
	 */
	public function withUserName($userName): DeleteIdentifierRequest {
	 ...
	 * @return DeleteIdentifierRequest
	 */
	public function withIdentifierId($identifierId): DeleteIdentifierRequest {
