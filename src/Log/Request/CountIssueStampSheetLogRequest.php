...
class CountIssueStampSheetLogRequest extends Gs2BasicRequest {
	...
	public function withService(?string $service): CountIssueStampSheetLogRequest {
		$this->service = $service;
		return $this;
	}
	...
	public function withMethod(?string $method): CountIssueStampSheetLogRequest {
		$this->method = $method;
		return $this;
	}
	...
	public function withUserId(?string $userId): CountIssueStampSheetLogRequest {
		$this->userId = $userId;
		return $this;
	}
	...
	public function withAction(?string $action): CountIssueStampSheetLogRequest {
		$this->action = $action;
		return $this;
	}
