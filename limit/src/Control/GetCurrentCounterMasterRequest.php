 ...
 */
class GetCurrentCounterMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetCurrentCounterMaster";
	 ...
	 *
	 * @param string $limitName 回数制限の名前を指定します。
	 * @return GetCurrentCounterMasterRequest
	 */
	public function withLimitName($limitName): GetCurrentCounterMasterRequest {
