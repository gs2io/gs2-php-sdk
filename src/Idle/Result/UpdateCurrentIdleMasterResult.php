...
class UpdateCurrentIdleMasterResult implements IResult {
	...
	public function withItem(?CurrentCategoryMaster $item): UpdateCurrentIdleMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentIdleMasterResult {
        if ($data === null) {
            return null;
        }
