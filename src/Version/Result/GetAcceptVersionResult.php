...
class GetAcceptVersionResult implements IResult {
	 ...
	 * 承認したバージョンを取得
	 *
	 * @return AcceptVersion|null 承認したバージョンを取得
	 */
	 ...
	 * 承認したバージョンを設定
	 *
	 * @param AcceptVersion|null $item 承認したバージョンを取得
	 */
	public function setItem(?AcceptVersion $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetAcceptVersionResult {
        $result = new GetAcceptVersionResult();
