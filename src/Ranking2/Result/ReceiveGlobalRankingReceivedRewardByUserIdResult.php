...
class ReceiveGlobalRankingReceivedRewardByUserIdResult implements IResult {
	...
	public function withItem(?GlobalRankingModel $item): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withAcquireActions(?array $acquireActions): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->acquireActions = $acquireActions;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): ReceiveGlobalRankingReceivedRewardByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?ReceiveGlobalRankingReceivedRewardByUserIdResult {
        if ($data === null) {
            return null;
        }
