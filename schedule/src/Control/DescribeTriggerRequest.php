 ...
 */
class DescribeTriggerRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeTrigger";
	 ...
	 */
	public function withScheduleName($scheduleName): DescribeTriggerRequest {
	 ...
	 * @return DescribeTriggerRequest
	 */
	public function withPageToken($pageToken): DescribeTriggerRequest {
	 ...
	 * @return DescribeTriggerRequest
	 */
	public function withLimit($limit): DescribeTriggerRequest {
		$this->setLimit($limit);
		return $this;
	}
