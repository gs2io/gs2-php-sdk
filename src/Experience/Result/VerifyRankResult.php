...
class VerifyRankResult implements IResult {
    /** @var Status */
    private $item;
	...
	public function withItem(?Status $item): VerifyRankResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?VerifyRankResult {
        if ($data === null) {
            return null;
        }
