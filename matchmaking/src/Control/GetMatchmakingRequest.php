 ...
 */
class GetMatchmakingRequest extends Gs2BasicRequest {

    const FUNCTION = "GetMatchmaking";
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return GetMatchmakingRequest
	 */
	public function withMatchmakingName($matchmakingName): GetMatchmakingRequest {
