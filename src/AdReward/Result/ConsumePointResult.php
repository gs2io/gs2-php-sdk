...
class ConsumePointResult implements IResult {
    /** @var Point */
    private $item;
	...
	public function withItem(?Point $item): ConsumePointResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?ConsumePointResult {
        if ($data === null) {
            return null;
        }
