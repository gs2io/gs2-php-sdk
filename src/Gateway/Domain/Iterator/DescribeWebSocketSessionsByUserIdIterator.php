...
use Gs2\Gateway\Domain\Cache\WebSocketSessionDomainCache;
...
class DescribeWebSocketSessionsByUserIdIterator implements Iterator {

    /**
     * @var WebSocketSessionDomainCache
     */
    ...
    public function __construct(
        WebSocketSessionDomainCache $webSocketSessionCache,
    ...
    private function load(): void {
        /**
         * @var DescribeWebSocketSessionsByUserIdResult
         */
         $r = $this->client->describeWebSocketSessionsByUserId(
