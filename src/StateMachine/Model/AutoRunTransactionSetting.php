...
class AutoRunTransactionSetting implements IModel {
	/**
     * @var string
	 */
	...
	public function withDistributorNamespaceId(?string $distributorNamespaceId): AutoRunTransactionSetting {
		$this->distributorNamespaceId = $distributorNamespaceId;
		return $this;
	}
	...
	public function withQueueNamespaceId(?string $queueNamespaceId): AutoRunTransactionSetting {
		$this->queueNamespaceId = $queueNamespaceId;
		return $this;
	}

    public static function fromJson(?array $data): ?AutoRunTransactionSetting {
        if ($data === null) {
            return null;
        }
