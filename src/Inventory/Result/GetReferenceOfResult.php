...
class GetReferenceOfResult implements IResult {
	 ...
	 * 有効期限ごとのアイテム所持数量を設定
	 *
	 * @param ItemSet|null $itemSet 参照元を取得
	 */
	 ...
	 * アイテムモデルを設定
	 *
	 * @param ItemModel|null $itemModel 参照元を取得
	 */
	 ...
	 * インベントリを設定
	 *
	 * @param Inventory|null $inventory 参照元を取得
	 */
    ...
    public static function fromJson(array $data): GetReferenceOfResult {
        $result = new GetReferenceOfResult();
