 ...
 */
class GetGameModeRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGameMode";
	 ...
	 *
	 * @param string $rankingTableName ランキングテーブルの名前を指定します。
	 * @return GetGameModeRequest
	 */
	public function withRankingTableName($rankingTableName): GetGameModeRequest {
	 ...
	 * @return GetGameModeRequest
	 */
	public function withGameMode($gameMode): GetGameModeRequest {
