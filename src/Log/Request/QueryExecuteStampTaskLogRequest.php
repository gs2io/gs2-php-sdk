...
class QueryExecuteStampTaskLogRequest extends Gs2BasicRequest {
	...
	public function withBegin(?int $begin): QueryExecuteStampTaskLogRequest {
		$this->begin = $begin;
		return $this;
	}
	...
	public function withEnd(?int $end): QueryExecuteStampTaskLogRequest {
		$this->end = $end;
		return $this;
	}
	...
	public function withLongTerm(?bool $longTerm): QueryExecuteStampTaskLogRequest {
		$this->longTerm = $longTerm;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?QueryExecuteStampTaskLogRequest {
        if ($data === null) {
            return null;
        }
