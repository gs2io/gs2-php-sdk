 ...
 */
class RoomBreakupGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomBreakupGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomBreakupGatheringRequest {
	 ...
	 * @return RoomBreakupGatheringRequest
	 */
	public function withGatheringId($gatheringId): RoomBreakupGatheringRequest {
