...
class UpdateStaminaByUserIdResult implements IResult {
	...
	public function withItem(?Stamina $item): UpdateStaminaByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): UpdateStaminaByUserIdResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}
