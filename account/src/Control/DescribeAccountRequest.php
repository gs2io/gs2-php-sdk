...
class DescribeAccountRequest extends Gs2BasicRequest {
	 ...
	 */
	public function withGameName($gameName): DescribeAccountRequest {
	 ...
	 * @return DescribeAccountRequest
	 */
	public function withPageToken($pageToken): DescribeAccountRequest {
	 ...
	 * @return DescribeAccountRequest
	 */
	public function withLimit($limit): DescribeAccountRequest {
		$this->setLimit($limit);
		return $this;
	}
