 ...
 */
class GetMoneyStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetMoneyStatus";
	 ...
	 *
	 * @param string $moneyName 取得する課金通貨の名前
	 * @return GetMoneyStatusRequest
	 */
	public function withMoneyName($moneyName): GetMoneyStatusRequest {
