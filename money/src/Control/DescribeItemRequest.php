 ...
 */
class DescribeItemRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeItem";
	 ...
	 *
	 * @param string $moneyName 課金通貨の名前
	 * @return DescribeItemRequest
	 */
	public function withMoneyName($moneyName): DescribeItemRequest {
	 ...
	 * @return DescribeItemRequest
	 */
	public function withPageToken($pageToken): DescribeItemRequest {
	 ...
	 * @return DescribeItemRequest
	 */
	public function withLimit($limit): DescribeItemRequest {
		$this->setLimit($limit);
		return $this;
	}
