...
class GetCurrentBuffMasterResult implements IResult {
	...
	public function withItem(?CurrentBuffMaster $item): GetCurrentBuffMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetCurrentBuffMasterResult {
        if ($data === null) {
            return null;
        }
