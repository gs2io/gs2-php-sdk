...
class GetTakeOverTypeModelResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetTakeOverTypeModelResult {
        if ($data === null) {
            return null;
        }
        return (new GetTakeOverTypeModelResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? TakeOverTypeModel::fromJson($data['item']) : null);
    }
