...
use Gs2\Realtime\Domain\Cache\RoomDomainCache;
...
class DescribeRoomsIterator implements Iterator {
    ...
    private function load(): void {
        /**
         * @var DescribeRoomsResult
         */
         $r = $this->client->describeRooms(
