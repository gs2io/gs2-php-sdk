...
class SetMaxValueByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SetMaxValueByUserIdRequest {
     ...
     * @return SetMaxValueByUserIdRequest $this
     */
    public function withStaminaName(string $staminaName = null): SetMaxValueByUserIdRequest {
     ...
     * @return SetMaxValueByUserIdRequest $this
     */
    public function withUserId(string $userId = null): SetMaxValueByUserIdRequest {
     ...
     * @return SetMaxValueByUserIdRequest $this
     */
    public function withMaxValue(int $maxValue = null): SetMaxValueByUserIdRequest {
     ...
     * @return SetMaxValueByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetMaxValueByUserIdRequest {
