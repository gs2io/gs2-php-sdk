 ...
 *
 */
class CurrentEntryMaster implements IModel {
	/**
     * @var string ネームスペース名
	 */
	 ...
	 *
	 * @param string|null $namespaceName ネームスペース名
	 * @return CurrentEntryMaster $this
	 */
	public function withNamespaceName(?string $namespaceName): CurrentEntryMaster {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	/**
	 ...
	 * @return CurrentEntryMaster $this
	 */
	public function withSettings(?string $settings): CurrentEntryMaster {
		$this->settings = $settings;
		return $this;
	}
    ...
    public static function fromJson(array $data): CurrentEntryMaster {
        $model = new CurrentEntryMaster();
