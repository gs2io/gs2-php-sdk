 ...
 */
class DeleteGatheringPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteGatheringPool";
	 ...
	 *
	 * @param string $gatheringPoolName ギャザリングプールの名前を指定します。
	 * @return DeleteGatheringPoolRequest
	 */
	public function withGatheringPoolName($gatheringPoolName): DeleteGatheringPoolRequest {
