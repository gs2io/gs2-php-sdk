 ...
 */
class RoomDescribeGatheringRequest extends Gs2UserRequest {

    const FUNCTION = "DescribeGathering";
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomDescribeGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomDescribeGatheringRequest {
	 ...
	 * @return RoomDescribeGatheringRequest
	 */
	public function withPageToken($pageToken): RoomDescribeGatheringRequest {
	 ...
	 * @return RoomDescribeGatheringRequest
	 */
	public function withLimit($limit): RoomDescribeGatheringRequest {
		$this->setLimit($limit);
		return $this;
	}
