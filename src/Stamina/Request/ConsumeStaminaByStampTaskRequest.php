...
class ConsumeStaminaByStampTaskRequest extends Gs2BasicRequest {
     ...
     */
    public function withStampTask(string $stampTask = null): ConsumeStaminaByStampTaskRequest {
     ...
     * @return ConsumeStaminaByStampTaskRequest $this
     */
    public function withKeyId(string $keyId = null): ConsumeStaminaByStampTaskRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return ConsumeStaminaByStampTaskRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): ConsumeStaminaByStampTaskRequest {
