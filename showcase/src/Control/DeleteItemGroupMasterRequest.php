 ...
 */
class DeleteItemGroupMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteItemGroupMaster";
	 ...
	 *
	 * @param string $showcaseName ショーケースの名前
	 * @return DeleteItemGroupMasterRequest
	 */
	public function withShowcaseName($showcaseName): DeleteItemGroupMasterRequest {
	 ...
	 * @return DeleteItemGroupMasterRequest
	 */
	public function withItemGroupName($itemGroupName): DeleteItemGroupMasterRequest {
