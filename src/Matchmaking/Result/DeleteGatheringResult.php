...
class DeleteGatheringResult implements IResult {
	 ...
	 * ギャザリングを取得
	 *
	 * @return Gathering|null ギャザリングを削除
	 */
	 ...
	 * ギャザリングを設定
	 *
	 * @param Gathering|null $item ギャザリングを削除
	 */
	public function setItem(?Gathering $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): DeleteGatheringResult {
        $result = new DeleteGatheringResult();
