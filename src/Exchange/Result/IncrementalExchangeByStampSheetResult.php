...
class IncrementalExchangeByStampSheetResult implements IResult {
	...
	public function withItem(?IncrementalRateModel $item): IncrementalExchangeByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): IncrementalExchangeByStampSheetResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): IncrementalExchangeByStampSheetResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): IncrementalExchangeByStampSheetResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): IncrementalExchangeByStampSheetResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): IncrementalExchangeByStampSheetResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): IncrementalExchangeByStampSheetResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): IncrementalExchangeByStampSheetResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?IncrementalExchangeByStampSheetResult {
        if ($data === null) {
            return null;
        }
