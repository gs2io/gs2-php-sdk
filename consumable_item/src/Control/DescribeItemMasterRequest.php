 ...
 */
class DescribeItemMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeItemMaster";
	 ...
	 *
	 * @param string $itemPoolName 消費型アイテムプールの名前
	 * @return DescribeItemMasterRequest
	 */
	public function withItemPoolName($itemPoolName): DescribeItemMasterRequest {
	 ...
	 * @return DescribeItemMasterRequest
	 */
	public function withPageToken($pageToken): DescribeItemMasterRequest {
	 ...
	 * @return DescribeItemMasterRequest
	 */
	public function withLimit($limit): DescribeItemMasterRequest {
		$this->setLimit($limit);
		return $this;
	}
