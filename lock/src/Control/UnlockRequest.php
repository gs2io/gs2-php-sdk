 ...
 */
class UnlockRequest extends Gs2UserRequest {

    const FUNCTION = "Unlock";
	 ...
	 */
	public function withLockPoolName($lockPoolName): UnlockRequest {
	 ...
	 * @return UnlockRequest
	 */
	public function withTransactionId($transactionId): UnlockRequest {
	 ...
	 * @return UnlockRequest
	 */
	public function withResourceName($resourceName): UnlockRequest {
