 ...
 */
class RoomCreateGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomCreateGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomCreateGatheringRequest {
	 ...
	 * @return RoomCreateGatheringRequest
	 */
	public function withMeta($meta): RoomCreateGatheringRequest {
		$this->setMeta($meta);
		return $this;
	}
