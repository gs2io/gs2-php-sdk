...
class SetRecoverIntervalByStampSheetResult implements IResult {
    /** @var Stamina */
    private $item;
    /** @var Stamina */
    private $old;
	...
	public function withItem(?Stamina $item): SetRecoverIntervalByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withOld(?Stamina $old): SetRecoverIntervalByStampSheetResult {
		$this->old = $old;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): SetRecoverIntervalByStampSheetResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SetRecoverIntervalByStampSheetResult {
        if ($data === null) {
            return null;
        }
