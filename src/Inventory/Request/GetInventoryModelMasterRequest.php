...
class GetInventoryModelMasterRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetInventoryModelMasterRequest {
     ...
     * @return GetInventoryModelMasterRequest $this
     */
    public function withInventoryName(string $inventoryName = null): GetInventoryModelMasterRequest {
