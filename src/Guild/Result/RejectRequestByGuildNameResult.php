...
class RejectRequestByGuildNameResult implements IResult {
	...
	public function withItem(?ReceiveMemberRequest $item): RejectRequestByGuildNameResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?RejectRequestByGuildNameResult {
        if ($data === null) {
            return null;
        }
