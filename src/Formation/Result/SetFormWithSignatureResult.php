...
class SetFormWithSignatureResult implements IResult {
	...
	public function withItem(?Form $item): SetFormWithSignatureResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withMold(?Mold $mold): SetFormWithSignatureResult {
		$this->mold = $mold;
		return $this;
	}
	...
	public function withMoldModel(?MoldModel $moldModel): SetFormWithSignatureResult {
		$this->moldModel = $moldModel;
		return $this;
	}
	...
	public function withFormModel(?FormModel $formModel): SetFormWithSignatureResult {
		$this->formModel = $formModel;
		return $this;
	}
