...
class SubGradeResult implements IResult {
    /** @var Status */
    private $item;
    /** @var string */
	...
	public function withItem(?Status $item): SubGradeResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withExperienceNamespaceName(?string $experienceNamespaceName): SubGradeResult {
		$this->experienceNamespaceName = $experienceNamespaceName;
		return $this;
	}
	...
	public function withExperienceStatus(?ExperienceStatus $experienceStatus): SubGradeResult {
		$this->experienceStatus = $experienceStatus;
		return $this;
	}

    public static function fromJson(?array $data): ?SubGradeResult {
        if ($data === null) {
            return null;
        }
