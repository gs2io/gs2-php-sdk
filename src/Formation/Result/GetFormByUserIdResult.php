...
class GetFormByUserIdResult implements IResult {
	...
	public function withItem(?Form $item): GetFormByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withMold(?Mold $mold): GetFormByUserIdResult {
		$this->mold = $mold;
		return $this;
	}
	...
	public function withMoldModel(?MoldModel $moldModel): GetFormByUserIdResult {
		$this->moldModel = $moldModel;
		return $this;
	}
	...
	public function withFormModel(?FormModel $formModel): GetFormByUserIdResult {
		$this->formModel = $formModel;
		return $this;
	}
