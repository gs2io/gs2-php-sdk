 ...
 */
class DeleteInboxRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteInbox";
	 ...
	 *
	 * @param string $inboxName 受信ボックスの名前を指定します。
	 * @return DeleteInboxRequest
	 */
	public function withInboxName($inboxName): DeleteInboxRequest {
