...
class AddReferenceOfByUserIdRequest extends Gs2BasicRequest {
	...
	public function withTimeOffsetToken(?string $timeOffsetToken): AddReferenceOfByUserIdRequest {
		$this->timeOffsetToken = $timeOffsetToken;
		return $this;
	}
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): AddReferenceOfByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}
