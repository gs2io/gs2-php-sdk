...
class UpdateCurrentDistributorMasterFromGitHubResult implements IResult {
	/** @var CurrentDistributorMaster 更新した現在有効な配信設定 */
	private $item;

	/**
	 * 更新した現在有効な配信設定を取得
	 *
	 * @return CurrentDistributorMaster|null 現在有効な配信設定を更新します
	 */
	 ...
	 * 更新した現在有効な配信設定を設定
	 *
	 * @param CurrentDistributorMaster|null $item 現在有効な配信設定を更新します
	 */
	public function setItem(?CurrentDistributorMaster $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): UpdateCurrentDistributorMasterFromGitHubResult {
        $result = new UpdateCurrentDistributorMasterFromGitHubResult();
