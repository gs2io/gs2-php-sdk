 ...
 */
class DeleteGoldPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteGoldPool";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return DeleteGoldPoolRequest
	 */
	public function withGoldPoolName($goldPoolName): DeleteGoldPoolRequest {
