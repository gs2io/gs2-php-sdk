 ...
 */
class RoomJoinGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomJoinGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomJoinGatheringRequest {
	 ...
	 * @return RoomJoinGatheringRequest
	 */
	public function withGatheringId($gatheringId): RoomJoinGatheringRequest {
