...
class SetMaxValueByStampSheetResult implements IResult {
	...
	public function withItem(?Stamina $item): SetMaxValueByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withOld(?Stamina $old): SetMaxValueByStampSheetResult {
		$this->old = $old;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): SetMaxValueByStampSheetResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}
