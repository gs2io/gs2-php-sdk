...
class CurrentCampaignMaster implements IModel {
	/**
     * @var string
	 */
	private $namespaceId;
	...
	public function withNamespaceId(?string $namespaceId): CurrentCampaignMaster {
		$this->namespaceId = $namespaceId;
		return $this;
	}
	...
	public function withSettings(?string $settings): CurrentCampaignMaster {
		$this->settings = $settings;
		return $this;
	}

    public static function fromJson(?array $data): ?CurrentCampaignMaster {
        if ($data === null) {
            return null;
        }
