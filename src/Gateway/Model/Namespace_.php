...
class Namespace_ implements IModel {
	 ...
	 *
	 * @return string|null Firebase の通知送信に使用するシークレットトークン
	 */
	 ...
	 *
	 * @param string|null $firebaseSecret Firebase の通知送信に使用するシークレットトークン
	 */
    ...
    public static function fromJson(array $data): Namespace_ {
        ...
        $model->setFirebaseSecret(isset($data["firebaseSecret"]) ? $data["firebaseSecret"] : null);
