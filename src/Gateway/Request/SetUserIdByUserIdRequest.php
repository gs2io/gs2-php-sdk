...
class SetUserIdByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SetUserIdByUserIdRequest {
     ...
     * @return SetUserIdByUserIdRequest $this
     */
    public function withConnectionId(string $connectionId = null): SetUserIdByUserIdRequest {
     ...
     * @return SetUserIdByUserIdRequest $this
     */
    public function withUserId(string $userId = null): SetUserIdByUserIdRequest {
     ...
     * @return SetUserIdByUserIdRequest $this
     */
    public function withAllowConcurrentAccess(bool $allowConcurrentAccess = null): SetUserIdByUserIdRequest {
     ...
     * @return SetUserIdByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetUserIdByUserIdRequest {
