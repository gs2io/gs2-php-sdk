...
class GetStatusModelMasterRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetStatusModelMasterRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withNodeModelName(?string $nodeModelName): GetStatusModelMasterRequest {
		$this->nodeModelName = $nodeModelName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetStatusModelMasterRequest {
        if ($data === null) {
            return null;
        }
