...
class UpdateTakeOverRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UpdateTakeOverRequest {
     ...
     * @return UpdateTakeOverRequest $this
     */
    public function withType(int $type = null): UpdateTakeOverRequest {
        $this->setType($type);
        return $this;
    }
     ...
     * @return UpdateTakeOverRequest $this
     */
    public function withOldPassword(string $oldPassword = null): UpdateTakeOverRequest {
     ...
     * @return UpdateTakeOverRequest $this
     */
    public function withPassword(string $password = null): UpdateTakeOverRequest {
     ...
     * @return UpdateTakeOverRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): UpdateTakeOverRequest {
