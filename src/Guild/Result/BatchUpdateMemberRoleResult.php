...
class BatchUpdateMemberRoleResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): BatchUpdateMemberRoleResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?BatchUpdateMemberRoleResult {
        if ($data === null) {
            return null;
        }
