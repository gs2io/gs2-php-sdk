...
class DescribeMaxStaminaTableMastersResult implements IResult {
	...
	public function withItems(?array $items): DescribeMaxStaminaTableMastersResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeMaxStaminaTableMastersResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?DescribeMaxStaminaTableMastersResult {
        ...
        return (new DescribeMaxStaminaTableMastersResult())
            ->withItems(array_map(
                function ($item) {
                    return MaxStaminaTableMaster::fromJson($item);
                },
