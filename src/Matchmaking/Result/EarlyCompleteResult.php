...
class EarlyCompleteResult implements IResult {
    /** @var Gathering */
    private $item;
	...
	public function withItem(?Gathering $item): EarlyCompleteResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?EarlyCompleteResult {
        if ($data === null) {
            return null;
        }
