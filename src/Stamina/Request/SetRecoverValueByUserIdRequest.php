...
class SetRecoverValueByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SetRecoverValueByUserIdRequest {
     ...
     * @return SetRecoverValueByUserIdRequest $this
     */
    public function withStaminaName(string $staminaName = null): SetRecoverValueByUserIdRequest {
     ...
     * @return SetRecoverValueByUserIdRequest $this
     */
    public function withUserId(string $userId = null): SetRecoverValueByUserIdRequest {
     ...
     * @return SetRecoverValueByUserIdRequest $this
     */
    public function withRecoverValue(int $recoverValue = null): SetRecoverValueByUserIdRequest {
     ...
     * @return SetRecoverValueByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetRecoverValueByUserIdRequest {
