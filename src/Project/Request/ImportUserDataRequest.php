...
class ImportUserDataRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): ImportUserDataRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?ImportUserDataRequest {
        if ($data === null) {
            return null;
        }
