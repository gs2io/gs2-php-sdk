...
class ApplyStaminaResult implements IResult {
    /** @var Stamina */
    private $item;
    /** @var StaminaModel */
	...
	public function withItem(?Stamina $item): ApplyStaminaResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): ApplyStaminaResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}

    public static function fromJson(?array $data): ?ApplyStaminaResult {
        if ($data === null) {
            return null;
        }
