...
class CreateStatusModelMasterResult implements IResult {
    /** @var NodeModelMaster */
    private $item;
	...
	public function withItem(?NodeModelMaster $item): CreateStatusModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?CreateStatusModelMasterResult {
        if ($data === null) {
            return null;
        }
