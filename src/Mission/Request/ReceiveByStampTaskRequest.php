...
class ReceiveByStampTaskRequest extends Gs2BasicRequest {
     ...
     */
    public function withStampTask(string $stampTask = null): ReceiveByStampTaskRequest {
     ...
     * @return ReceiveByStampTaskRequest $this
     */
    public function withKeyId(string $keyId = null): ReceiveByStampTaskRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return ReceiveByStampTaskRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): ReceiveByStampTaskRequest {
