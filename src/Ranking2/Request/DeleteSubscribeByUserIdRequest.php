...
class DeleteSubscribeByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): DeleteSubscribeByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteSubscribeByUserIdRequest {
        if ($data === null) {
            return null;
        }
