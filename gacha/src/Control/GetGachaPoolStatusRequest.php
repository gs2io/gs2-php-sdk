 ...
 */
class GetGachaPoolStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGachaPoolStatus";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return GetGachaPoolStatusRequest
	 */
	public function withGachaPoolName($gachaPoolName): GetGachaPoolStatusRequest {
