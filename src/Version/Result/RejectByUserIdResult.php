...
class RejectByUserIdResult implements IResult {
    /** @var AcceptVersion */
    private $item;
	...
	public function withItem(?AcceptVersion $item): RejectByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?RejectByUserIdResult {
        if ($data === null) {
            return null;
        }
