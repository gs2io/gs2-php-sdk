...
class UpdateSalesItemGroupMasterResult implements IResult {
	/** @var SalesItemGroupMaster 更新した商品グループマスター */
	private $item;

	/**
	 * 更新した商品グループマスターを取得
	 *
	 * @return SalesItemGroupMaster|null 商品グループマスターを更新
	 */
	 ...
	 * 更新した商品グループマスターを設定
	 *
	 * @param SalesItemGroupMaster|null $item 商品グループマスターを更新
	 */
    ...
    public static function fromJson(array $data): UpdateSalesItemGroupMasterResult {
        $result = new UpdateSalesItemGroupMasterResult();
