...
class UpdateCurrentEventMasterRequest extends Gs2BasicRequest {
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentEventMasterRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withMode(?string $mode): UpdateCurrentEventMasterRequest {
		$this->mode = $mode;
		return $this;
	}
	...
	public function withSettings(?string $settings): UpdateCurrentEventMasterRequest {
		$this->settings = $settings;
		return $this;
	}
	...
	public function withUploadToken(?string $uploadToken): UpdateCurrentEventMasterRequest {
		$this->uploadToken = $uploadToken;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentEventMasterRequest {
        if ($data === null) {
            return null;
        }
