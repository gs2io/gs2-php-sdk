...
class SubscribeRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SubscribeRequest {
     ...
     * @return SubscribeRequest $this
     */
    public function withRoomName(string $roomName = null): SubscribeRequest {
     ...
     * @return SubscribeRequest $this
     */
    public function withNotificationTypes(array $notificationTypes = null): SubscribeRequest {
     ...
     * @return SubscribeRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SubscribeRequest {
