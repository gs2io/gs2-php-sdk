...
class GetBigItemModelResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetBigItemModelResult {
        if ($data === null) {
            return null;
        }
        return (new GetBigItemModelResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? BigItemModel::fromJson($data['item']) : null);
    }
