...
class BatchUpdateMemberRoleByGuildNameResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): BatchUpdateMemberRoleByGuildNameResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?BatchUpdateMemberRoleByGuildNameResult {
        if ($data === null) {
            return null;
        }
