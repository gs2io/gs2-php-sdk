...
class Namespace_ implements IModel {
	 ...
	 *
	 * @return NotificationSetting|null ジョブキューにジョブが登録されたときののプッシュ通知
	 */
	 ...
	 *
	 * @param NotificationSetting|null $pushNotification ジョブキューにジョブが登録されたときののプッシュ通知
	 */
    ...
    public function toJson(): array {
        return array(
            ...
            "pushNotification" => $this->pushNotification->toJson(),
    ...
    public static function fromJson(array $data): Namespace_ {
        ...
        $model->setPushNotification(isset($data["pushNotification"]) ? NotificationSetting::fromJson($data["pushNotification"]) : null);
