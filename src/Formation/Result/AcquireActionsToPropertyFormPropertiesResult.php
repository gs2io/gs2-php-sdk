...
class AcquireActionsToPropertyFormPropertiesResult implements IResult {
    /** @var PropertyForm */
    private $item;
    /** @var string */
	...
	public function withItem(?PropertyForm $item): AcquireActionsToPropertyFormPropertiesResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): AcquireActionsToPropertyFormPropertiesResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): AcquireActionsToPropertyFormPropertiesResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): AcquireActionsToPropertyFormPropertiesResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): AcquireActionsToPropertyFormPropertiesResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): AcquireActionsToPropertyFormPropertiesResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): AcquireActionsToPropertyFormPropertiesResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): AcquireActionsToPropertyFormPropertiesResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?AcquireActionsToPropertyFormPropertiesResult {
        if ($data === null) {
            return null;
        }
