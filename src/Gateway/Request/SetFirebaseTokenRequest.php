...
class SetFirebaseTokenRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): SetFirebaseTokenRequest {
     ...
     * @return SetFirebaseTokenRequest $this
     */
    public function withToken(string $token = null): SetFirebaseTokenRequest {
        $this->setToken($token);
        return $this;
    }
     ...
     * @return SetFirebaseTokenRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetFirebaseTokenRequest {
