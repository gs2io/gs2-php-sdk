...
class DescribeMutexesByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeMutexesByUserIdRequest {
     ...
     * @return DescribeMutexesByUserIdRequest $this
     */
    public function withUserId(string $userId = null): DescribeMutexesByUserIdRequest {
     ...
     * @return DescribeMutexesByUserIdRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeMutexesByUserIdRequest {
     ...
     * @return DescribeMutexesByUserIdRequest $this
     */
    public function withLimit(int $limit = null): DescribeMutexesByUserIdRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeMutexesByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeMutexesByUserIdRequest {
