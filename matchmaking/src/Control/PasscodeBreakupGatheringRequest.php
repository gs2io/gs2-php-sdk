 ...
 */
class PasscodeBreakupGatheringRequest extends Gs2UserRequest {

    const FUNCTION = "BreakupGathering";
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return PasscodeBreakupGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): PasscodeBreakupGatheringRequest {
	 ...
	 * @return PasscodeBreakupGatheringRequest
	 */
	public function withGatheringId($gatheringId): PasscodeBreakupGatheringRequest {
