 ...
 */
class DeleteShowcaseRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteShowcase";
	 ...
	 *
	 * @param string $showcaseName ショーケースの名前
	 * @return DeleteShowcaseRequest
	 */
	public function withShowcaseName($showcaseName): DeleteShowcaseRequest {
