...
class DeleteGradeModelMasterResult implements IResult {
    ...
    public static function fromJson(?array $data): ?DeleteGradeModelMasterResult {
        if ($data === null) {
            return null;
        }
        return (new DeleteGradeModelMasterResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? GradeModelMaster::fromJson($data['item']) : null);
    }
