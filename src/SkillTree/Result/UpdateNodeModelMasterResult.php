...
class UpdateNodeModelMasterResult implements IResult {
    /** @var NodeModelMaster */
    private $item;
	...
	public function withItem(?NodeModelMaster $item): UpdateNodeModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateNodeModelMasterResult {
        if ($data === null) {
            return null;
        }
