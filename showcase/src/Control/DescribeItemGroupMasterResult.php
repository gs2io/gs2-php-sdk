...
use Gs2\Showcase\Model\ItemGroupMaster;

/**
 * @author Game Server Services, Inc.
 */
class DescribeItemGroupMasterResult {

	/** @var ItemGroupMaster[] 商品グループ */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, ItemGroupMaster::build($arr));
            }
        }
	 ...
	 * 商品グループを設定
	 *
	 * @param ItemGroupMaster[] $items 商品グループ
	 */
