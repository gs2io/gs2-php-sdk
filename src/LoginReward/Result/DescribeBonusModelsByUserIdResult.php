...
class DescribeBonusModelsByUserIdResult implements IResult {
    /** @var array */
    private $items;
	...
	public function withItems(?array $items): DescribeBonusModelsByUserIdResult {
		$this->items = $items;
		return $this;
	}

    public static function fromJson(?array $data): ?DescribeBonusModelsByUserIdResult {
        if ($data === null) {
            return null;
        }
