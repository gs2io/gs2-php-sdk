...
class UpdateGuildResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): UpdateGuildResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateGuildResult {
        if ($data === null) {
            return null;
        }
