...
class UpdateStatusModelMasterResult implements IResult {
    /** @var NodeModelMaster */
    private $item;
	...
	public function withItem(?NodeModelMaster $item): UpdateStatusModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateStatusModelMasterResult {
        if ($data === null) {
            return null;
        }
