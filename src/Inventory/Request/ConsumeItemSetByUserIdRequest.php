...
class ConsumeItemSetByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withInventoryName(string $inventoryName = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withUserId(string $userId = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withItemName(string $itemName = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withConsumeCount(int $consumeCount = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withItemSetName(string $itemSetName = null): ConsumeItemSetByUserIdRequest {
     ...
     * @return ConsumeItemSetByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): ConsumeItemSetByUserIdRequest {
