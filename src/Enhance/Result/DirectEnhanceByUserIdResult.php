...
class DirectEnhanceByUserIdResult implements IResult {
	 ...
	 * 強化レートモデルを取得
	 *
	 * @return RateModel|null ユーザIDを指定して強化を実行
	 */
	 ...
	 * 強化レートモデルを設定
	 *
	 * @param RateModel|null $item ユーザIDを指定して強化を実行
	 */
	 ...
	 *
	 * @param string|null $stampSheet ユーザIDを指定して強化を実行
	 */
	 ...
	 *
	 * @param string|null $stampSheetEncryptionKeyId ユーザIDを指定して強化を実行
	 */
	 ...
	 * 獲得経験値量を取得
	 *
	 * @return int|null ユーザIDを指定して強化を実行
	 */
	 ...
	 * 獲得経験値量を設定
	 *
	 * @param int|null $acquireExperience ユーザIDを指定して強化を実行
	 */
	 ...
	 *
	 * @return float|null ユーザIDを指定して強化を実行
	 */
	 ...
	 *
	 * @param float|null $bonusRate ユーザIDを指定して強化を実行
	 */
    ...
    public static function fromJson(array $data): DirectEnhanceByUserIdResult {
        $result = new DirectEnhanceByUserIdResult();
