...
class GetCompletedQuestListRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetCompletedQuestListRequest {
     ...
     * @return GetCompletedQuestListRequest $this
     */
    public function withQuestGroupName(string $questGroupName = null): GetCompletedQuestListRequest {
     ...
     * @return GetCompletedQuestListRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetCompletedQuestListRequest {
