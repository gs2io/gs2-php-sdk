 ...
 */
class DeleteGachaPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteGachaPool";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DeleteGachaPoolRequest
	 */
	public function withGachaPoolName($gachaPoolName): DeleteGachaPoolRequest {
