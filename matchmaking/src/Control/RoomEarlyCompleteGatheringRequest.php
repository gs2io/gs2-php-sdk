 ...
 */
class RoomEarlyCompleteGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomEarlyCompleteGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomEarlyCompleteGatheringRequest {
	 ...
	 * @return RoomEarlyCompleteGatheringRequest
	 */
	public function withGatheringId($gatheringId): RoomEarlyCompleteGatheringRequest {
