...
use Gs2\Ranking\Model\RankingTable;

/**
 * @author Game Server Services, Inc.
 */
class DescribeRankingTableResult {

	/** @var RankingTable[] ランキングテーブル */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, RankingTable::build($arr));
            }
        }
	 ...
	 * ランキングテーブルを設定
	 *
	 * @param RankingTable[] $items ランキングテーブル
	 */
