...
class GetStatusRequest extends Gs2BasicRequest {
     ...
     * @return GetStatusRequest $this
     */
    public function withExperienceName(string $experienceName): GetStatusRequest {
     ...
     * @return GetStatusRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider): GetStatusRequest {
