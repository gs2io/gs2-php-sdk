...
class CurrentBonusMaster implements IModel {
	/**
     * @var string
	 */
	private $namespaceId;
	...
	public function withNamespaceId(?string $namespaceId): CurrentBonusMaster {
		$this->namespaceId = $namespaceId;
		return $this;
	}
	...
	public function withSettings(?string $settings): CurrentBonusMaster {
		$this->settings = $settings;
		return $this;
	}

    public static function fromJson(?array $data): ?CurrentBonusMaster {
        if ($data === null) {
            return null;
        }
