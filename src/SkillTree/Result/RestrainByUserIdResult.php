...
class RestrainByUserIdResult implements IResult {
    /** @var Status */
    private $item;
    /** @var string */
	...
	public function withItem(?Status $item): RestrainByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): RestrainByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): RestrainByUserIdResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): RestrainByUserIdResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): RestrainByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): RestrainByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): RestrainByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): RestrainByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?RestrainByUserIdResult {
        if ($data === null) {
            return null;
        }
