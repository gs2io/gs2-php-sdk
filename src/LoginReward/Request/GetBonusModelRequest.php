...
class GetBonusModelRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): GetBonusModelRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withBonusModelName(?string $bonusModelName): GetBonusModelRequest {
		$this->bonusModelName = $bonusModelName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetBonusModelRequest {
        if ($data === null) {
            return null;
        }
