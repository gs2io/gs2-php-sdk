...
class GetPropertyFormWithSignatureResult implements IResult {
	...
	public function withItem(?PropertyForm $item): GetPropertyFormWithSignatureResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withBody(?string $body): GetPropertyFormWithSignatureResult {
		$this->body = $body;
		return $this;
	}
	...
	public function withSignature(?string $signature): GetPropertyFormWithSignatureResult {
		$this->signature = $signature;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?GetPropertyFormWithSignatureResult {
        if ($data === null) {
            return null;
        }
