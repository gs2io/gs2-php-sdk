...
/**
 * バージョンマスターを取得 のレスポンスモデル
 *
 * @author Game Server Services, Inc.
 */
class GetVersionModelMasterResult implements IResult {
	/** @var VersionModelMaster バージョンマスター */
	private $item;

	/**
	 * バージョンマスターを取得
	 *
	 * @return VersionModelMaster|null バージョンマスターを取得
	 */
	 ...
	 * バージョンマスターを設定
	 *
	 * @param VersionModelMaster|null $item バージョンマスターを取得
	 */
	public function setItem(?VersionModelMaster $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetVersionModelMasterResult {
        $result = new GetVersionModelMasterResult();
