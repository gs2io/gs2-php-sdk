...
class SubMoldCapacityByUserIdResult implements IResult {
    /** @var Mold */
    private $item;
    /** @var MoldModel */
    private $moldModel;
	...
	public function withItem(?Mold $item): SubMoldCapacityByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withMoldModel(?MoldModel $moldModel): SubMoldCapacityByUserIdResult {
		$this->moldModel = $moldModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SubMoldCapacityByUserIdResult {
        if ($data === null) {
            return null;
        }
