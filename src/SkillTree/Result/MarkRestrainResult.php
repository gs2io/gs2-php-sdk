...
class MarkRestrainResult implements IResult {
    /** @var Status */
    private $item;
	...
	public function withItem(?Status $item): MarkRestrainResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?MarkRestrainResult {
        if ($data === null) {
            return null;
        }
