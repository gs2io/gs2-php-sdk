...
class CloseMessageByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): CloseMessageByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?CloseMessageByUserIdRequest {
        if ($data === null) {
            return null;
        }
