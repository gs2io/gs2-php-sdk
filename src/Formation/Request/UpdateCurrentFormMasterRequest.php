...
class UpdateCurrentFormMasterRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UpdateCurrentFormMasterRequest {
     ...
     * @return UpdateCurrentFormMasterRequest $this
     */
    public function withSettings(string $settings = null): UpdateCurrentFormMasterRequest {
