...
class AcceptRequestRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): AcceptRequestRequest {
     ...
     * @return AcceptRequestRequest $this
     */
    public function withFromUserId(string $fromUserId = null): AcceptRequestRequest {
     ...
     * @return AcceptRequestRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): AcceptRequestRequest {
