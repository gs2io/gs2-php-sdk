...
class GetShowcaseByUserIdRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName ユーザIDを指定して陳列棚を取得
     * @return GetShowcaseByUserIdRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetShowcaseByUserIdRequest {
     ...
     * @return GetShowcaseByUserIdRequest $this
     */
    public function withShowcaseName(string $showcaseName = null): GetShowcaseByUserIdRequest {
     ...
     * @return GetShowcaseByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetShowcaseByUserIdRequest {
     ...
     * @return GetShowcaseByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetShowcaseByUserIdRequest {
