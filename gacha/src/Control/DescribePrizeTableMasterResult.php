...
use Gs2\Gacha\Model\PrizeTableMaster;

/**
 * @author Game Server Services, Inc.
 */
class DescribePrizeTableMasterResult {

	/** @var PrizeTableMaster[] 排出確率テーブル */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, PrizeTableMaster::build($arr));
            }
        }
	 ...
	 * 排出確率テーブルを取得
	 *
	 * @return PrizeTableMaster[] 排出確率テーブル
	 */
	 ...
	 * 排出確率テーブルを設定
	 *
	 * @param PrizeTableMaster[] $items 排出確率テーブル
	 */
