...
class QueryExecuteStampSheetLogResult implements IResult {
	/** @var ExecuteStampSheetLog[] スタンプシート実行ログのリスト */
	private $items;
	 ...
	 * スタンプシート実行ログのリストを取得
	 *
	 * @return ExecuteStampSheetLog[]|null スタンプシート実行ログの一覧を取得
	 */
	 ...
	 * スタンプシート実行ログのリストを設定
	 *
	 * @param ExecuteStampSheetLog[]|null $items スタンプシート実行ログの一覧を取得
	 */
    ...
    public static function fromJson(array $data): QueryExecuteStampSheetLogResult {
        $result = new QueryExecuteStampSheetLogResult();
        $result->setItems(array_map(
                function ($v) {
                    return ExecuteStampSheetLog::fromJson($v);
                },
