...
class SetPropertyFormResult implements IResult {
    /** @var PropertyForm */
    private $item;
	...
	public function withItem(?PropertyForm $item): SetPropertyFormResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withPropertyFormModel(?PropertyFormModel $propertyFormModel): SetPropertyFormResult {
		$this->propertyFormModel = $propertyFormModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SetPropertyFormResult {
        if ($data === null) {
            return null;
        }
