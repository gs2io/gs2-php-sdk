...
class GetMoldByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetMoldByUserIdRequest {
     ...
     * @return GetMoldByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetMoldByUserIdRequest {
     ...
     * @return GetMoldByUserIdRequest $this
     */
    public function withMoldName(string $moldName = null): GetMoldByUserIdRequest {
     ...
     * @return GetMoldByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetMoldByUserIdRequest {
