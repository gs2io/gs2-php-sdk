...
class UnlockIncrementalExchangeByStampSheetResult implements IResult {
	...
	public function withItem(?IncrementalRateModel $item): UnlockIncrementalExchangeByStampSheetResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UnlockIncrementalExchangeByStampSheetResult {
        if ($data === null) {
            return null;
        }
