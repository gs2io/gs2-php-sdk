 ...
 */
class DeleteMoneyRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteMoney";
	 ...
	 *
	 * @param string $moneyName 取得する課金通貨の名前
	 * @return DeleteMoneyRequest
	 */
	public function withMoneyName($moneyName): DeleteMoneyRequest {
