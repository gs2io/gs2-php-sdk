...
class DeletePropertyFormResult implements IResult {
    /** @var PropertyForm */
    private $item;
	...
	public function withItem(?PropertyForm $item): DeletePropertyFormResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withPropertyFormModel(?PropertyFormModel $propertyFormModel): DeletePropertyFormResult {
		$this->propertyFormModel = $propertyFormModel;
		return $this;
	}

    public static function fromJson(?array $data): ?DeletePropertyFormResult {
        if ($data === null) {
            return null;
        }
