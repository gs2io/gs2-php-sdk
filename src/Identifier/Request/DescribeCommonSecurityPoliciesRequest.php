...
class DescribeCommonSecurityPoliciesRequest extends Gs2BasicRequest {
     ...
     */
    public function withOwnerId(string $ownerId = null): DescribeCommonSecurityPoliciesRequest {
     ...
     * @return DescribeCommonSecurityPoliciesRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeCommonSecurityPoliciesRequest {
     ...
     * @return DescribeCommonSecurityPoliciesRequest $this
     */
    public function withLimit(int $limit = null): DescribeCommonSecurityPoliciesRequest {
        $this->setLimit($limit);
        return $this;
    }
