...
class PreUpdateCurrentQuestMasterResult implements IResult {
    /** @var string */
    private $uploadToken;
    /** @var string */
    private $uploadUrl;
	...
	public function withUploadToken(?string $uploadToken): PreUpdateCurrentQuestMasterResult {
		$this->uploadToken = $uploadToken;
		return $this;
	}
	...
	public function withUploadUrl(?string $uploadUrl): PreUpdateCurrentQuestMasterResult {
		$this->uploadUrl = $uploadUrl;
		return $this;
	}

    public static function fromJson(?array $data): ?PreUpdateCurrentQuestMasterResult {
        if ($data === null) {
            return null;
        }
