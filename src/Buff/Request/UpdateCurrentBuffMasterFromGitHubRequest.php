...
use Gs2\Buff\Model\GitHubCheckoutSetting;

class UpdateCurrentBuffMasterFromGitHubRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentBuffMasterFromGitHubRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCheckoutSetting(?GitHubCheckoutSetting $checkoutSetting): UpdateCurrentBuffMasterFromGitHubRequest {
		$this->checkoutSetting = $checkoutSetting;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentBuffMasterFromGitHubRequest {
        if ($data === null) {
            return null;
        }
