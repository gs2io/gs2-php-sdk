...
class CurrentCategoryMaster implements IModel {
	/**
     * @var string
	 */
	private $namespaceId;
	...
	public function withNamespaceId(?string $namespaceId): CurrentCategoryMaster {
		$this->namespaceId = $namespaceId;
		return $this;
	}
	...
	public function withSettings(?string $settings): CurrentCategoryMaster {
		$this->settings = $settings;
		return $this;
	}

    public static function fromJson(?array $data): ?CurrentCategoryMaster {
        if ($data === null) {
            return null;
        }
