 ...
 */
class GetLockPoolStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetLockPoolStatus";
	 ...
	 *
	 * @param string $lockPoolName ロックプールの名前を指定します。
	 * @return GetLockPoolStatusRequest
	 */
	public function withLockPoolName($lockPoolName): GetLockPoolStatusRequest {
