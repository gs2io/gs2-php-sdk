 ...
 */
class GetRankingTableRequest extends Gs2BasicRequest {

    const FUNCTION = "GetRankingTable";
	 ...
	 *
	 * @param string $rankingTableName ランキングテーブルの名前を指定します。
	 * @return GetRankingTableRequest
	 */
	public function withRankingTableName($rankingTableName): GetRankingTableRequest {
