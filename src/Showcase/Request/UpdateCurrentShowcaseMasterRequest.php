...
class UpdateCurrentShowcaseMasterRequest extends Gs2BasicRequest {
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentShowcaseMasterRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withMode(?string $mode): UpdateCurrentShowcaseMasterRequest {
		$this->mode = $mode;
		return $this;
	}
	...
	public function withSettings(?string $settings): UpdateCurrentShowcaseMasterRequest {
		$this->settings = $settings;
		return $this;
	}
	...
	public function withUploadToken(?string $uploadToken): UpdateCurrentShowcaseMasterRequest {
		$this->uploadToken = $uploadToken;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentShowcaseMasterRequest {
        if ($data === null) {
            return null;
        }
