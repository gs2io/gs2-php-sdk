...
class UpdateShowcaseMasterRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UpdateShowcaseMasterRequest {
     ...
     * @return UpdateShowcaseMasterRequest $this
     */
    public function withShowcaseName(string $showcaseName = null): UpdateShowcaseMasterRequest {
     ...
     * @return UpdateShowcaseMasterRequest $this
     */
    public function withDescription(string $description = null): UpdateShowcaseMasterRequest {
     ...
     * @return UpdateShowcaseMasterRequest $this
     */
    public function withMetadata(string $metadata = null): UpdateShowcaseMasterRequest {
     ...
     * @return UpdateShowcaseMasterRequest $this
     */
    public function withDisplayItems(array $displayItems = null): UpdateShowcaseMasterRequest {
     ...
     * @return UpdateShowcaseMasterRequest $this
     */
    public function withSalesPeriodEventId(string $salesPeriodEventId = null): UpdateShowcaseMasterRequest {
