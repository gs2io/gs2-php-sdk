...
class UnregisterBlackListRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UnregisterBlackListRequest {
     ...
     * @return UnregisterBlackListRequest $this
     */
    public function withTargetUserId(string $targetUserId = null): UnregisterBlackListRequest {
     ...
     * @return UnregisterBlackListRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): UnregisterBlackListRequest {
