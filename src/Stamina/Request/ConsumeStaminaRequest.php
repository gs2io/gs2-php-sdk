...
class ConsumeStaminaRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): ConsumeStaminaRequest {
     ...
     * @return ConsumeStaminaRequest $this
     */
    public function withStaminaName(string $staminaName = null): ConsumeStaminaRequest {
     ...
     * @return ConsumeStaminaRequest $this
     */
    public function withConsumeValue(int $consumeValue = null): ConsumeStaminaRequest {
     ...
     * @return ConsumeStaminaRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): ConsumeStaminaRequest {
