...
class CreateLayerModelMasterResult implements IResult {
    ...
    public static function fromJson(?array $data): ?CreateLayerModelMasterResult {
        if ($data === null) {
            return null;
        }
        return (new CreateLayerModelMasterResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? LayerModelMaster::fromJson($data['item']) : null);
    }
