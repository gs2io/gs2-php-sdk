 ...
 */
class PasscodeCreateGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return PasscodeCreateGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): PasscodeCreateGatheringRequest {
