...
class DescribeReferenceOfByUserIdResult implements IResult {
    /** @var array */
    private $items;
    /** @var ItemSet */
    private $itemSet;
	...
	public function withItems(?array $items): DescribeReferenceOfByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withItemSet(?ItemSet $itemSet): DescribeReferenceOfByUserIdResult {
		$this->itemSet = $itemSet;
		return $this;
	}
	...
	public function withItemModel(?ItemModel $itemModel): DescribeReferenceOfByUserIdResult {
		$this->itemModel = $itemModel;
		return $this;
	}
	...
	public function withInventory(?Inventory $inventory): DescribeReferenceOfByUserIdResult {
		$this->inventory = $inventory;
		return $this;
	}

    public static function fromJson(?array $data): ?DescribeReferenceOfByUserIdResult {
        if ($data === null) {
            return null;
        }
