...
class DeleteGatheringRequest extends Gs2BasicRequest {
    ...
    const FUNCTION = "DeleteGathering";
	 ...
	 */
	public function withGatheringPoolName($gatheringPoolName): DeleteGatheringRequest {
	 ...
	 * @return DeleteGatheringRequest
	 */
	public function withGatheringName($gatheringName): DeleteGatheringRequest {
