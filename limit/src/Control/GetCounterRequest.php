...
class GetCounterRequest extends Gs2BasicRequest {
	 ...
	 */
	public function withLimitName($limitName): GetCounterRequest {
	 ...
	 * @return GetCounterRequest
	 */
	public function withUserId($userId): GetCounterRequest {
	 ...
	 * @return GetCounterRequest
	 */
	public function withCounterName($counterName): GetCounterRequest {
