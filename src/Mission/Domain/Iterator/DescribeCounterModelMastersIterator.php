...
use Gs2\Mission\Domain\Cache\CounterModelMasterDomainCache;
...
class DescribeCounterModelMastersIterator implements Iterator {

    /**
     * @var CounterModelMasterDomainCache
     */
    ...
    public function __construct(
        CounterModelMasterDomainCache $counterModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeCounterModelMastersResult
         */
         $r = $this->client->describeCounterModelMasters(
