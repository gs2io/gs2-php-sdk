 ...
 */
class GetGachaPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGachaPool";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return GetGachaPoolRequest
	 */
	public function withGachaPoolName($gachaPoolName): GetGachaPoolRequest {
