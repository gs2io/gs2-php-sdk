...
class UpdateTakeOverTypeModelMasterResult implements IResult {
	...
	public function withItem(?TakeOverTypeModelMaster $item): UpdateTakeOverTypeModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateTakeOverTypeModelMasterResult {
        if ($data === null) {
            return null;
        }
