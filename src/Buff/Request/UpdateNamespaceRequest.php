...
use Gs2\Buff\Model\TransactionSetting;
use Gs2\Buff\Model\TransactionSettingV2;
...
class UpdateNamespaceRequest extends Gs2BasicRequest {
	...
	public function withApplyBuffScript(?ScriptSetting $applyBuffScript): UpdateNamespaceRequest {
		$this->applyBuffScript = $applyBuffScript;
		return $this;
	}
