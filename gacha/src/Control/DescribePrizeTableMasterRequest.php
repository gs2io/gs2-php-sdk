 ...
 */
class DescribePrizeTableMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribePrizeTableMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DescribePrizeTableMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): DescribePrizeTableMasterRequest {
	 ...
	 * @return DescribePrizeTableMasterRequest
	 */
	public function withPageToken($pageToken): DescribePrizeTableMasterRequest {
	 ...
	 * @return DescribePrizeTableMasterRequest
	 */
	public function withLimit($limit): DescribePrizeTableMasterRequest {
		$this->setLimit($limit);
		return $this;
	}
