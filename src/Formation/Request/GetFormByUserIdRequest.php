...
class GetFormByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetFormByUserIdRequest {
     ...
     * @return GetFormByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetFormByUserIdRequest {
     ...
     * @return GetFormByUserIdRequest $this
     */
    public function withMoldName(string $moldName = null): GetFormByUserIdRequest {
     ...
     * @return GetFormByUserIdRequest $this
     */
    public function withIndex(int $index = null): GetFormByUserIdRequest {
        $this->setIndex($index);
        return $this;
    }
     ...
     * @return GetFormByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetFormByUserIdRequest {
