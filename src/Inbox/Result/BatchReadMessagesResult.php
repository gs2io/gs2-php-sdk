...
class BatchReadMessagesResult implements IResult {
    /** @var array */
    private $items;
    /** @var string */
	...
	public function withItems(?array $items): BatchReadMessagesResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): BatchReadMessagesResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): BatchReadMessagesResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): BatchReadMessagesResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): BatchReadMessagesResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): BatchReadMessagesResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): BatchReadMessagesResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): BatchReadMessagesResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?BatchReadMessagesResult {
        if ($data === null) {
            return null;
        }
