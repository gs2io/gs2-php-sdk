...
class CreatePrizeTableMasterRequest extends Gs2BasicRequest {
    ...
    const FUNCTION = "CreatePrizeTableMaster";
	 ...
	 */
	public function withGachaPoolName($gachaPoolName): CreatePrizeTableMasterRequest {
	 ...
	 * @return CreatePrizeTableMasterRequest
	 */
	public function withName($name): CreatePrizeTableMasterRequest {
		$this->setName($name);
		return $this;
	}
