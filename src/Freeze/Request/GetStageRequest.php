...
class GetStageRequest extends Gs2BasicRequest {
    /** @var string */
    private $stageName;
	...
	public function withStageName(?string $stageName): GetStageRequest {
		$this->stageName = $stageName;
		return $this;
	}

    public static function fromJson(?array $data): ?GetStageRequest {
        if ($data === null) {
            return null;
        }
