...
class GetLastGuildMasterActivityByGuildNameResult implements IResult {
	...
	public function withItem(?LastGuildMasterActivity $item): GetLastGuildMasterActivityByGuildNameResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withGuild(?Guild $guild): GetLastGuildMasterActivityByGuildNameResult {
		$this->guild = $guild;
		return $this;
	}

    public static function fromJson(?array $data): ?GetLastGuildMasterActivityByGuildNameResult {
        if ($data === null) {
            return null;
        }
