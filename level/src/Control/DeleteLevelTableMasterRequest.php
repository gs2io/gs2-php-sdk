 ...
 */
class DeleteLevelTableMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteLevelTableMaster";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return DeleteLevelTableMasterRequest
	 */
	public function withResourcePoolName($resourcePoolName): DeleteLevelTableMasterRequest {
	 ...
	 * @return DeleteLevelTableMasterRequest
	 */
	public function withLevelTableName($levelTableName): DeleteLevelTableMasterRequest {
