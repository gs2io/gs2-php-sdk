...
class UpdateCurrentIdleMasterFromGitHubResult implements IResult {
	...
	public function withItem(?CurrentCategoryMaster $item): UpdateCurrentIdleMasterFromGitHubResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentIdleMasterFromGitHubResult {
        if ($data === null) {
            return null;
        }
