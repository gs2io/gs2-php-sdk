...
class DescribeMutexesByUserIdRequest extends Gs2BasicRequest {
	...
	public function withTimeOffsetToken(?string $timeOffsetToken): DescribeMutexesByUserIdRequest {
		$this->timeOffsetToken = $timeOffsetToken;
		return $this;
	}

    public static function fromJson(?array $data): ?DescribeMutexesByUserIdRequest {
        if ($data === null) {
            return null;
        }
