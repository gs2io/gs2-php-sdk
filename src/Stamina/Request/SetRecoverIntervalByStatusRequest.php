...
class SetRecoverIntervalByStatusRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName スタミナの最大値をGS2-Experienceのステータスを使用して更新
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): SetRecoverIntervalByStatusRequest {
     ...
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withStaminaName(string $staminaName = null): SetRecoverIntervalByStatusRequest {
     ...
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withKeyId(string $keyId = null): SetRecoverIntervalByStatusRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withSignedStatusBody(string $signedStatusBody = null): SetRecoverIntervalByStatusRequest {
     ...
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withSignedStatusSignature(string $signedStatusSignature = null): SetRecoverIntervalByStatusRequest {
     ...
     * @return SetRecoverIntervalByStatusRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetRecoverIntervalByStatusRequest {
