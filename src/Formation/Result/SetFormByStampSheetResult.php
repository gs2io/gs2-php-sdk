...
class SetFormByStampSheetResult implements IResult {
    /** @var Form */
    private $item;
    /** @var Mold */
    private $mold;
	...
	public function withItem(?Form $item): SetFormByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withMold(?Mold $mold): SetFormByStampSheetResult {
		$this->mold = $mold;
		return $this;
	}
	...
	public function withMoldModel(?MoldModel $moldModel): SetFormByStampSheetResult {
		$this->moldModel = $moldModel;
		return $this;
	}
	...
	public function withFormModel(?FormModel $formModel): SetFormByStampSheetResult {
		$this->formModel = $formModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SetFormByStampSheetResult {
        if ($data === null) {
            return null;
        }
