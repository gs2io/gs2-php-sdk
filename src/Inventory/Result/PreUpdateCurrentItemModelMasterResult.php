...
class PreUpdateCurrentItemModelMasterResult implements IResult {
    /** @var string */
    private $uploadToken;
    /** @var string */
    private $uploadUrl;
	...
	public function withUploadToken(?string $uploadToken): PreUpdateCurrentItemModelMasterResult {
		$this->uploadToken = $uploadToken;
		return $this;
	}
	...
	public function withUploadUrl(?string $uploadUrl): PreUpdateCurrentItemModelMasterResult {
		$this->uploadUrl = $uploadUrl;
		return $this;
	}

    public static function fromJson(?array $data): ?PreUpdateCurrentItemModelMasterResult {
        if ($data === null) {
            return null;
        }
