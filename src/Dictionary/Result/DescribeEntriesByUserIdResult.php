...
class DescribeEntriesByUserIdResult implements IResult {
	...
	public function withItems(?array $items): DescribeEntriesByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeEntriesByUserIdResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
