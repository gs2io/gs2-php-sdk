...
use Gs2\Watch\Model\AlarmEvent;

/**
 * @author Game Server Services, Inc.
 */
class DescribeAlarmEventResult {

	/** @var AlarmEvent[] アラームイベント */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, AlarmEvent::build($arr));
            }
        }
	 ...
	 * アラームイベントを設定
	 *
	 * @param AlarmEvent[] $items アラームイベント
	 */
