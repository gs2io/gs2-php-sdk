...
class DeleteLotteryModelMasterResult implements IResult {
	/** @var LotteryModelMaster 削除した抽選の種類マスター */
	private $item;

	/**
	 * 削除した抽選の種類マスターを取得
	 *
	 * @return LotteryModelMaster|null 抽選の種類マスターを削除
	 */
	 ...
	 * 削除した抽選の種類マスターを設定
	 *
	 * @param LotteryModelMaster|null $item 抽選の種類マスターを削除
	 */
	public function setItem(?LotteryModelMaster $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): DeleteLotteryModelMasterResult {
        $result = new DeleteLotteryModelMasterResult();
