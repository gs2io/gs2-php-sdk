...
class VerifyIncludeMemberResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): VerifyIncludeMemberResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?VerifyIncludeMemberResult {
        if ($data === null) {
            return null;
        }
