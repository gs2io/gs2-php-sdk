...
class DoTakeOverOpenIdConnectResult implements IResult {
    /** @var Account */
    private $item;
	...
	public function withItem(?Account $item): DoTakeOverOpenIdConnectResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DoTakeOverOpenIdConnectResult {
        if ($data === null) {
            return null;
        }
