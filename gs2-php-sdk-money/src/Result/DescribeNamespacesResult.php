...
class DescribeNamespacesResult implements IResult {
	 ...
	 * ネームスペースのリストを取得
	 *
	 * @return Namespace_[]|null ネームスペースの一覧を取得します
	 */
	 ...
	 * ネームスペースのリストを設定
	 *
	 * @param Namespace_[]|null $items ネームスペースの一覧を取得します
	 */
	 ...
	 *
	 * @param string|null $nextPageToken ネームスペースの一覧を取得します
	 */
