...
class DescribeSubscribesResult implements IResult {
	 ...
	 * 購読のリストを取得
	 *
	 * @return Subscribe[]|null 購読しているルームの一覧取得
	 */
	 ...
	 * 購読のリストを設定
	 *
	 * @param Subscribe[]|null $items 購読しているルームの一覧取得
	 */
	 ...
	 *
	 * @param string|null $nextPageToken 購読しているルームの一覧取得
	 */
    ...
    public static function fromJson(array $data): DescribeSubscribesResult {
        $result = new DescribeSubscribesResult();
