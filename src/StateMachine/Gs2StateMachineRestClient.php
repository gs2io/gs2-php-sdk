...
use Gs2\StateMachine\Result\GetServiceVersionResult;
use Gs2\StateMachine\Request\DumpUserDataByUserIdRequest;
use Gs2\StateMachine\Result\DumpUserDataByUserIdResult;
use Gs2\StateMachine\Request\CheckDumpUserDataByUserIdRequest;
use Gs2\StateMachine\Result\CheckDumpUserDataByUserIdResult;
use Gs2\StateMachine\Request\CleanUserDataByUserIdRequest;
use Gs2\StateMachine\Result\CleanUserDataByUserIdResult;
use Gs2\StateMachine\Request\CheckCleanUserDataByUserIdRequest;
use Gs2\StateMachine\Result\CheckCleanUserDataByUserIdResult;
use Gs2\StateMachine\Request\PrepareImportUserDataByUserIdRequest;
use Gs2\StateMachine\Result\PrepareImportUserDataByUserIdResult;
use Gs2\StateMachine\Request\ImportUserDataByUserIdRequest;
use Gs2\StateMachine\Result\ImportUserDataByUserIdResult;
use Gs2\StateMachine\Request\CheckImportUserDataByUserIdRequest;
use Gs2\StateMachine\Result\CheckImportUserDataByUserIdResult;
...
class GetServiceVersionTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/version";
...
class DumpUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/dump/user/{userId}";
...
class CleanUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/clean/user/{userId}";
...
class PrepareImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/import/user/{userId}/prepare";
...
class ImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/import/user/{userId}";
...
class CheckImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "state-machine", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/import/user/{userId}/{uploadToken}";
