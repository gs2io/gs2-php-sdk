...
class GetTakeOverRequest extends Gs2UserRequest {
	 ...
	 */
	public function withGameName($gameName): GetTakeOverRequest {
	 ...
	 * @return GetTakeOverRequest
	 */
	public function withType($type): GetTakeOverRequest {
		$this->setType($type);
		return $this;
	}
	 ...
	 * @return GetTakeOverRequest
	 */
	public function withUserIdentifier($userIdentifier): GetTakeOverRequest {
