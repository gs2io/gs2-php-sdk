...
use Gs2\Exchange\Domain\Cache\RateModelMasterDomainCache;
...
class DescribeRateModelMastersIterator implements Iterator {

    /**
     * @var RateModelMasterDomainCache
     */
    ...
    public function __construct(
        RateModelMasterDomainCache $rateModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeRateModelMastersResult
         */
         $r = $this->client->describeRateModelMasters(
