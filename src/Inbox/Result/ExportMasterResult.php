...
/**
 * 現在有効なグローバルメッセージ設定のマスターデータをエクスポートします のレスポンスモデル
 *
...
class ExportMasterResult implements IResult {
	 ...
	 *
	 * @return CurrentMessageMaster|null 現在有効なグローバルメッセージ設定のマスターデータをエクスポートします
	 */
	 ...
	 *
	 * @param CurrentMessageMaster|null $item 現在有効なグローバルメッセージ設定のマスターデータをエクスポートします
	 */
