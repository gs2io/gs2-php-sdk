...
use Gs2\Gacha\Model\GachaPool;

/**
 * @author Game Server Services, Inc.
 */
class DescribeGachaPoolResult {

	/** @var GachaPool[] ガチャプール */
	private $items;
    ...
    public function __construct(array $array)
    {
        if(isset($array['items'])) {
            ...
            {
                array_push($this->items, GachaPool::build($arr));
            }
        }
