...
class ReceiveGlobalMessageByUserIdRequest extends Gs2BasicRequest {
	...
	public function withTimeOffsetToken(?string $timeOffsetToken): ReceiveGlobalMessageByUserIdRequest {
		$this->timeOffsetToken = $timeOffsetToken;
		return $this;
	}
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): ReceiveGlobalMessageByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?ReceiveGlobalMessageByUserIdRequest {
        if ($data === null) {
            return null;
        }
