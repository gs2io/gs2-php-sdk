...
class UnmarkReceivedByUserIdResult implements IResult {
    /** @var ReceiveStatus */
    private $item;
    /** @var BonusModel */
    private $bonusModel;
	...
	public function withItem(?ReceiveStatus $item): UnmarkReceivedByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withBonusModel(?BonusModel $bonusModel): UnmarkReceivedByUserIdResult {
		$this->bonusModel = $bonusModel;
		return $this;
	}

    public static function fromJson(?array $data): ?UnmarkReceivedByUserIdResult {
        if ($data === null) {
            return null;
        }
