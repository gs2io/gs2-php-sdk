...
class CreateBuffEntryModelMasterResult implements IResult {
	...
	public function withItem(?BuffEntryModelMaster $item): CreateBuffEntryModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?CreateBuffEntryModelMasterResult {
        if ($data === null) {
            return null;
        }
