...
class UseResult implements IResult {
    /** @var SerialKey */
    private $item;
    /** @var CampaignModel */
	...
	public function withItem(?SerialKey $item): UseResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withCampaignModel(?CampaignModel $campaignModel): UseResult {
		$this->campaignModel = $campaignModel;
		return $this;
	}

    public static function fromJson(?array $data): ?UseResult {
        if ($data === null) {
            return null;
        }
