 ...
 */
class GetEventRequest extends Gs2UserRequest {

    const FUNCTION = "GetEvent";
	 ...
	 */
	public function withScheduleName($scheduleName): GetEventRequest {
	 ...
	 * @return GetEventRequest
	 */
	public function withEventName($eventName): GetEventRequest {
