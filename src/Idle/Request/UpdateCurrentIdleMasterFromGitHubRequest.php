...
class UpdateCurrentIdleMasterFromGitHubRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentIdleMasterFromGitHubRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCheckoutSetting(?GitHubCheckoutSetting $checkoutSetting): UpdateCurrentIdleMasterFromGitHubRequest {
		$this->checkoutSetting = $checkoutSetting;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentIdleMasterFromGitHubRequest {
        if ($data === null) {
            return null;
        }
