 ...
 */
class DeleteLockPoolRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteLockPool";
	 ...
	 *
	 * @param string $lockPoolName ロックプールの名前を指定します。
	 * @return DeleteLockPoolRequest
	 */
	public function withLockPoolName($lockPoolName): DeleteLockPoolRequest {
