...
class GetDistributorModelMasterRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetDistributorModelMasterRequest {
     ...
     * @return GetDistributorModelMasterRequest $this
     */
    public function withDistributorName(string $distributorName = null): GetDistributorModelMasterRequest {
