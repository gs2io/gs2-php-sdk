...
class CurrentTreeMaster implements IModel {
	/**
     * @var string
	 */
	private $namespaceId;
	...
	public function withNamespaceId(?string $namespaceId): CurrentTreeMaster {
		$this->namespaceId = $namespaceId;
		return $this;
	}
	...
	public function withSettings(?string $settings): CurrentTreeMaster {
		$this->settings = $settings;
		return $this;
	}

    public static function fromJson(?array $data): ?CurrentTreeMaster {
        if ($data === null) {
            return null;
        }
