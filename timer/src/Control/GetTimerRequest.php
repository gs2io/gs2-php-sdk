 ...
 */
class GetTimerRequest extends Gs2BasicRequest {

    const FUNCTION = "GetTimer";

	/** @var string タイマープールの名前を指定します。 */
	private $timerPoolName;

	/** @var string タイマーのIDを指定します。 */
	private $timerId;
	 ...
	 *
	 * @param string $timerPoolName タイマープールの名前を指定します。
	 * @return GetTimerRequest
	 */
	public function withTimerPoolName($timerPoolName): GetTimerRequest {
	 ...
	 * タイマーのIDを指定します。を設定
	 *
	 * @param string $timerId タイマーのIDを指定します。
	 */
	 ...
	 * @return GetTimerRequest
	 */
	public function withTimerId($timerId): GetTimerRequest {
