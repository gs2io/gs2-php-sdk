...
class GetSimpleItemModelResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetSimpleItemModelResult {
        if ($data === null) {
            return null;
        }
        return (new GetSimpleItemModelResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? SimpleItemModel::fromJson($data['item']) : null);
    }
