...
class CreateNamespaceRequest extends Gs2BasicRequest {
    ...
    /** @var string Firebase の通知送信に使用するシークレットトークン */
     ...
     *
     * @param string $firebaseSecret ネームスペースを新規作成
     */
    public function setFirebaseSecret(string $firebaseSecret = null) {
     ...
     * @return CreateNamespaceRequest $this
     */
    public function withFirebaseSecret(string $firebaseSecret = null): CreateNamespaceRequest {
        $this->setFirebaseSecret($firebaseSecret);
        return $this;
    }
