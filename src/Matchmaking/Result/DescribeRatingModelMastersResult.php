...
class DescribeRatingModelMastersResult implements IResult {
	...
	public function withItems(?array $items): DescribeRatingModelMastersResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeRatingModelMastersResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?DescribeRatingModelMastersResult {
        ...
        return (new DescribeRatingModelMastersResult())
            ->withItems(array_map(
                function ($item) {
                    return RatingModelMaster::fromJson($item);
                },
