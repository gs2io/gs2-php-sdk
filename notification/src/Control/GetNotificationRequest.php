 ...
 */
class GetNotificationRequest extends Gs2BasicRequest {

    const FUNCTION = "GetNotification";
	 ...
	 */
	public function withNotificationName($notificationName): GetNotificationRequest {
