...
use Gs2\Schedule\Domain\Cache\EventMasterDomainCache;
...
class DescribeEventMastersIterator implements Iterator {

    /**
     * @var EventMasterDomainCache
     */
    ...
    public function __construct(
        EventMasterDomainCache $eventMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeEventMastersResult
         */
         $r = $this->client->describeEventMasters(
