...
/**
 * 現在有効なエントリー設定のマスターデータをエクスポートします のレスポンスモデル
 *
...
class ExportMasterResult implements IResult {
	 ...
	 * 現在有効なエントリー設定を取得
	 *
	 * @return CurrentEntryMaster|null 現在有効なエントリー設定のマスターデータをエクスポートします
	 */
	 ...
	 * 現在有効なエントリー設定を設定
	 *
	 * @param CurrentEntryMaster|null $item 現在有効なエントリー設定のマスターデータをエクスポートします
	 */
