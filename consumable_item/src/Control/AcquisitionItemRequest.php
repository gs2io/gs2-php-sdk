 ...
 */
class AcquisitionItemRequest extends Gs2UserRequest {

    const FUNCTION = "AcquisitionItem";
	 ...
	 *
	 * @param string $itemPoolName 消費型アイテムプールの名前
	 * @return AcquisitionItemRequest
	 */
	public function withItemPoolName($itemPoolName): AcquisitionItemRequest {
	 ...
	 * @return AcquisitionItemRequest
	 */
	public function withItemName($itemName): AcquisitionItemRequest {
	 ...
	 * @return AcquisitionItemRequest
	 */
	public function withCount($count): AcquisitionItemRequest {
		$this->setCount($count);
		return $this;
	}
	 ...
	 * @return AcquisitionItemRequest
	 */
	public function withExpireAt($expireAt): AcquisitionItemRequest {
