...
class SetFormByUserIdResult implements IResult {
	 ...
	 * フォームを取得
	 *
	 * @return Form|null ユーザIDを指定してフォームを更新
	 */
	 ...
	 * フォームを設定
	 *
	 * @param Form|null $item ユーザIDを指定してフォームを更新
	 */
	 ...
	 * 保存したフォームを取得
	 *
	 * @return Mold|null ユーザIDを指定してフォームを更新
	 */
	 ...
	 * 保存したフォームを設定
	 *
	 * @param Mold|null $mold ユーザIDを指定してフォームを更新
	 */
	 ...
	 * フォームの保存領域を取得
	 *
	 * @return MoldModel|null ユーザIDを指定してフォームを更新
	 */
	 ...
	 * フォームの保存領域を設定
	 *
	 * @param MoldModel|null $moldModel ユーザIDを指定してフォームを更新
	 */
	 ...
	 * フォームモデルを取得
	 *
	 * @return FormModel|null ユーザIDを指定してフォームを更新
	 */
	 ...
	 * フォームモデルを設定
	 *
	 * @param FormModel|null $formModel ユーザIDを指定してフォームを更新
	 */
	public function setFormModel(?FormModel $formModel) {
		$this->formModel = $formModel;
	}

    public static function fromJson(array $data): SetFormByUserIdResult {
        $result = new SetFormByUserIdResult();
