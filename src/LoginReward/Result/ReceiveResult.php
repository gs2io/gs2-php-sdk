...
class ReceiveResult implements IResult {
	...
	public function withItem(?ReceiveStatus $item): ReceiveResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withBonusModel(?BonusModel $bonusModel): ReceiveResult {
		$this->bonusModel = $bonusModel;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): ReceiveResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): ReceiveResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): ReceiveResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): ReceiveResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): ReceiveResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): ReceiveResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): ReceiveResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?ReceiveResult {
        if ($data === null) {
            return null;
        }
