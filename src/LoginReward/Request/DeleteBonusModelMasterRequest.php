...
class DeleteBonusModelMasterRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): DeleteBonusModelMasterRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withBonusModelName(?string $bonusModelName): DeleteBonusModelMasterRequest {
		$this->bonusModelName = $bonusModelName;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteBonusModelMasterRequest {
        if ($data === null) {
            return null;
        }
