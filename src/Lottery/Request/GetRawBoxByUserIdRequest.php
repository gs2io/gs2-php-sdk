...
class GetRawBoxByUserIdRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName ユーザIDを指定してボックスを取得
     * @return GetRawBoxByUserIdRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetRawBoxByUserIdRequest {
     ...
     * @return GetRawBoxByUserIdRequest $this
     */
    public function withPrizeTableName(string $prizeTableName = null): GetRawBoxByUserIdRequest {
     ...
     * @return GetRawBoxByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetRawBoxByUserIdRequest {
     ...
     * @return GetRawBoxByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetRawBoxByUserIdRequest {
