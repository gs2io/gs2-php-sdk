...
class GetClusterRankingScoreResult implements IResult {
	...
	public function withItem(?ClusterRankingScore $item): GetClusterRankingScoreResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetClusterRankingScoreResult {
        if ($data === null) {
            return null;
        }
