 ...
 */
class AnybodyDoMatchmakingRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return AnybodyDoMatchmakingRequest
	 */
	public function withMatchmakingName($matchmakingName): AnybodyDoMatchmakingRequest {
