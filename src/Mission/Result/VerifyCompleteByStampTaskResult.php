...
class VerifyCompleteByStampTaskResult implements IResult {
	...
	public function withNewContextStack(?string $newContextStack): VerifyCompleteByStampTaskResult {
		$this->newContextStack = $newContextStack;
		return $this;
	}

    public static function fromJson(?array $data): ?VerifyCompleteByStampTaskResult {
        if ($data === null) {
            return null;
        }
