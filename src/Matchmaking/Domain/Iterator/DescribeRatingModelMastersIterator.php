...
use Gs2\Matchmaking\Domain\Cache\RatingModelMasterDomainCache;
...
class DescribeRatingModelMastersIterator implements Iterator {

    /**
     * @var RatingModelMasterDomainCache
     */
    ...
    public function __construct(
        RatingModelMasterDomainCache $ratingModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeRatingModelMastersResult
         */
         $r = $this->client->describeRatingModelMasters(
