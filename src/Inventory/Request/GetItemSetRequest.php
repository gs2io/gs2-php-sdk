...
class GetItemSetRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetItemSetRequest {
     ...
     * @return GetItemSetRequest $this
     */
    public function withInventoryName(string $inventoryName = null): GetItemSetRequest {
     ...
     * @return GetItemSetRequest $this
     */
    public function withItemName(string $itemName = null): GetItemSetRequest {
     ...
     * @return GetItemSetRequest $this
     */
    public function withItemSetName(string $itemSetName = null): GetItemSetRequest {
     ...
     * @return GetItemSetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetItemSetRequest {
