...
class DeleteSimpleItemsByUserIdRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): DeleteSimpleItemsByUserIdRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteSimpleItemsByUserIdRequest {
        if ($data === null) {
            return null;
        }
