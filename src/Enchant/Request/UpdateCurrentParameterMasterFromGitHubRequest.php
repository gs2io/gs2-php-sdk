...
use Gs2\Enchant\Model\GitHubCheckoutSetting;

class UpdateCurrentParameterMasterFromGitHubRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): UpdateCurrentParameterMasterFromGitHubRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCheckoutSetting(?GitHubCheckoutSetting $checkoutSetting): UpdateCurrentParameterMasterFromGitHubRequest {
		$this->checkoutSetting = $checkoutSetting;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentParameterMasterFromGitHubRequest {
        if ($data === null) {
            return null;
        }
