 ...
 */
class GetGlobalMessageRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName 全ユーザに向けたメッセージを取得
     * @return GetGlobalMessageRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetGlobalMessageRequest {
     ...
     * @return GetGlobalMessageRequest $this
     */
    public function withGlobalMessageName(string $globalMessageName = null): GetGlobalMessageRequest {
