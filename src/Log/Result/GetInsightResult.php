...
class GetInsightResult implements IResult {
    /** @var Insight */
    private $item;
	...
	public function withItem(?Insight $item): GetInsightResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetInsightResult {
        if ($data === null) {
            return null;
        }
