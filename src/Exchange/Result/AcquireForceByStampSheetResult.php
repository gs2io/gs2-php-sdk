...
class AcquireForceByStampSheetResult implements IResult {
    /** @var Await */
    private $item;
    /** @var string */
	...
	public function withItem(?Await $item): AcquireForceByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): AcquireForceByStampSheetResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): AcquireForceByStampSheetResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): AcquireForceByStampSheetResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): AcquireForceByStampSheetResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): AcquireForceByStampSheetResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): AcquireForceByStampSheetResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): AcquireForceByStampSheetResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?AcquireForceByStampSheetResult {
        if ($data === null) {
            return null;
        }
