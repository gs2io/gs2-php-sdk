...
class AcquireByUserIdResult implements IResult {
	...
	public function withAtomicCommit(?bool $atomicCommit): AcquireByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): AcquireByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): AcquireByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
