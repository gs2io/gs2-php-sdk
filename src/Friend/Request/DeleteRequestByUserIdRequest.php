...
class DeleteRequestByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DeleteRequestByUserIdRequest {
     ...
     * @return DeleteRequestByUserIdRequest $this
     */
    public function withUserId(string $userId = null): DeleteRequestByUserIdRequest {
     ...
     * @return DeleteRequestByUserIdRequest $this
     */
    public function withTargetUserId(string $targetUserId = null): DeleteRequestByUserIdRequest {
     ...
     * @return DeleteRequestByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DeleteRequestByUserIdRequest {
