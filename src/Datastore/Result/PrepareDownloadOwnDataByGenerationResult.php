...
/**
 * データオブジェクトを世代を指定してダウンロード準備する のレスポンスモデル
 *
 * @author Game Server Services, Inc.
 */
class PrepareDownloadOwnDataByGenerationResult implements IResult {
	 ...
	 * データオブジェクトを取得
	 *
	 * @return DataObject|null データオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 * データオブジェクトを設定
	 *
	 * @param DataObject|null $item データオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 *
	 * @param string|null $fileUrl データオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 * ファイルの容量を取得
	 *
	 * @return int|null データオブジェクトを世代を指定してダウンロード準備する
	 */
	 ...
	 * ファイルの容量を設定
	 *
	 * @param int|null $contentLength データオブジェクトを世代を指定してダウンロード準備する
	 */
	public function setContentLength(?int $contentLength) {
		$this->contentLength = $contentLength;
	}

    public static function fromJson(array $data): PrepareDownloadOwnDataByGenerationResult {
        $result = new PrepareDownloadOwnDataByGenerationResult();
