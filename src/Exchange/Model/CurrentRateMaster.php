 ...
 *
 */
class CurrentRateMaster implements IModel {
	/**
     * @var string ネームスペース名
	 */
	 ...
	 *
	 * @param string|null $namespaceName ネームスペース名
	 * @return CurrentRateMaster $this
	 */
	public function withNamespaceName(?string $namespaceName): CurrentRateMaster {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	/**
	 ...
	 * @return CurrentRateMaster $this
	 */
	public function withSettings(?string $settings): CurrentRateMaster {
		$this->settings = $settings;
		return $this;
	}
    ...
    public static function fromJson(array $data): CurrentRateMaster {
        $model = new CurrentRateMaster();
