 ...
 */
class DeleteGachaMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteGachaMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return DeleteGachaMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): DeleteGachaMasterRequest {
	 ...
	 * @return DeleteGachaMasterRequest
	 */
	public function withGachaName($gachaName): DeleteGachaMasterRequest {
