 ...
 */
class UpdateShowcaseItemMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "UpdateShowcaseItemMaster";
	 ...
	 *
	 * @param string $showcaseName ショーケースの名前
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withShowcaseName($showcaseName): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withCategory($category): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withResourceId($resourceId): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withReleaseConditionType($releaseConditionType): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withReleaseConditionScheduleName($releaseConditionScheduleName): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withReleaseConditionScheduleEventName($releaseConditionScheduleEventName): UpdateShowcaseItemMasterRequest {
	 ...
	 * @return UpdateShowcaseItemMasterRequest
	 */
	public function withPriority($priority): UpdateShowcaseItemMasterRequest {
