...
use Gs2\Key\Domain\Cache\KeyDomainCache;
...
class DescribeKeysIterator implements Iterator {
    ...
    private function load(): void {
        /**
         * @var DescribeKeysResult
         */
         $r = $this->client->describeKeys(
