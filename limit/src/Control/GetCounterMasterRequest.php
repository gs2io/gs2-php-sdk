 ...
 */
class GetCounterMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetCounterMaster";
	 ...
	 *
	 * @param string $limitName 回数制限の名前を指定します。
	 * @return GetCounterMasterRequest
	 */
	public function withLimitName($limitName): GetCounterMasterRequest {
	 ...
	 * @return GetCounterMasterRequest
	 */
	public function withCounterName($counterName): GetCounterMasterRequest {
