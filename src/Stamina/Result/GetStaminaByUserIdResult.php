 ...
 */
class GetStaminaByUserIdResult implements IResult {
	/** @var Stamina スタミナ */
	private $item;
	 ...
	 * スタミナを設定
	 *
	 * @param Stamina|null $item ユーザIDを指定してスタミナを取得
	 */
	 ...
	 * スタミナモデルを取得
	 *
	 * @return StaminaModel|null ユーザIDを指定してスタミナを取得
	 */
	 ...
	 * スタミナモデルを設定
	 *
	 * @param StaminaModel|null $staminaModel ユーザIDを指定してスタミナを取得
	 */
	public function setStaminaModel(?StaminaModel $staminaModel) {
		$this->staminaModel = $staminaModel;
	}

    public static function fromJson(array $data): GetStaminaByUserIdResult {
        $result = new GetStaminaByUserIdResult();
