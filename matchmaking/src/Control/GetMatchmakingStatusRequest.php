 ...
 */
class GetMatchmakingStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetMatchmakingStatus";
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return GetMatchmakingStatusRequest
	 */
	public function withMatchmakingName($matchmakingName): GetMatchmakingStatusRequest {
