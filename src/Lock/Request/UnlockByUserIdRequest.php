...
class UnlockByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): UnlockByUserIdRequest {
     ...
     * @return UnlockByUserIdRequest $this
     */
    public function withPropertyId(string $propertyId = null): UnlockByUserIdRequest {
     ...
     * @return UnlockByUserIdRequest $this
     */
    public function withUserId(string $userId = null): UnlockByUserIdRequest {
     ...
     * @return UnlockByUserIdRequest $this
     */
    public function withTransactionId(string $transactionId = null): UnlockByUserIdRequest {
     ...
     * @return UnlockByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): UnlockByUserIdRequest {
