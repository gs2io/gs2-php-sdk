 ...
 */
class RoomDescribeJoinedUserRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomDescribeJoinedUserRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomDescribeJoinedUserRequest {
	 ...
	 * @return RoomDescribeJoinedUserRequest
	 */
	public function withGatheringId($gatheringId): RoomDescribeJoinedUserRequest {
