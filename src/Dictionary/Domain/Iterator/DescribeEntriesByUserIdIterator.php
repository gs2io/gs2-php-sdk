...
use Gs2\Dictionary\Domain\Cache\EntryDomainCache;
...
class DescribeEntriesByUserIdIterator implements Iterator {

    /**
     * @var EntryDomainCache
     */
    private $entryCache;
    ...
    private function load(): void {
        /**
         * @var DescribeEntriesByUserIdResult
         */
         $r = $this->client->describeEntriesByUserId(
