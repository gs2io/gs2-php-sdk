...
class UpdateCurrentFormMasterRequest extends Gs2BasicRequest {
	...
	public function withMode(?string $mode): UpdateCurrentFormMasterRequest {
		$this->mode = $mode;
		return $this;
	}
	...
	public function withUploadToken(?string $uploadToken): UpdateCurrentFormMasterRequest {
		$this->uploadToken = $uploadToken;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentFormMasterRequest {
        if ($data === null) {
            return null;
        }
