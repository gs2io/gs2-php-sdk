...
class DeleteStatusModelMasterResult implements IResult {
    /** @var NodeModelMaster */
    private $item;
	...
	public function withItem(?NodeModelMaster $item): DeleteStatusModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteStatusModelMasterResult {
        if ($data === null) {
            return null;
        }
