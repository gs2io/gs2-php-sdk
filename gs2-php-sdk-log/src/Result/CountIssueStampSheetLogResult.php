...
class CountIssueStampSheetLogResult implements IResult {
	/** @var IssueStampSheetLogCount[] スタンプシート発行ログ集計のリスト */
	private $items;
	...
	/**
	 * スタンプシート発行ログ集計のリストを取得
	 *
	 * @return IssueStampSheetLogCount[]|null スタンプシート発行ログの一覧を取得
	 */
	...
	/**
	 * スタンプシート発行ログ集計のリストを設定
	 *
	 * @param IssueStampSheetLogCount[]|null $items スタンプシート発行ログの一覧を取得
	 */
    ...
    public static function fromJson(array $data): CountIssueStampSheetLogResult {
        $result = new CountIssueStampSheetLogResult();
        $result->setItems(array_map(
                function ($v) {
                    return IssueStampSheetLogCount::fromJson($v);
                },
