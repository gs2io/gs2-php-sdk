...
use Gs2\Version\Domain\Cache\VersionModelMasterDomainCache;
...
class DescribeVersionModelMastersIterator implements Iterator {

    /**
     * @var VersionModelMasterDomainCache
     */
    ...
    public function __construct(
        VersionModelMasterDomainCache $versionModelMasterCache,
    ...
    private function load(): void {
        /**
         * @var DescribeVersionModelMastersResult
         */
         $r = $this->client->describeVersionModelMasters(
