...
class SubscribeByUserIdRequest extends Gs2BasicRequest {
     ...
     * ネームスペース名を取得
     *
     * @return string|null ユーザIDを指定してユーザIDを購読
     */
     ...
     * ネームスペース名を設定
     *
     * @param string $namespaceName ユーザIDを指定してユーザIDを購読
     */
     ...
     * カテゴリ名を設定
     *
     * @param string $categoryName ユーザIDを指定してユーザIDを購読
     */
     ...
     * @return SubscribeByUserIdRequest $this
     */
    public function withCategoryName(string $categoryName = null): SubscribeByUserIdRequest {
     ...
     * 購読するユーザIDを設定
     *
     * @param string $userId ユーザIDを指定してユーザIDを購読
     */
     ...
     * 購読されるユーザIDを設定
     *
     * @param string $targetUserId ユーザIDを指定してユーザIDを購読
     */
     ...
     * @return SubscribeByUserIdRequest $this
     */
    public function withTargetUserId(string $targetUserId = null): SubscribeByUserIdRequest {
     ...
     * 重複実行回避機能に使用するIDを設定
     *
     * @param string $duplicationAvoider ユーザIDを指定してユーザIDを購読
     */
