 ...
 */
class GetGachaMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGachaMaster";
	 ...
	 *
	 * @param string $gachaPoolName ガチャプールの名前を指定します。
	 * @return GetGachaMasterRequest
	 */
	public function withGachaPoolName($gachaPoolName): GetGachaMasterRequest {
	 ...
	 * @return GetGachaMasterRequest
	 */
	public function withGachaName($gachaName): GetGachaMasterRequest {
