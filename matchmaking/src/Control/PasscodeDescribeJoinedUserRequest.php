 ...
 */
class PasscodeDescribeJoinedUserRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return PasscodeDescribeJoinedUserRequest
	 */
	public function withMatchmakingName($matchmakingName): PasscodeDescribeJoinedUserRequest {
	 ...
	 * @return PasscodeDescribeJoinedUserRequest
	 */
	public function withGatheringId($gatheringId): PasscodeDescribeJoinedUserRequest {
