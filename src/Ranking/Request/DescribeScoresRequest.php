...
class DescribeScoresRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName スコアの一覧を取得
     * @return DescribeScoresRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): DescribeScoresRequest {
     ...
     * @return DescribeScoresRequest $this
     */
    public function withCategoryName(string $categoryName = null): DescribeScoresRequest {
     ...
     * @return DescribeScoresRequest $this
     */
    public function withScorerUserId(string $scorerUserId = null): DescribeScoresRequest {
     ...
     * @return DescribeScoresRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeScoresRequest {
     ...
     * @return DescribeScoresRequest $this
     */
    public function withLimit(int $limit = null): DescribeScoresRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeScoresRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeScoresRequest {
