 ...
 */
class RoomLeaveGatheringRequest extends Gs2UserRequest {
	 ...
	 *
	 * @param string $matchmakingName マッチメイキングの名前を指定します。
	 * @return RoomLeaveGatheringRequest
	 */
	public function withMatchmakingName($matchmakingName): RoomLeaveGatheringRequest {
	 ...
	 * @return RoomLeaveGatheringRequest
	 */
	public function withGatheringId($gatheringId): RoomLeaveGatheringRequest {
