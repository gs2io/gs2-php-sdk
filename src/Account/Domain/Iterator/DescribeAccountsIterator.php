...
use Gs2\Account\Domain\Cache\AccountDomainCache;
...
class DescribeAccountsIterator implements Iterator {

    /**
     * @var AccountDomainCache
     */
    ...
    public function __construct(
        AccountDomainCache $accountCache,
    ...
    private function load(): void {
        /**
         * @var DescribeAccountsResult
         */
         $r = $this->client->describeAccounts(
