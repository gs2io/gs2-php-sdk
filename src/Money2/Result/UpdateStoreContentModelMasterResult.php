...
class UpdateStoreContentModelMasterResult implements IResult {
	...
	public function withItem(?StoreContentModelMaster $item): UpdateStoreContentModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateStoreContentModelMasterResult {
        if ($data === null) {
            return null;
        }
