...
class DescribeReceiveRequestsByUserIdIterator implements Iterator {
    ...
    private function load(): void {
        /**
         * @var DescribeReceiveRequestsByUserIdResult
         */
         $r = $this->client->describeReceiveRequestsByUserId(
