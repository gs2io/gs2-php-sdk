...
class GetWebSocketSessionRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetWebSocketSessionRequest {
     ...
     * @return GetWebSocketSessionRequest $this
     */
    public function withConnectionId(string $connectionId = null): GetWebSocketSessionRequest {
