 ...
 */
class GetGoldPoolStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetGoldPoolStatus";
	 ...
	 *
	 * @param string $goldPoolName ゴールドプールの名前
	 * @return GetGoldPoolStatusRequest
	 */
	public function withGoldPoolName($goldPoolName): GetGoldPoolStatusRequest {
