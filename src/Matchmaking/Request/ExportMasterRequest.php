...
/**
 * 現在有効なレーティングマスターのマスターデータをエクスポートします のリクエストモデル
 *
...
class ExportMasterRequest extends Gs2BasicRequest {
     ...
     * ネームスペース名を取得
     *
     * @return string|null 現在有効なレーティングマスターのマスターデータをエクスポートします
     */
     ...
     * ネームスペース名を設定
     *
     * @param string $namespaceName 現在有効なレーティングマスターのマスターデータをエクスポートします
     */
