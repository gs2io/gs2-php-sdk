...
class DirectEnhanceByUserIdResult implements IResult {
	...
	public function withAtomicCommit(?bool $atomicCommit): DirectEnhanceByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): DirectEnhanceByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): DirectEnhanceByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
