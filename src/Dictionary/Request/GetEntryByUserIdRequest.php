...
class GetEntryByUserIdRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName ユーザIDを指定してエントリーを取得
     * @return GetEntryByUserIdRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetEntryByUserIdRequest {
     ...
     * @return GetEntryByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetEntryByUserIdRequest {
     ...
     * @return GetEntryByUserIdRequest $this
     */
    public function withEntryModelName(string $entryModelName = null): GetEntryByUserIdRequest {
     ...
     * @return GetEntryByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetEntryByUserIdRequest {
