...
class SetMaxValueByStatusResult implements IResult {
    /** @var Stamina */
    private $item;
    /** @var Stamina */
    private $old;
	...
	public function withItem(?Stamina $item): SetMaxValueByStatusResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withOld(?Stamina $old): SetMaxValueByStatusResult {
		$this->old = $old;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): SetMaxValueByStatusResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}

    public static function fromJson(?array $data): ?SetMaxValueByStatusResult {
        if ($data === null) {
            return null;
        }
