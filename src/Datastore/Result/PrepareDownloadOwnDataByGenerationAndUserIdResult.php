 ...
 */
class PrepareDownloadOwnDataByGenerationAndUserIdResult implements IResult {
    ...
    public static function fromJson(array $data): PrepareDownloadOwnDataByGenerationAndUserIdResult {
        $result = new PrepareDownloadOwnDataByGenerationAndUserIdResult();
