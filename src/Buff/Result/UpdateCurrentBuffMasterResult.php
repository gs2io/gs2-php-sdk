...
class UpdateCurrentBuffMasterResult implements IResult {
	...
	public function withItem(?CurrentBuffMaster $item): UpdateCurrentBuffMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateCurrentBuffMasterResult {
        if ($data === null) {
            return null;
        }
