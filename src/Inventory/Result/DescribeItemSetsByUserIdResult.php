...
class DescribeItemSetsByUserIdResult implements IResult {
	...
	public function withItems(?array $items): DescribeItemSetsByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeItemSetsByUserIdResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
