...
class RandomShowcaseBuyResult implements IResult {
	...
	public function withAtomicCommit(?bool $atomicCommit): RandomShowcaseBuyResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): RandomShowcaseBuyResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): RandomShowcaseBuyResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
