 ...
 */
class GetShowcaseStatusRequest extends Gs2BasicRequest {

    const FUNCTION = "GetShowcaseStatus";
	 ...
	 *
	 * @param string $showcaseName ショーケースの名前
	 * @return GetShowcaseStatusRequest
	 */
	public function withShowcaseName($showcaseName): GetShowcaseStatusRequest {
