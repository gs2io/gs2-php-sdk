...
class QueryAccessLogResult implements IResult {
	 ...
	 * アクセスログのリストを取得
	 *
	 * @return AccessLog[]|null アクセスログの一覧を取得
	 */
	 ...
	 * アクセスログのリストを設定
	 *
	 * @param AccessLog[]|null $items アクセスログの一覧を取得
	 */
	 ...
	 *
	 * @param string|null $nextPageToken アクセスログの一覧を取得
	 */
	 ...
	 * クエリ結果の総件数を設定
	 *
	 * @param int|null $totalCount アクセスログの一覧を取得
	 */
	 ...
	 * 検索時にスキャンした総容量を設定
	 *
	 * @param int|null $scanSize アクセスログの一覧を取得
	 */
	public function setScanSize(?int $scanSize) {
		$this->scanSize = $scanSize;
	}

    public static function fromJson(array $data): QueryAccessLogResult {
        $result = new QueryAccessLogResult();
        $result->setItems(array_map(
                function ($v) {
                    return AccessLog::fromJson($v);
                },
