...
/**
 * ユーザーIDを指定してブラックリストに登録 のレスポンスモデル
 *
...
class RegisterBlackListByUserIdResult implements IResult {
	 ...
	 * ブラックリストを取得
	 *
	 * @return BlackList|null ユーザーIDを指定してブラックリストに登録
	 */
	 ...
	 * ブラックリストを設定
	 *
	 * @param BlackList|null $item ユーザーIDを指定してブラックリストに登録
	 */
	public function setItem(?BlackList $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): RegisterBlackListByUserIdResult {
        $result = new RegisterBlackListByUserIdResult();
