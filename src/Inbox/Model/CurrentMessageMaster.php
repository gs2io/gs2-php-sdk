 ...
 *
 */
class CurrentMessageMaster implements IModel {
	/**
     * @var string ネームスペース名
	 */
	 ...
	 *
	 * @param string|null $namespaceName ネームスペース名
	 * @return CurrentMessageMaster $this
	 */
	public function withNamespaceName(?string $namespaceName): CurrentMessageMaster {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	/**
	 ...
	 * @return CurrentMessageMaster $this
	 */
	public function withSettings(?string $settings): CurrentMessageMaster {
		$this->settings = $settings;
		return $this;
	}
    ...
    public static function fromJson(array $data): CurrentMessageMaster {
        $model = new CurrentMessageMaster();
