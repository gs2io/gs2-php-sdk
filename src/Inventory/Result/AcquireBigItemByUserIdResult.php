...
class AcquireBigItemByUserIdResult implements IResult {
    /** @var BigItem */
    private $item;
	...
	public function withItem(?BigItem $item): AcquireBigItemByUserIdResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?AcquireBigItemByUserIdResult {
        if ($data === null) {
            return null;
        }
