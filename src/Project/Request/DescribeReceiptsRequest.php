...
class DescribeReceiptsRequest extends Gs2BasicRequest {
     ...
     * GS2アカウントトークンを設定
     *
     * @param string $accountToken 領収書の一覧を取得
     */
     ...
     */
    public function withAccountToken(string $accountToken = null): DescribeReceiptsRequest {
     ...
     *
     * @param string $pageToken 領収書の一覧を取得
     */
