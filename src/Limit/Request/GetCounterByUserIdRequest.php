...
class GetCounterByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetCounterByUserIdRequest {
     ...
     * 回数制限の種類の名前を設定
     *
     * @param string $limitName ユーザIDを指定してカウンターを取得
     */
     ...
     * @return GetCounterByUserIdRequest $this
     */
    public function withLimitName(string $limitName = null): GetCounterByUserIdRequest {
     ...
     * @return GetCounterByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetCounterByUserIdRequest {
     ...
     * @return GetCounterByUserIdRequest $this
     */
    public function withCounterName(string $counterName = null): GetCounterByUserIdRequest {
     ...
     * @return GetCounterByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetCounterByUserIdRequest {
