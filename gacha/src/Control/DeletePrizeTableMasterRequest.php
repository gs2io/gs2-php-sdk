...
class DeletePrizeTableMasterRequest extends Gs2BasicRequest {
    ...
    const FUNCTION = "DeletePrizeTableMaster";
	 ...
	 */
	public function withGachaPoolName($gachaPoolName): DeletePrizeTableMasterRequest {
	 ...
	 * @return DeletePrizeTableMasterRequest
	 */
	public function withPrizeTableName($prizeTableName): DeletePrizeTableMasterRequest {
