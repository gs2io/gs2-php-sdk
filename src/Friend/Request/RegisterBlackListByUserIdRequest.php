...
class RegisterBlackListByUserIdRequest extends Gs2BasicRequest {
	...
	public function withTimeOffsetToken(?string $timeOffsetToken): RegisterBlackListByUserIdRequest {
		$this->timeOffsetToken = $timeOffsetToken;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?RegisterBlackListByUserIdRequest {
        if ($data === null) {
            return null;
        }
