...
class DescribeCompletedQuestListsByUserIdResult implements IResult {
	...
	public function withItems(?array $items): DescribeCompletedQuestListsByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeCompletedQuestListsByUserIdResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?DescribeCompletedQuestListsByUserIdResult {
        ...
        return (new DescribeCompletedQuestListsByUserIdResult())
            ->withItems(array_map(
                function ($item) {
                    return CompletedQuestList::fromJson($item);
                },
