...
class DescribeStaminasByUserIdResult implements IResult {
	...
	public function withItems(?array $items): DescribeStaminasByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeStaminasByUserIdResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
