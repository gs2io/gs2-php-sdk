...
class GetReceiveStatusResult implements IResult {
    /** @var ReceiveStatus */
    private $item;
    /** @var BonusModel */
    private $bonusModel;
	...
	public function withItem(?ReceiveStatus $item): GetReceiveStatusResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withBonusModel(?BonusModel $bonusModel): GetReceiveStatusResult {
		$this->bonusModel = $bonusModel;
		return $this;
	}

    public static function fromJson(?array $data): ?GetReceiveStatusResult {
        if ($data === null) {
            return null;
        }
