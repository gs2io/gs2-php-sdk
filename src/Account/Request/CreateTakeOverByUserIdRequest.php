...
class CreateTakeOverByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): CreateTakeOverByUserIdRequest {
     ...
     * @return CreateTakeOverByUserIdRequest $this
     */
    public function withUserId(string $userId = null): CreateTakeOverByUserIdRequest {
     ...
     * @return CreateTakeOverByUserIdRequest $this
     */
    public function withType(int $type = null): CreateTakeOverByUserIdRequest {
        $this->setType($type);
        return $this;
    }
     ...
     * @return CreateTakeOverByUserIdRequest $this
     */
    public function withUserIdentifier(string $userIdentifier = null): CreateTakeOverByUserIdRequest {
     ...
     * @return CreateTakeOverByUserIdRequest $this
     */
    public function withPassword(string $password = null): CreateTakeOverByUserIdRequest {
     ...
     * @return CreateTakeOverByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): CreateTakeOverByUserIdRequest {
