 ...
 */
class DeleteResourceTypeMasterRequest extends Gs2BasicRequest {

    const FUNCTION = "DeleteResourceTypeMaster";
	 ...
	 *
	 * @param string $resourcePoolName リソースプール
	 * @return DeleteResourceTypeMasterRequest
	 */
	public function withResourcePoolName($resourcePoolName): DeleteResourceTypeMasterRequest {
	 ...
	 * @return DeleteResourceTypeMasterRequest
	 */
	public function withResourceTypeName($resourceTypeName): DeleteResourceTypeMasterRequest {
