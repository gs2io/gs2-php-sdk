...
use Gs2\Limit\Domain\Cache\CounterDomainCache;
...
class DescribeCountersByUserIdIterator implements Iterator {
    ...
    private function load(): void {
        /**
         * @var DescribeCountersByUserIdResult
         */
         $r = $this->client->describeCountersByUserId(
