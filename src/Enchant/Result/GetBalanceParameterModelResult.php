...
class GetBalanceParameterModelResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetBalanceParameterModelResult {
        if ($data === null) {
            return null;
        }
        return (new GetBalanceParameterModelResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? BalanceParameterModel::fromJson($data['item']) : null);
    }
