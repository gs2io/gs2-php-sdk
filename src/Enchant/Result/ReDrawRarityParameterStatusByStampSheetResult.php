...
class ReDrawRarityParameterStatusByStampSheetResult implements IResult {
	...
	public function withItem(?RarityParameterStatus $item): ReDrawRarityParameterStatusByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withOld(?RarityParameterStatus $old): ReDrawRarityParameterStatusByStampSheetResult {
		$this->old = $old;
		return $this;
	}

    public static function fromJson(?array $data): ?ReDrawRarityParameterStatusByStampSheetResult {
        if ($data === null) {
            return null;
        }
