 ...
 */
class SetMaxValueByStampSheetResult implements IResult {
	/** @var Stamina スタミナ */
	private $item;
    ...
    public static function fromJson(array $data): SetMaxValueByStampSheetResult {
        $result = new SetMaxValueByStampSheetResult();
