...
class DescribeSubscribesByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeSubscribesByUserIdRequest {
     ...
     * @return DescribeSubscribesByUserIdRequest $this
     */
    public function withUserId(string $userId = null): DescribeSubscribesByUserIdRequest {
     ...
     * @return DescribeSubscribesByUserIdRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeSubscribesByUserIdRequest {
     ...
     * @return DescribeSubscribesByUserIdRequest $this
     */
    public function withLimit(int $limit = null): DescribeSubscribesByUserIdRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeSubscribesByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeSubscribesByUserIdRequest {
