...
class CreateNamespaceRequest extends Gs2BasicRequest {
	...
	public function withRankCapScriptId(?string $rankCapScriptId): CreateNamespaceRequest {
		$this->rankCapScriptId = $rankCapScriptId;
		return $this;
	}
	...
	public function withOverflowExperienceScript(?string $overflowExperienceScript): CreateNamespaceRequest {
		$this->overflowExperienceScript = $overflowExperienceScript;
		return $this;
	}
