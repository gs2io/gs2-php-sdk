...
class DeleteGuildResult implements IResult {
    /** @var Guild */
    private $item;
	...
	public function withItem(?Guild $item): DeleteGuildResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteGuildResult {
        if ($data === null) {
            return null;
        }
