...
class DrawWithRandomSeedByUserIdResult implements IResult {
    /** @var array */
    private $items;
    /** @var string */
	...
	public function withItems(?array $items): DrawWithRandomSeedByUserIdResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withTransactionId(?string $transactionId): DrawWithRandomSeedByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withStampSheet(?string $stampSheet): DrawWithRandomSeedByUserIdResult {
		$this->stampSheet = $stampSheet;
		return $this;
	}
	...
	public function withStampSheetEncryptionKeyId(?string $stampSheetEncryptionKeyId): DrawWithRandomSeedByUserIdResult {
		$this->stampSheetEncryptionKeyId = $stampSheetEncryptionKeyId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): DrawWithRandomSeedByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): DrawWithRandomSeedByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): DrawWithRandomSeedByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): DrawWithRandomSeedByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}

    public static function fromJson(?array $data): ?DrawWithRandomSeedByUserIdResult {
        if ($data === null) {
            return null;
        }
