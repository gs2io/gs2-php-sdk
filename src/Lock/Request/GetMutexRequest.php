...
class GetMutexRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $namespaceName ミューテックスを取得
     * @return GetMutexRequest $this
     */
    public function withNamespaceName(string $namespaceName = null): GetMutexRequest {
     ...
     * @return GetMutexRequest $this
     */
    public function withPropertyId(string $propertyId = null): GetMutexRequest {
     ...
     * @return GetMutexRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetMutexRequest {
