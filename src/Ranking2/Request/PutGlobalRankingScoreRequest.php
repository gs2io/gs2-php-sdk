...
class PutGlobalRankingScoreRequest extends Gs2BasicRequest {
	...
	public function withDuplicationAvoider(?string $duplicationAvoider): PutGlobalRankingScoreRequest {
		$this->duplicationAvoider = $duplicationAvoider;
		return $this;
	}

    public static function fromJson(?array $data): ?PutGlobalRankingScoreRequest {
        if ($data === null) {
            return null;
        }
