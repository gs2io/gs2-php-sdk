...
class DumpUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "inventory", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/user/{userId}/dump";
...
class CleanUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "inventory", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/user/{userId}/clean";
...
class PrepareImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "inventory", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/user/{userId}/import/prepare";
...
class ImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "inventory", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/user/{userId}/import";
...
class CheckImportUserDataByUserIdTask extends Gs2RestSessionTask {
    ...
    public function executeImpl(): PromiseInterface {
        ...
        $url = str_replace('{service}', "inventory", str_replace('{region}', $this->session->getRegion(), Gs2RestSession::$endpointHost)) . "/system/user/{userId}/import/{uploadToken}";
