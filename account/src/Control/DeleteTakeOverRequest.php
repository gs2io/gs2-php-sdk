...
class DeleteTakeOverRequest extends Gs2UserRequest {
	 ...
	 */
	public function withGameName($gameName): DeleteTakeOverRequest {
	 ...
	 * @return DeleteTakeOverRequest
	 */
	public function withType($type): DeleteTakeOverRequest {
		$this->setType($type);
		return $this;
	}
	 ...
	 * @return DeleteTakeOverRequest
	 */
	public function withUserIdentifier($userIdentifier): DeleteTakeOverRequest {
