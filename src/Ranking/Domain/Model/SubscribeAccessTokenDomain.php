...
class SubscribeAccessTokenDomain {
    ...
    public function subscribe(
        \Gs2\Ranking\Request\SubscribeRequest $request
    ): \Gs2\Ranking\Result\SubscribeResult {
        $request->setNamespaceName($this->namespaceName);
        $request->setAccessToken($this->accessToken !== null ? $this->accessToken->getToken() : null);
        $request->setCategoryName($this->categoryName);
        /**
         * @var \Gs2\Ranking\Result\SubscribeResult
         */
    ...
    public function load(
        \Gs2\Ranking\Request\GetSubscribeRequest $request
    ): \Gs2\Ranking\Result\GetSubscribeResult {
        $request->setNamespaceName($this->namespaceName);
        $request->setAccessToken($this->accessToken !== null ? $this->accessToken->getToken() : null);
        $request->setCategoryName($this->categoryName);
        /**
         * @var \Gs2\Ranking\Result\GetSubscribeResult
         */
    ...
    public function unsubscribe(
        \Gs2\Ranking\Request\UnsubscribeRequest $request
    ): \Gs2\Ranking\Result\UnsubscribeResult {
        $request->setNamespaceName($this->namespaceName);
        $request->setAccessToken($this->accessToken !== null ? $this->accessToken->getToken() : null);
        $request->setCategoryName($this->categoryName);
        /**
         * @var \Gs2\Ranking\Result\UnsubscribeResult
         */
