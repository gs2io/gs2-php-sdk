 ...
 */
class DescribeJobRequest extends Gs2BasicRequest {

    const FUNCTION = "DescribeJob";
	 ...
	 */
	public function withQueueName($queueName): DescribeJobRequest {
	 ...
	 * @return DescribeJobRequest
	 */
	public function withPageToken($pageToken): DescribeJobRequest {
	 ...
	 * @return DescribeJobRequest
	 */
	public function withLimit($limit): DescribeJobRequest {
		$this->setLimit($limit);
		return $this;
	}
