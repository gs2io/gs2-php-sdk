...
class AddGradeByStampSheetResult implements IResult {
    /** @var Status */
    private $item;
    /** @var string */
	...
	public function withItem(?Status $item): AddGradeByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withExperienceNamespaceName(?string $experienceNamespaceName): AddGradeByStampSheetResult {
		$this->experienceNamespaceName = $experienceNamespaceName;
		return $this;
	}
	...
	public function withExperienceStatus(?ExperienceStatus $experienceStatus): AddGradeByStampSheetResult {
		$this->experienceStatus = $experienceStatus;
		return $this;
	}

    public static function fromJson(?array $data): ?AddGradeByStampSheetResult {
        if ($data === null) {
            return null;
        }
