...
class PostRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): PostRequest {
     ...
     * @return PostRequest $this
     */
    public function withRoomName(string $roomName = null): PostRequest {
     ...
     * @return PostRequest $this
     */
    public function withCategory(int $category = null): PostRequest {
     ...
     * @return PostRequest $this
     */
    public function withMetadata(string $metadata = null): PostRequest {
     ...
     * @return PostRequest $this
     */
    public function withPassword(string $password = null): PostRequest {
     ...
     * @return PostRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): PostRequest {
