...
class VerifyCounterValueResult implements IResult {
    /** @var Counter */
    private $item;
	...
	public function withItem(?Counter $item): VerifyCounterValueResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?VerifyCounterValueResult {
        if ($data === null) {
            return null;
        }
