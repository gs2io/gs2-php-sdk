 ...
 */
class DescribeGameModeRequest extends Gs2UserRequest {

    const FUNCTION = "DescribeGameMode";
	 ...
	 *
	 * @param string $rankingTableName ランキングテーブルの名前を指定します。
	 * @return DescribeGameModeRequest
	 */
	public function withRankingTableName($rankingTableName): DescribeGameModeRequest {
	 ...
	 * @return DescribeGameModeRequest
	 */
	public function withPageToken($pageToken): DescribeGameModeRequest {
	 ...
	 * @return DescribeGameModeRequest
	 */
	public function withLimit($limit): DescribeGameModeRequest {
		$this->setLimit($limit);
		return $this;
	}
