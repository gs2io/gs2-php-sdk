...
class PrepareDownloadRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): PrepareDownloadRequest {
     ...
     * @return PrepareDownloadRequest $this
     */
    public function withDataObjectId(string $dataObjectId = null): PrepareDownloadRequest {
     ...
     * @return PrepareDownloadRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): PrepareDownloadRequest {
