 ...
 */
class SetRecoverValueByStampSheetRequest extends Gs2BasicRequest {
     ...
     *
     * @param string $stampSheet スタンプシートでスタミナの最大値を更新
     * @return SetRecoverValueByStampSheetRequest $this
     */
    public function withStampSheet(string $stampSheet = null): SetRecoverValueByStampSheetRequest {
     ...
     * @return SetRecoverValueByStampSheetRequest $this
     */
    public function withKeyId(string $keyId = null): SetRecoverValueByStampSheetRequest {
        $this->setKeyId($keyId);
        return $this;
    }
     ...
     * @return SetRecoverValueByStampSheetRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): SetRecoverValueByStampSheetRequest {
