...
class DescribeSerialCodesRequest extends Gs2BasicRequest {
    /** @var string */
	...
	public function withNamespaceName(?string $namespaceName): DescribeSerialCodesRequest {
		$this->namespaceName = $namespaceName;
		return $this;
	}
	...
	public function withCampaignModelName(?string $campaignModelName): DescribeSerialCodesRequest {
		$this->campaignModelName = $campaignModelName;
		return $this;
	}
	...
	public function withIssueJobName(?string $issueJobName): DescribeSerialCodesRequest {
		$this->issueJobName = $issueJobName;
		return $this;
	}
	...
	public function withPageToken(?string $pageToken): DescribeSerialCodesRequest {
		$this->pageToken = $pageToken;
		return $this;
	}
	...
	public function withLimit(?int $limit): DescribeSerialCodesRequest {
		$this->limit = $limit;
		return $this;
	}

    public static function fromJson(?array $data): ?DescribeSerialCodesRequest {
        if ($data === null) {
            return null;
        }
