...
class Namespace_ implements IModel {
	...
	/**
     * @var CalculatedAt[] 最終集計日時リスト
	 */
	protected $lastCalculatedAts;

	/**
	 * 最終集計日時リストを取得
	 *
	 * @return CalculatedAt[]|null 最終集計日時リスト
	 */
	public function getLastCalculatedAts(): ?array {
	 ...
	 * 最終集計日時リストを設定
	 *
	 * @param CalculatedAt[]|null $lastCalculatedAts 最終集計日時リスト
	 */
	public function setLastCalculatedAts(?array $lastCalculatedAts) {
	 ...
	 * @return Namespace_ $this
	 */
	public function withLastCalculatedAts(?array $lastCalculatedAts): Namespace_ {
		$this->lastCalculatedAts = $lastCalculatedAts;
		return $this;
	}
	/**
    ...
    public static function fromJson(array $data): Namespace_ {
        ...
        $model->setLastCalculatedAts(array_map(
                function ($v) {
                    return CalculatedAt::fromJson($v);
                },
                isset($data["lastCalculatedAts"]) ? $data["lastCalculatedAts"] : []
            )
        );
