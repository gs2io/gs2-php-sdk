...
class DeleteReferenceOfByUserIdResult implements IResult {
    /** @var string */
    private $item;
    /** @var ItemSet */
    private $itemSet;
	...
	public function withItem(?string $item): DeleteReferenceOfByUserIdResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withItemSet(?ItemSet $itemSet): DeleteReferenceOfByUserIdResult {
		$this->itemSet = $itemSet;
		return $this;
	}
	...
	public function withItemModel(?ItemModel $itemModel): DeleteReferenceOfByUserIdResult {
		$this->itemModel = $itemModel;
		return $this;
	}
	...
	public function withInventory(?Inventory $inventory): DeleteReferenceOfByUserIdResult {
		$this->inventory = $inventory;
		return $this;
	}

    public static function fromJson(?array $data): ?DeleteReferenceOfByUserIdResult {
        if ($data === null) {
            return null;
        }
