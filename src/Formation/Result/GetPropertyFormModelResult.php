...
class GetPropertyFormModelResult implements IResult {
    ...
    public static function fromJson(?array $data): ?GetPropertyFormModelResult {
        if ($data === null) {
            return null;
        }
        return (new GetPropertyFormModelResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? PropertyFormModel::fromJson($data['item']) : null);
    }
