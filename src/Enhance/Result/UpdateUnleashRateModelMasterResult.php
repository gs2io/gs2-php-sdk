...
class UpdateUnleashRateModelMasterResult implements IResult {
	...
	public function withItem(?UnleashRateModelMaster $item): UpdateUnleashRateModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?UpdateUnleashRateModelMasterResult {
        if ($data === null) {
            return null;
        }
