...
class DrawByUserIdResult implements IResult {
	...
	public function withTransactionId(?string $transactionId): DrawByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): DrawByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): DrawByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): DrawByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): DrawByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
