...
class WithdrawRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): WithdrawRequest {
     ...
     * @return WithdrawRequest $this
     */
    public function withSlot(int $slot = null): WithdrawRequest {
        $this->setSlot($slot);
        return $this;
    }
     ...
     * @return WithdrawRequest $this
     */
    public function withCount(int $count = null): WithdrawRequest {
        $this->setCount($count);
        return $this;
    }
     ...
     * @return WithdrawRequest $this
     */
    public function withPaidOnly(bool $paidOnly = null): WithdrawRequest {
     ...
     * @return WithdrawRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): WithdrawRequest {
