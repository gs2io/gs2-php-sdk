...
use Gs2\Inventory\Domain\Cache\ItemSetDomainCache;
...
class DescribeItemSetsByUserIdIterator implements Iterator {

    /**
     * @var ItemSetDomainCache
     */
    ...
    public function __construct(
        ItemSetDomainCache $itemSetCache,
    ...
    private function load(): void {
        /**
         * @var DescribeItemSetsByUserIdResult
         */
         $r = $this->client->describeItemSetsByUserId(
