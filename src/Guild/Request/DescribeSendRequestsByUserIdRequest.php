...
class DescribeSendRequestsByUserIdRequest extends Gs2BasicRequest {
	...
	public function withGuildModelName(?string $guildModelName): DescribeSendRequestsByUserIdRequest {
		$this->guildModelName = $guildModelName;
		return $this;
	}
    ...
    public static function fromJson(?array $data): ?DescribeSendRequestsByUserIdRequest {
        if ($data === null) {
            return null;
        }
