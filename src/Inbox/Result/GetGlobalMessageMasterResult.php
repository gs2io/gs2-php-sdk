...
class GetGlobalMessageMasterResult implements IResult {
	 ...
	 * 全ユーザに向けたメッセージを取得
	 *
	 * @return GlobalMessageMaster|null 全ユーザに向けたメッセージを取得
	 */
	 ...
	 * 全ユーザに向けたメッセージを設定
	 *
	 * @param GlobalMessageMaster|null $item 全ユーザに向けたメッセージを取得
	 */
	public function setItem(?GlobalMessageMaster $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): GetGlobalMessageMasterResult {
        $result = new GetGlobalMessageMasterResult();
