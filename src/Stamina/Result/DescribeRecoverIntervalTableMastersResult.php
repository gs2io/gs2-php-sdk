...
class DescribeRecoverIntervalTableMastersResult implements IResult {
	...
	public function withItems(?array $items): DescribeRecoverIntervalTableMastersResult {
		$this->items = $items;
		return $this;
	}
	...
	public function withNextPageToken(?string $nextPageToken): DescribeRecoverIntervalTableMastersResult {
		$this->nextPageToken = $nextPageToken;
		return $this;
	}
