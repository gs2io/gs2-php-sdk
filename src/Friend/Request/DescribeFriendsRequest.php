...
class DescribeFriendsRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeFriendsRequest {
     ...
     * @return DescribeFriendsRequest $this
     */
    public function withWithProfile(bool $withProfile = null): DescribeFriendsRequest {
     ...
     * @return DescribeFriendsRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeFriendsRequest {
     ...
     * @return DescribeFriendsRequest $this
     */
    public function withLimit(int $limit = null): DescribeFriendsRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeFriendsRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeFriendsRequest {
