...
class CountAccessLogRequest extends Gs2BasicRequest {
	...
	public function withService(?string $service): CountAccessLogRequest {
		$this->service = $service;
		return $this;
	}
	...
	public function withMethod(?string $method): CountAccessLogRequest {
		$this->method = $method;
		return $this;
	}
	...
	public function withUserId(?string $userId): CountAccessLogRequest {
		$this->userId = $userId;
		return $this;
	}
