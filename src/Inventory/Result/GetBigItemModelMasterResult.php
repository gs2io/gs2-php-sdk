...
class GetBigItemModelMasterResult implements IResult {
	...
	public function withItem(?BigItemModelMaster $item): GetBigItemModelMasterResult {
		$this->item = $item;
		return $this;
	}

    public static function fromJson(?array $data): ?GetBigItemModelMasterResult {
        if ($data === null) {
            return null;
        }
