...
class PutPositionByUserIdResult implements IResult {
    ...
    public static function fromJson(?array $data): ?PutPositionByUserIdResult {
        if ($data === null) {
            return null;
        }
        return (new PutPositionByUserIdResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? Spatial::fromJson($data['item']) : null);
    }
