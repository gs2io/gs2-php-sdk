...
class DescribeTakeOversRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): DescribeTakeOversRequest {
     ...
     * @return DescribeTakeOversRequest $this
     */
    public function withPageToken(string $pageToken = null): DescribeTakeOversRequest {
     ...
     * @return DescribeTakeOversRequest $this
     */
    public function withLimit(int $limit = null): DescribeTakeOversRequest {
        $this->setLimit($limit);
        return $this;
    }
     ...
     * @return DescribeTakeOversRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): DescribeTakeOversRequest {
