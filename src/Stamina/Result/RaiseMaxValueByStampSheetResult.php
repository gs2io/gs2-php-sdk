...
class RaiseMaxValueByStampSheetResult implements IResult {
	...
	public function withItem(?Stamina $item): RaiseMaxValueByStampSheetResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withStaminaModel(?StaminaModel $staminaModel): RaiseMaxValueByStampSheetResult {
		$this->staminaModel = $staminaModel;
		return $this;
	}
