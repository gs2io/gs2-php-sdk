...
class UpdateRecoverIntervalTableMasterResult implements IResult {
	/** @var RecoverIntervalTableMaster 更新したスタミナ回復間隔テーブルマスター */
	private $item;

	/**
	 * 更新したスタミナ回復間隔テーブルマスターを取得
	 *
	 * @return RecoverIntervalTableMaster|null スタミナ回復間隔テーブルマスターを更新
	 */
	 ...
	 *
	 * @param RecoverIntervalTableMaster|null $item スタミナ回復間隔テーブルマスターを更新
	 */
    ...
    public static function fromJson(array $data): UpdateRecoverIntervalTableMasterResult {
        $result = new UpdateRecoverIntervalTableMasterResult();
