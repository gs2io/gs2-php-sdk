 ...
 */
class GetResourcePoolRequest extends Gs2BasicRequest {

    const FUNCTION = "GetResourcePool";
	 ...
	 */
	public function withResourcePoolName($resourcePoolName): GetResourcePoolRequest {
