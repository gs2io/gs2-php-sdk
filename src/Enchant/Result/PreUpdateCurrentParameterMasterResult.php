...
class PreUpdateCurrentParameterMasterResult implements IResult {
    /** @var string */
    private $uploadToken;
    /** @var string */
    private $uploadUrl;
	...
	public function withUploadToken(?string $uploadToken): PreUpdateCurrentParameterMasterResult {
		$this->uploadToken = $uploadToken;
		return $this;
	}
	...
	public function withUploadUrl(?string $uploadUrl): PreUpdateCurrentParameterMasterResult {
		$this->uploadUrl = $uploadUrl;
		return $this;
	}

    public static function fromJson(?array $data): ?PreUpdateCurrentParameterMasterResult {
        if ($data === null) {
            return null;
        }
