...
class DoTakeOverRequest extends Gs2BasicRequest {
	 ...
	 */
	public function withGameName($gameName): DoTakeOverRequest {
	 ...
	 * @return DoTakeOverRequest
	 */
	public function withType($type): DoTakeOverRequest {
		$this->setType($type);
		return $this;
	}
	 ...
	 * @return DoTakeOverRequest
	 */
	public function withUserIdentifier($userIdentifier): DoTakeOverRequest {
	 ...
	 * @return DoTakeOverRequest
	 */
	public function withPassword($password): DoTakeOverRequest {
