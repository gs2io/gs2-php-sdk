...
class DescribeItemSetsByUserIdRequest extends Gs2BasicRequest {
	...
	public function withTimeOffsetToken(?string $timeOffsetToken): DescribeItemSetsByUserIdRequest {
		$this->timeOffsetToken = $timeOffsetToken;
		return $this;
	}

    public static function fromJson(?array $data): ?DescribeItemSetsByUserIdRequest {
        if ($data === null) {
            return null;
        }
