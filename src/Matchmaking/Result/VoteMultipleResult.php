...
class VoteMultipleResult implements IResult {
	 ...
	 * 投票用紙を取得
	 *
	 * @return Ballot|null 対戦結果をまとめて投票します。
	 */
	 ...
	 * 投票用紙を設定
	 *
	 * @param Ballot|null $item 対戦結果をまとめて投票します。
	 */
	public function setItem(?Ballot $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): VoteMultipleResult {
        $result = new VoteMultipleResult();
