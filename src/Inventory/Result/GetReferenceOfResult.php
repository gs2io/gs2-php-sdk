...
class GetReferenceOfResult implements IResult {
    /** @var string */
    private $item;
    /** @var ItemSet */
    private $itemSet;
	...
	public function withItem(?string $item): GetReferenceOfResult {
		$this->item = $item;
		return $this;
	}
	...
	public function withItemSet(?ItemSet $itemSet): GetReferenceOfResult {
		$this->itemSet = $itemSet;
		return $this;
	}
	...
	public function withItemModel(?ItemModel $itemModel): GetReferenceOfResult {
		$this->itemModel = $itemModel;
		return $this;
	}
	...
	public function withInventory(?Inventory $inventory): GetReferenceOfResult {
		$this->inventory = $inventory;
		return $this;
	}

    public static function fromJson(?array $data): ?GetReferenceOfResult {
        if ($data === null) {
            return null;
        }
