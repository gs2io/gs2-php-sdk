...
class GetTriggerByUserIdRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): GetTriggerByUserIdRequest {
     ...
     * @return GetTriggerByUserIdRequest $this
     */
    public function withUserId(string $userId = null): GetTriggerByUserIdRequest {
     ...
     * @return GetTriggerByUserIdRequest $this
     */
    public function withTriggerName(string $triggerName = null): GetTriggerByUserIdRequest {
     ...
     * @return GetTriggerByUserIdRequest $this
     */
    public function withDuplicationAvoider(string $duplicationAvoider = null): GetTriggerByUserIdRequest {
