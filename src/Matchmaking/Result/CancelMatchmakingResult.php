...
class CancelMatchmakingResult implements IResult {
	 ...
	 * ギャザリングを取得
	 *
	 * @return Gathering|null マッチメイキングをキャンセルする
	 */
	 ...
	 * ギャザリングを設定
	 *
	 * @param Gathering|null $item マッチメイキングをキャンセルする
	 */
	public function setItem(?Gathering $item) {
		$this->item = $item;
	}

    public static function fromJson(array $data): CancelMatchmakingResult {
        $result = new CancelMatchmakingResult();
