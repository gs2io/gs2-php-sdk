...
class PreUpdateCurrentEntryMasterResult implements IResult {
    /** @var string */
    private $uploadToken;
    /** @var string */
    private $uploadUrl;
	...
	public function withUploadToken(?string $uploadToken): PreUpdateCurrentEntryMasterResult {
		$this->uploadToken = $uploadToken;
		return $this;
	}
	...
	public function withUploadUrl(?string $uploadUrl): PreUpdateCurrentEntryMasterResult {
		$this->uploadUrl = $uploadUrl;
		return $this;
	}

    public static function fromJson(?array $data): ?PreUpdateCurrentEntryMasterResult {
        if ($data === null) {
            return null;
        }
