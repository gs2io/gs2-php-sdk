...
class UpdateAreaModelMasterResult implements IResult {
    ...
    public static function fromJson(?array $data): ?UpdateAreaModelMasterResult {
        if ($data === null) {
            return null;
        }
        return (new UpdateAreaModelMasterResult())
            ->withItem(array_key_exists('item', $data) && $data['item'] !== null ? AreaModelMaster::fromJson($data['item']) : null);
    }
