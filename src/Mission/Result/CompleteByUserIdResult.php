...
class CompleteByUserIdResult implements IResult {
	...
	public function withTransactionId(?string $transactionId): CompleteByUserIdResult {
		$this->transactionId = $transactionId;
		return $this;
	}
	...
	public function withAutoRunStampSheet(?bool $autoRunStampSheet): CompleteByUserIdResult {
		$this->autoRunStampSheet = $autoRunStampSheet;
		return $this;
	}
	...
	public function withAtomicCommit(?bool $atomicCommit): CompleteByUserIdResult {
		$this->atomicCommit = $atomicCommit;
		return $this;
	}
	...
	public function withTransaction(?string $transaction): CompleteByUserIdResult {
		$this->transaction = $transaction;
		return $this;
	}
	...
	public function withTransactionResult(?CoreTransactionResult $transactionResult): CompleteByUserIdResult {
		$this->transactionResult = $transactionResult;
		return $this;
	}
