...
class CreateThresholdMasterRequest extends Gs2BasicRequest {
     ...
     */
    public function withNamespaceName(string $namespaceName = null): CreateThresholdMasterRequest {
     ...
     * @return CreateThresholdMasterRequest $this
     */
    public function withName(string $name = null): CreateThresholdMasterRequest {
        $this->setName($name);
        return $this;
    }
     ...
     * @return CreateThresholdMasterRequest $this
     */
    public function withDescription(string $description = null): CreateThresholdMasterRequest {
     ...
     * @return CreateThresholdMasterRequest $this
     */
    public function withMetadata(string $metadata = null): CreateThresholdMasterRequest {
     ...
     * @return CreateThresholdMasterRequest $this
     */
    public function withValues(array $values = null): CreateThresholdMasterRequest {
